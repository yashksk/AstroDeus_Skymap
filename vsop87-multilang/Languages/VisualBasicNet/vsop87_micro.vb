...
Public Class vsop87_micro 
   ...
   Shared Function jupiter_a(t as Double) as Double
      ...
      jupiter_a=jupiter_a_0+jupiter_a_1
   End Function
   ...
   Shared Function jupiter_q(t as Double) as Double
      ...
      jupiter_q=jupiter_q_0+jupiter_q_1
   End Function
   ...
   Shared Function jupiter_p(t as Double) as Double
      ...
      jupiter_p=jupiter_p_0+jupiter_p_1
   End Function
   ...
   Shared Function mercury_q(t as Double) as Double
      ...
      mercury_q=mercury_q_0+mercury_q_1
   End Function
   ...
   Shared Function neptune_a(t as Double) as Double
      ...
      neptune_a=neptune_a_0+neptune_a_1
   End Function
   ...
   Shared Function saturn_a(t as Double) as Double
      ...
      saturn_a=saturn_a_0+saturn_a_1+saturn_a_2
   End Function
   ...
   Shared Function saturn_k(t as Double) as Double
      ...
      saturn_k=saturn_k_0+saturn_k_1+saturn_k_2
   End Function
   ...
   Shared Function saturn_h(t as Double) as Double
      ...
      saturn_h=saturn_h_0+saturn_h_1+saturn_h_2
   End Function
   ...
   Shared Function saturn_q(t as Double) as Double
      ...
      saturn_q=saturn_q_0+saturn_q_1
   End Function
   ...
   Shared Function saturn_p(t as Double) as Double
      ...
      saturn_p=saturn_p_0+saturn_p_1
   End Function
   ...
   Shared Function uranus_a(t as Double) as Double
      ...
      uranus_a=uranus_a_0+uranus_a_1
   End Function
   ...
   Shared Function uranus_h(t as Double) as Double
      ...
      uranus_h=uranus_h_0+uranus_h_1
   End Function
