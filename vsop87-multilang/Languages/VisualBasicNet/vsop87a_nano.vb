...
Public Class vsop87a_nano 
   ...
   Shared Function neptune_x(t as Double) as Double
      ...
      neptune_x=neptune_x_0+neptune_x_1
   End Function
   ...
   Shared Function neptune_y(t as Double) as Double
      ...
      neptune_y=neptune_y_0+neptune_y_1
   End Function
   ...
   Shared Function uranus_x(t as Double) as Double
      ...
      uranus_x=uranus_x_0+uranus_x_1
   End Function
