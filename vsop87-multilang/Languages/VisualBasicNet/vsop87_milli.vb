...
Public Class vsop87_milli 
   ...
   Shared Function jupiter_k(t as Double) as Double
      ...
      jupiter_k=jupiter_k_0+jupiter_k_1+jupiter_k_2
   End Function
   ...
   Shared Function jupiter_h(t as Double) as Double
      ...
      jupiter_h=jupiter_h_0+jupiter_h_1+jupiter_h_2
   End Function
   ...
   Shared Function neptune_a(t as Double) as Double
      ...
      neptune_a=neptune_a_0+neptune_a_1+neptune_a_2
   End Function
   ...
   Shared Function uranus_a(t as Double) as Double
      ...
      uranus_a=uranus_a_0+uranus_a_1+uranus_a_2
   End Function
   ...
   Shared Function uranus_k(t as Double) as Double
      ...
      uranus_k=uranus_k_0+uranus_k_1
   End Function
