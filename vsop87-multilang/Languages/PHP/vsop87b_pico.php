...
class vsop87b_pico {
   ...
   public static function getEarth($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_pico::earth_l($t));
      array_push($temp,vsop87b_pico::earth_b($t));
      array_push($temp,vsop87b_pico::earth_r($t));
      return $temp;
   }
   ...
   public static function getJupiter($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_pico::jupiter_l($t));
      array_push($temp,vsop87b_pico::jupiter_b($t));
      array_push($temp,vsop87b_pico::jupiter_r($t));
      return $temp;
   }
   ...
   public static function getMars($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_pico::mars_l($t));
      array_push($temp,vsop87b_pico::mars_b($t));
      array_push($temp,vsop87b_pico::mars_r($t));
      return $temp;
   }
   ...
   public static function getMercury($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_pico::mercury_l($t));
      array_push($temp,vsop87b_pico::mercury_b($t));
      array_push($temp,vsop87b_pico::mercury_r($t));
      return $temp;
   }
   ...
   public static function getNeptune($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_pico::neptune_l($t));
      array_push($temp,vsop87b_pico::neptune_b($t));
      array_push($temp,vsop87b_pico::neptune_r($t));
      return $temp;
   }
   ...
   public static function getSaturn($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_pico::saturn_l($t));
      array_push($temp,vsop87b_pico::saturn_b($t));
      array_push($temp,vsop87b_pico::saturn_r($t));
      return $temp;
   }
   ...
   public static function getUranus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_pico::uranus_l($t));
      array_push($temp,vsop87b_pico::uranus_b($t));
      array_push($temp,vsop87b_pico::uranus_r($t));
      return $temp;
   }
   ...
   public static function getVenus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_pico::venus_l($t));
      array_push($temp,vsop87b_pico::venus_b($t));
      array_push($temp,vsop87b_pico::venus_r($t));
      return $temp;
   }
