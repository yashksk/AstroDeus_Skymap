...
class vsop87_micro {
   ...
   public static function getEmb($t) {
      ...
      $temp=[];
      array_push($temp,vsop87_micro::emb_a($t));
      array_push($temp,vsop87_micro::emb_l($t));
      array_push($temp,vsop87_micro::emb_k($t));
      array_push($temp,vsop87_micro::emb_h($t));
      array_push($temp,vsop87_micro::emb_q($t));
      array_push($temp,vsop87_micro::emb_p($t));
      return $temp;
   }
   ...
   public static function getJupiter($t) {
      ...
      $temp=[];
      array_push($temp,vsop87_micro::jupiter_a($t));
      array_push($temp,vsop87_micro::jupiter_l($t));
      array_push($temp,vsop87_micro::jupiter_k($t));
      array_push($temp,vsop87_micro::jupiter_h($t));
      array_push($temp,vsop87_micro::jupiter_q($t));
      array_push($temp,vsop87_micro::jupiter_p($t));
      return $temp;
   }
   ...
   public static function getMars($t) {
      ...
      $temp=[];
      array_push($temp,vsop87_micro::mars_a($t));
      array_push($temp,vsop87_micro::mars_l($t));
      array_push($temp,vsop87_micro::mars_k($t));
      array_push($temp,vsop87_micro::mars_h($t));
      array_push($temp,vsop87_micro::mars_q($t));
      array_push($temp,vsop87_micro::mars_p($t));
      return $temp;
   }
   ...
   public static function getMercury($t) {
      ...
      $temp=[];
      array_push($temp,vsop87_micro::mercury_a($t));
      array_push($temp,vsop87_micro::mercury_l($t));
      array_push($temp,vsop87_micro::mercury_k($t));
      array_push($temp,vsop87_micro::mercury_h($t));
      array_push($temp,vsop87_micro::mercury_q($t));
      array_push($temp,vsop87_micro::mercury_p($t));
      return $temp;
   }
   ...
   public static function getNeptune($t) {
      ...
      $temp=[];
      array_push($temp,vsop87_micro::neptune_a($t));
      array_push($temp,vsop87_micro::neptune_l($t));
      array_push($temp,vsop87_micro::neptune_k($t));
      array_push($temp,vsop87_micro::neptune_h($t));
      array_push($temp,vsop87_micro::neptune_q($t));
      array_push($temp,vsop87_micro::neptune_p($t));
      return $temp;
   }
   ...
   public static function getSaturn($t) {
      ...
      $temp=[];
      array_push($temp,vsop87_micro::saturn_a($t));
      array_push($temp,vsop87_micro::saturn_l($t));
      array_push($temp,vsop87_micro::saturn_k($t));
      array_push($temp,vsop87_micro::saturn_h($t));
      array_push($temp,vsop87_micro::saturn_q($t));
      array_push($temp,vsop87_micro::saturn_p($t));
      return $temp;
   }
   ...
   public static function getUranus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87_micro::uranus_a($t));
      array_push($temp,vsop87_micro::uranus_l($t));
      array_push($temp,vsop87_micro::uranus_k($t));
      array_push($temp,vsop87_micro::uranus_h($t));
      array_push($temp,vsop87_micro::uranus_q($t));
      array_push($temp,vsop87_micro::uranus_p($t));
      return $temp;
   }
   ...
   public static function getVenus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87_micro::venus_a($t));
      array_push($temp,vsop87_micro::venus_l($t));
      array_push($temp,vsop87_micro::venus_k($t));
      array_push($temp,vsop87_micro::venus_h($t));
      array_push($temp,vsop87_micro::venus_q($t));
      array_push($temp,vsop87_micro::venus_p($t));
      return $temp;
   }
