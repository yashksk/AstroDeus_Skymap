...
class vsop87d_pico_velocities {
   ...
   public static function getEarth($t) {
      ...
      $temp=[];
      array_push($temp,vsop87d_pico_velocities::earth_l($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::earth_b($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::earth_r($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getJupiter($t) {
      ...
      $temp=[];
      array_push($temp,vsop87d_pico_velocities::jupiter_l($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::jupiter_b($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::jupiter_r($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getMars($t) {
      ...
      $temp=[];
      array_push($temp,vsop87d_pico_velocities::mars_l($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::mars_b($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::mars_r($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getMercury($t) {
      ...
      $temp=[];
      array_push($temp,vsop87d_pico_velocities::mercury_l($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::mercury_b($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::mercury_r($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getNeptune($t) {
      ...
      $temp=[];
      array_push($temp,vsop87d_pico_velocities::neptune_l($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::neptune_b($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::neptune_r($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getSaturn($t) {
      ...
      $temp=[];
      array_push($temp,vsop87d_pico_velocities::saturn_l($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::saturn_b($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::saturn_r($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getUranus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87d_pico_velocities::uranus_l($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::uranus_b($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::uranus_r($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getVenus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87d_pico_velocities::venus_l($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::venus_b($t) / 365250.0);
      array_push($temp,vsop87d_pico_velocities::venus_r($t) / 365250.0);
      return $temp;
   }
