...
class vsop87b_nano {
   ...
   public static function getEarth($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_nano::earth_l($t));
      array_push($temp,vsop87b_nano::earth_b($t));
      array_push($temp,vsop87b_nano::earth_r($t));
      return $temp;
   }
   ...
   public static function getJupiter($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_nano::jupiter_l($t));
      array_push($temp,vsop87b_nano::jupiter_b($t));
      array_push($temp,vsop87b_nano::jupiter_r($t));
      return $temp;
   }
   ...
   public static function getMars($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_nano::mars_l($t));
      array_push($temp,vsop87b_nano::mars_b($t));
      array_push($temp,vsop87b_nano::mars_r($t));
      return $temp;
   }
   ...
   public static function getMercury($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_nano::mercury_l($t));
      array_push($temp,vsop87b_nano::mercury_b($t));
      array_push($temp,vsop87b_nano::mercury_r($t));
      return $temp;
   }
   ...
   public static function getNeptune($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_nano::neptune_l($t));
      array_push($temp,vsop87b_nano::neptune_b($t));
      array_push($temp,vsop87b_nano::neptune_r($t));
      return $temp;
   }
   ...
   public static function getSaturn($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_nano::saturn_l($t));
      array_push($temp,vsop87b_nano::saturn_b($t));
      array_push($temp,vsop87b_nano::saturn_r($t));
      return $temp;
   }
   ...
   public static function getUranus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_nano::uranus_l($t));
      array_push($temp,vsop87b_nano::uranus_b($t));
      array_push($temp,vsop87b_nano::uranus_r($t));
      return $temp;
   }
   ...
   public static function getVenus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87b_nano::venus_l($t));
      array_push($temp,vsop87b_nano::venus_b($t));
      array_push($temp,vsop87b_nano::venus_r($t));
      return $temp;
   }
