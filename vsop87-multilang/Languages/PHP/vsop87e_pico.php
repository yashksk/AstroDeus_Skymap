...
class vsop87e_pico {
   ...
   public static function getEarth($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::earth_x($t));
      array_push($temp,vsop87e_pico::earth_y($t));
      array_push($temp,vsop87e_pico::earth_z($t));
      return $temp;
   }
   ...
   public static function getJupiter($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::jupiter_x($t));
      array_push($temp,vsop87e_pico::jupiter_y($t));
      array_push($temp,vsop87e_pico::jupiter_z($t));
      return $temp;
   }
   ...
   public static function getMars($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::mars_x($t));
      array_push($temp,vsop87e_pico::mars_y($t));
      array_push($temp,vsop87e_pico::mars_z($t));
      return $temp;
   }
   ...
   public static function getMercury($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::mercury_x($t));
      array_push($temp,vsop87e_pico::mercury_y($t));
      array_push($temp,vsop87e_pico::mercury_z($t));
      return $temp;
   }
   ...
   public static function getNeptune($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::neptune_x($t));
      array_push($temp,vsop87e_pico::neptune_y($t));
      array_push($temp,vsop87e_pico::neptune_z($t));
      return $temp;
   }
   ...
   public static function getSaturn($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::saturn_x($t));
      array_push($temp,vsop87e_pico::saturn_y($t));
      array_push($temp,vsop87e_pico::saturn_z($t));
      return $temp;
   }
   ...
   public static function getUranus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::uranus_x($t));
      array_push($temp,vsop87e_pico::uranus_y($t));
      array_push($temp,vsop87e_pico::uranus_z($t));
      return $temp;
   }
   ...
   public static function getVenus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::venus_x($t));
      array_push($temp,vsop87e_pico::venus_y($t));
      array_push($temp,vsop87e_pico::venus_z($t));
      return $temp;
   }
   ...
   public static function getSun($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico::sun_x($t));
      array_push($temp,vsop87e_pico::sun_y($t));
      array_push($temp,vsop87e_pico::sun_z($t));
      return $temp;
   }
