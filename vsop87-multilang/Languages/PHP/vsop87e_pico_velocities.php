...
class vsop87e_pico_velocities {
   ...
   public static function getEarth($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::earth_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::earth_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::earth_z($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getJupiter($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::jupiter_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::jupiter_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::jupiter_z($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getMars($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::mars_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::mars_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::mars_z($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getMercury($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::mercury_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::mercury_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::mercury_z($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getNeptune($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::neptune_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::neptune_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::neptune_z($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getSaturn($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::saturn_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::saturn_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::saturn_z($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getUranus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::uranus_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::uranus_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::uranus_z($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getVenus($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::venus_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::venus_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::venus_z($t) / 365250.0);
      return $temp;
   }
   ...
   public static function getSun($t) {
      ...
      $temp=[];
      array_push($temp,vsop87e_pico_velocities::sun_x($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::sun_y($t) / 365250.0);
      array_push($temp,vsop87e_pico_velocities::sun_z($t) / 365250.0);
      return $temp;
   }
