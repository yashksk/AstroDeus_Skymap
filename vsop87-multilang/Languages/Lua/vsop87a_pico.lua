...
function vsop87a_pico.getMercury(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.mercury_x(t)
   temp[2]=vsop87a_pico.mercury_y(t)
   temp[3]=vsop87a_pico.mercury_z(t)

   return temp;
end

function vsop87a_pico.getVenus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.venus_x(t)
   temp[2]=vsop87a_pico.venus_y(t)
   temp[3]=vsop87a_pico.venus_z(t)

   return temp;
end

function vsop87a_pico.getEarth(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.earth_x(t)
   temp[2]=vsop87a_pico.earth_y(t)
   temp[3]=vsop87a_pico.earth_z(t)

   return temp;
end

function vsop87a_pico.getMars(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.mars_x(t)
   temp[2]=vsop87a_pico.mars_y(t)
   temp[3]=vsop87a_pico.mars_z(t)

   return temp;
end

function vsop87a_pico.getJupiter(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.jupiter_x(t)
   temp[2]=vsop87a_pico.jupiter_y(t)
   temp[3]=vsop87a_pico.jupiter_z(t)

   return temp;
end

function vsop87a_pico.getSaturn(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.saturn_x(t)
   temp[2]=vsop87a_pico.saturn_y(t)
   temp[3]=vsop87a_pico.saturn_z(t)

   return temp;
end

function vsop87a_pico.getUranus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.uranus_x(t)
   temp[2]=vsop87a_pico.uranus_y(t)
   temp[3]=vsop87a_pico.uranus_z(t)

   return temp;
end

function vsop87a_pico.getNeptune(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.neptune_x(t)
   temp[2]=vsop87a_pico.neptune_y(t)
   temp[3]=vsop87a_pico.neptune_z(t)

   return temp;
end

function vsop87a_pico.getEmb(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_pico.emb_x(t)
   temp[2]=vsop87a_pico.emb_y(t)
   temp[3]=vsop87a_pico.emb_z(t)

   return temp;
end

function vsop87a_pico.getMoon(earth, emb)
   local temp={0.0, 0.0, 0,0}
...
function vsop87a_pico.earth_x(t)
   local earth_x_0 = 0.0
...
function vsop87a_pico.earth_y(t)
   local earth_y_0 = 0.0
...
function vsop87a_pico.earth_z(t)
   return 0
end

function vsop87a_pico.emb_x(t)
   local emb_x_0 = 0.0
   ...
   emb_x_0=emb_x_0*t*t*t

   emb_x_0=emb_x_0*t*t*t*t

   emb_x_0=emb_x_0*t*t*t*t*t

   return emb_x_0
end

function vsop87a_pico.emb_y(t)
   local emb_y_0 = 0.0
...
function vsop87a_pico.emb_z(t)
   return 0
end

function vsop87a_pico.jupiter_x(t)
   ...
   jupiter_x_0=jupiter_x_0*t

   jupiter_x_0=jupiter_x_0*t*t

   jupiter_x_0=jupiter_x_0*t*t*t

   jupiter_x_0=jupiter_x_0*t*t*t*t

   jupiter_x_0=jupiter_x_0*t*t*t*t*t

   return jupiter_x_0
end

function vsop87a_pico.jupiter_y(t)
...
function vsop87a_pico.jupiter_z(t)
...
function vsop87a_pico.mars_x(t)
   local mars_x_0 = 0.0
   ...
   mars_x_0=mars_x_0*t*t

   mars_x_0=mars_x_0*t*t*t

   mars_x_0=mars_x_0*t*t*t*t

   mars_x_0=mars_x_0*t*t*t*t*t

   return mars_x_0
end

function vsop87a_pico.mars_y(t)
   local mars_y_0 = 0.0
...
function vsop87a_pico.mars_z(t)
   local mars_z_0 = 0.0
...
function vsop87a_pico.mercury_x(t)
...
function vsop87a_pico.mercury_y(t)
...
function vsop87a_pico.mercury_z(t)
...
function vsop87a_pico.neptune_x(t)
   ...
   neptune_x_0=neptune_x_0*t*t

   neptune_x_0=neptune_x_0*t*t*t

   neptune_x_0=neptune_x_0*t*t*t*t

   return neptune_x_0
end

function vsop87a_pico.neptune_y(t)
   ...
   neptune_y_0=neptune_y_0*t*t

   neptune_y_0=neptune_y_0*t*t*t

   neptune_y_0=neptune_y_0*t*t*t*t

   return neptune_y_0
end

function vsop87a_pico.neptune_z(t)
   ...
   neptune_z_0=neptune_z_0*t

   neptune_z_0=neptune_z_0*t*t

   neptune_z_0=neptune_z_0*t*t*t

   return neptune_z_0
end

function vsop87a_pico.saturn_x(t)
...
function vsop87a_pico.saturn_y(t)
...
function vsop87a_pico.saturn_z(t)
...
function vsop87a_pico.uranus_x(t)
   ...
   uranus_x_0=uranus_x_0*t

   uranus_x_0=uranus_x_0*t*t

   uranus_x_0=uranus_x_0*t*t*t

   uranus_x_0=uranus_x_0*t*t*t*t

   return uranus_x_0
end

function vsop87a_pico.uranus_y(t)
...
function vsop87a_pico.uranus_z(t)
   ...
   uranus_z_0=uranus_z_0*t

   uranus_z_0=uranus_z_0*t*t

   uranus_z_0=uranus_z_0*t*t*t

   return uranus_z_0
end

function vsop87a_pico.venus_x(t)
   local venus_x_0 = 0.0
...
function vsop87a_pico.venus_y(t)
   local venus_y_0 = 0.0
...
function vsop87a_pico.venus_z(t)
   local venus_z_0 = 0.0
