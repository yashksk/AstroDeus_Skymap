...
local vsop87c_pico_velocities = {}

function vsop87c_pico_velocities.getMercury(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87c_pico_velocities.mercury_x(t) / 365250.0
   temp[2]=vsop87c_pico_velocities.mercury_y(t) / 365250.0
   temp[3]=vsop87c_pico_velocities.mercury_z(t) / 365250.0

   return temp;
end

function vsop87c_pico_velocities.getVenus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87c_pico_velocities.venus_x(t) / 365250.0
   temp[2]=vsop87c_pico_velocities.venus_y(t) / 365250.0
   temp[3]=vsop87c_pico_velocities.venus_z(t) / 365250.0

   return temp;
end

function vsop87c_pico_velocities.getEarth(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87c_pico_velocities.earth_x(t) / 365250.0
   temp[2]=vsop87c_pico_velocities.earth_y(t) / 365250.0
   temp[3]=vsop87c_pico_velocities.earth_z(t) / 365250.0

   return temp;
end

function vsop87c_pico_velocities.getMars(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87c_pico_velocities.mars_x(t) / 365250.0
   temp[2]=vsop87c_pico_velocities.mars_y(t) / 365250.0
   temp[3]=vsop87c_pico_velocities.mars_z(t) / 365250.0

   return temp;
end

function vsop87c_pico_velocities.getJupiter(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87c_pico_velocities.jupiter_x(t) / 365250.0
   temp[2]=vsop87c_pico_velocities.jupiter_y(t) / 365250.0
   temp[3]=vsop87c_pico_velocities.jupiter_z(t) / 365250.0

   return temp;
end

function vsop87c_pico_velocities.getSaturn(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87c_pico_velocities.saturn_x(t) / 365250.0
   temp[2]=vsop87c_pico_velocities.saturn_y(t) / 365250.0
   temp[3]=vsop87c_pico_velocities.saturn_z(t) / 365250.0

   return temp;
end

function vsop87c_pico_velocities.getUranus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87c_pico_velocities.uranus_x(t) / 365250.0
   temp[2]=vsop87c_pico_velocities.uranus_y(t) / 365250.0
   temp[3]=vsop87c_pico_velocities.uranus_z(t) / 365250.0

   return temp;
end

function vsop87c_pico_velocities.getNeptune(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87c_pico_velocities.neptune_x(t) / 365250.0
   temp[2]=vsop87c_pico_velocities.neptune_y(t) / 365250.0
   temp[3]=vsop87c_pico_velocities.neptune_z(t) / 365250.0

   return temp;
end

function vsop87c_pico_velocities.earth_x(t)
   local earth_x_0 = 0.0
...
function vsop87c_pico_velocities.earth_y(t)
   local earth_y_0 = 0.0
...
function vsop87c_pico_velocities.earth_z(t)
   return 0
end

function vsop87c_pico_velocities.jupiter_x(t)
...
function vsop87c_pico_velocities.jupiter_y(t)
...
function vsop87c_pico_velocities.jupiter_z(t)
...
function vsop87c_pico_velocities.mars_x(t)
   local mars_x_0 = 0.0
...
function vsop87c_pico_velocities.mars_y(t)
   local mars_y_0 = 0.0
...
function vsop87c_pico_velocities.mars_z(t)
   local mars_z_0 = 0.0
...
function vsop87c_pico_velocities.mercury_x(t)
...
function vsop87c_pico_velocities.mercury_y(t)
...
function vsop87c_pico_velocities.mercury_z(t)
...
function vsop87c_pico_velocities.neptune_x(t)
...
function vsop87c_pico_velocities.neptune_y(t)
...
function vsop87c_pico_velocities.neptune_z(t)
...
function vsop87c_pico_velocities.saturn_x(t)
...
function vsop87c_pico_velocities.saturn_y(t)
...
function vsop87c_pico_velocities.saturn_z(t)
...
function vsop87c_pico_velocities.uranus_x(t)
...
function vsop87c_pico_velocities.uranus_y(t)
...
function vsop87c_pico_velocities.uranus_z(t)
...
function vsop87c_pico_velocities.venus_x(t)
   local venus_x_0 = 0.0
...
function vsop87c_pico_velocities.venus_y(t)
   local venus_y_0 = 0.0
...
function vsop87c_pico_velocities.venus_z(t)
   local venus_z_0 = 0.0
...
return vsop87c_pico_velocities
