...
function vsop87e_pico.getMercury(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.mercury_x(t)
   temp[2]=vsop87e_pico.mercury_y(t)
   temp[3]=vsop87e_pico.mercury_z(t)

   return temp;
end

function vsop87e_pico.getVenus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.venus_x(t)
   temp[2]=vsop87e_pico.venus_y(t)
   temp[3]=vsop87e_pico.venus_z(t)

   return temp;
end

function vsop87e_pico.getEarth(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.earth_x(t)
   temp[2]=vsop87e_pico.earth_y(t)
   temp[3]=vsop87e_pico.earth_z(t)

   return temp;
end

function vsop87e_pico.getMars(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.mars_x(t)
   temp[2]=vsop87e_pico.mars_y(t)
   temp[3]=vsop87e_pico.mars_z(t)

   return temp;
end

function vsop87e_pico.getJupiter(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.jupiter_x(t)
   temp[2]=vsop87e_pico.jupiter_y(t)
   temp[3]=vsop87e_pico.jupiter_z(t)

   return temp;
end

function vsop87e_pico.getSaturn(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.saturn_x(t)
   temp[2]=vsop87e_pico.saturn_y(t)
   temp[3]=vsop87e_pico.saturn_z(t)

   return temp;
end

function vsop87e_pico.getUranus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.uranus_x(t)
   temp[2]=vsop87e_pico.uranus_y(t)
   temp[3]=vsop87e_pico.uranus_z(t)

   return temp;
end

function vsop87e_pico.getNeptune(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.neptune_x(t)
   temp[2]=vsop87e_pico.neptune_y(t)
   temp[3]=vsop87e_pico.neptune_z(t)

   return temp;
end

function vsop87e_pico.getSun(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_pico.sun_x(t)
   temp[2]=vsop87e_pico.sun_y(t)
   temp[3]=vsop87e_pico.sun_z(t)

   return temp;
end

function vsop87e_pico.earth_x(t)
   local earth_x_0 = 0.0
...
function vsop87e_pico.earth_y(t)
   local earth_y_0 = 0.0
...
function vsop87e_pico.earth_z(t)
   return 0
end

function vsop87e_pico.jupiter_x(t)
...
function vsop87e_pico.jupiter_y(t)
...
function vsop87e_pico.jupiter_z(t)
...
function vsop87e_pico.mars_x(t)
   local mars_x_0 = 0.0
...
function vsop87e_pico.mars_y(t)
   local mars_y_0 = 0.0
...
function vsop87e_pico.mars_z(t)
   local mars_z_0 = 0.0
...
function vsop87e_pico.mercury_x(t)
...
function vsop87e_pico.mercury_y(t)
...
function vsop87e_pico.mercury_z(t)
...
function vsop87e_pico.neptune_x(t)
...
function vsop87e_pico.neptune_y(t)
...
function vsop87e_pico.neptune_z(t)
...
function vsop87e_pico.saturn_x(t)
...
function vsop87e_pico.saturn_y(t)
...
function vsop87e_pico.saturn_z(t)
...
function vsop87e_pico.sun_x(t)
   return 0
end

function vsop87e_pico.sun_y(t)
   return 0
end

function vsop87e_pico.sun_z(t)
   return 0
end

function vsop87e_pico.uranus_x(t)
...
function vsop87e_pico.uranus_y(t)
...
function vsop87e_pico.uranus_z(t)
...
function vsop87e_pico.venus_x(t)
   local venus_x_0 = 0.0
...
function vsop87e_pico.venus_y(t)
   local venus_y_0 = 0.0
...
function vsop87e_pico.venus_z(t)
   local venus_z_0 = 0.0
