...
function vsop87e_nano.getMercury(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.mercury_x(t)
   temp[2]=vsop87e_nano.mercury_y(t)
   temp[3]=vsop87e_nano.mercury_z(t)

   return temp;
end

function vsop87e_nano.getVenus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.venus_x(t)
   temp[2]=vsop87e_nano.venus_y(t)
   temp[3]=vsop87e_nano.venus_z(t)

   return temp;
end

function vsop87e_nano.getEarth(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.earth_x(t)
   temp[2]=vsop87e_nano.earth_y(t)
   temp[3]=vsop87e_nano.earth_z(t)

   return temp;
end

function vsop87e_nano.getMars(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.mars_x(t)
   temp[2]=vsop87e_nano.mars_y(t)
   temp[3]=vsop87e_nano.mars_z(t)

   return temp;
end

function vsop87e_nano.getJupiter(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.jupiter_x(t)
   temp[2]=vsop87e_nano.jupiter_y(t)
   temp[3]=vsop87e_nano.jupiter_z(t)

   return temp;
end

function vsop87e_nano.getSaturn(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.saturn_x(t)
   temp[2]=vsop87e_nano.saturn_y(t)
   temp[3]=vsop87e_nano.saturn_z(t)

   return temp;
end

function vsop87e_nano.getUranus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.uranus_x(t)
   temp[2]=vsop87e_nano.uranus_y(t)
   temp[3]=vsop87e_nano.uranus_z(t)

   return temp;
end

function vsop87e_nano.getNeptune(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.neptune_x(t)
   temp[2]=vsop87e_nano.neptune_y(t)
   temp[3]=vsop87e_nano.neptune_z(t)

   return temp;
end

function vsop87e_nano.getSun(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87e_nano.sun_x(t)
   temp[2]=vsop87e_nano.sun_y(t)
   temp[3]=vsop87e_nano.sun_z(t)

   return temp;
end

function vsop87e_nano.earth_x(t)
   local earth_x_0 = 0.0
...
function vsop87e_nano.earth_y(t)
   local earth_y_0 = 0.0
...
function vsop87e_nano.earth_z(t)
   local earth_z_1 = 0.0
...
function vsop87e_nano.jupiter_x(t)
...
function vsop87e_nano.jupiter_y(t)
...
function vsop87e_nano.jupiter_z(t)
...
function vsop87e_nano.mars_x(t)
   local mars_x_0 = 0.0
...
function vsop87e_nano.mars_y(t)
   local mars_y_0 = 0.0
...
function vsop87e_nano.mars_z(t)
   local mars_z_0 = 0.0
...
function vsop87e_nano.mercury_x(t)
...
function vsop87e_nano.mercury_y(t)
...
function vsop87e_nano.mercury_z(t)
...
function vsop87e_nano.neptune_x(t)
...
function vsop87e_nano.neptune_y(t)
...
function vsop87e_nano.neptune_z(t)
...
function vsop87e_nano.saturn_x(t)
...
function vsop87e_nano.saturn_y(t)
...
function vsop87e_nano.saturn_z(t)
...
function vsop87e_nano.sun_z(t)
   return 0
end

function vsop87e_nano.uranus_x(t)
...
function vsop87e_nano.uranus_y(t)
...
function vsop87e_nano.uranus_z(t)
...
function vsop87e_nano.venus_x(t)
   local venus_x_0 = 0.0
...
function vsop87e_nano.venus_y(t)
   local venus_y_0 = 0.0
...
function vsop87e_nano.venus_z(t)
   local venus_z_0 = 0.0
