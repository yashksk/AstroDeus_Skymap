...
function vsop87a_micro.getMercury(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.mercury_x(t)
   temp[2]=vsop87a_micro.mercury_y(t)
   temp[3]=vsop87a_micro.mercury_z(t)

   return temp;
end

function vsop87a_micro.getVenus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.venus_x(t)
   temp[2]=vsop87a_micro.venus_y(t)
   temp[3]=vsop87a_micro.venus_z(t)

   return temp;
end

function vsop87a_micro.getEarth(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.earth_x(t)
   temp[2]=vsop87a_micro.earth_y(t)
   temp[3]=vsop87a_micro.earth_z(t)

   return temp;
end

function vsop87a_micro.getMars(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.mars_x(t)
   temp[2]=vsop87a_micro.mars_y(t)
   temp[3]=vsop87a_micro.mars_z(t)

   return temp;
end

function vsop87a_micro.getJupiter(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.jupiter_x(t)
   temp[2]=vsop87a_micro.jupiter_y(t)
   temp[3]=vsop87a_micro.jupiter_z(t)

   return temp;
end

function vsop87a_micro.getSaturn(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.saturn_x(t)
   temp[2]=vsop87a_micro.saturn_y(t)
   temp[3]=vsop87a_micro.saturn_z(t)

   return temp;
end

function vsop87a_micro.getUranus(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.uranus_x(t)
   temp[2]=vsop87a_micro.uranus_y(t)
   temp[3]=vsop87a_micro.uranus_z(t)

   return temp;
end

function vsop87a_micro.getNeptune(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.neptune_x(t)
   temp[2]=vsop87a_micro.neptune_y(t)
   temp[3]=vsop87a_micro.neptune_z(t)

   return temp;
end

function vsop87a_micro.getEmb(t)
   local temp={0.0, 0.0, 0.0}
   temp[1]=vsop87a_micro.emb_x(t)
   temp[2]=vsop87a_micro.emb_y(t)
   temp[3]=vsop87a_micro.emb_z(t)

   return temp;
end

function vsop87a_micro.getMoon(earth, emb)
   local temp={0.0, 0.0, 0,0}
...
function vsop87a_micro.earth_x(t)
   local earth_x_0 = 0.0
...
function vsop87a_micro.earth_y(t)
   local earth_y_0 = 0.0
...
function vsop87a_micro.earth_z(t)
   local earth_z_1 = 0.0
...
function vsop87a_micro.emb_x(t)
   local emb_x_0 = 0.0
...
function vsop87a_micro.emb_y(t)
   local emb_y_0 = 0.0
   ...
   emb_y_1=emb_y_1*t*t*t

   emb_y_1=emb_y_1*t*t*t*t

   emb_y_1=emb_y_1*t*t*t*t*t

   return emb_y_0+emb_y_1
end

function vsop87a_micro.emb_z(t)
   local emb_z_1 = 0.0
...
function vsop87a_micro.jupiter_x(t)
...
function vsop87a_micro.jupiter_y(t)
...
function vsop87a_micro.jupiter_z(t)
...
function vsop87a_micro.mars_x(t)
   local mars_x_0 = 0.0
...
function vsop87a_micro.mars_y(t)
   local mars_y_0 = 0.0
...
function vsop87a_micro.mars_z(t)
   local mars_z_0 = 0.0
...
function vsop87a_micro.mercury_x(t)
...
function vsop87a_micro.mercury_y(t)
...
function vsop87a_micro.mercury_z(t)
...
function vsop87a_micro.neptune_x(t)
...
function vsop87a_micro.neptune_y(t)
...
function vsop87a_micro.neptune_z(t)
...
function vsop87a_micro.saturn_x(t)
...
function vsop87a_micro.saturn_y(t)
...
function vsop87a_micro.saturn_z(t)
...
function vsop87a_micro.uranus_x(t)
...
function vsop87a_micro.uranus_y(t)
...
function vsop87a_micro.uranus_z(t)
...
function vsop87a_micro.venus_x(t)
   local venus_x_0 = 0.0
...
function vsop87a_micro.venus_y(t)
   local venus_y_0 = 0.0
...
function vsop87a_micro.venus_z(t)
   local venus_z_0 = 0.0
