...
class vsop87b_nano :
   ...
   def getEarth(t):
      temp=[]
      temp.append(vsop87b_nano.earth_l(t))
      temp.append(vsop87b_nano.earth_b(t))
      temp.append(vsop87b_nano.earth_r(t))
      return temp
   ...
   def getJupiter(t):
      temp=[]
      temp.append(vsop87b_nano.jupiter_l(t))
      temp.append(vsop87b_nano.jupiter_b(t))
      temp.append(vsop87b_nano.jupiter_r(t))
      return temp
   ...
   def getMars(t):
      temp=[]
      temp.append(vsop87b_nano.mars_l(t))
      temp.append(vsop87b_nano.mars_b(t))
      temp.append(vsop87b_nano.mars_r(t))
      return temp
   ...
   def getMercury(t):
      temp=[]
      temp.append(vsop87b_nano.mercury_l(t))
      temp.append(vsop87b_nano.mercury_b(t))
      temp.append(vsop87b_nano.mercury_r(t))
      return temp
   ...
   def getNeptune(t):
      temp=[]
      temp.append(vsop87b_nano.neptune_l(t))
      temp.append(vsop87b_nano.neptune_b(t))
      temp.append(vsop87b_nano.neptune_r(t))
      return temp
   ...
   def getSaturn(t):
      temp=[]
      temp.append(vsop87b_nano.saturn_l(t))
      temp.append(vsop87b_nano.saturn_b(t))
      temp.append(vsop87b_nano.saturn_r(t))
      return temp
   ...
   def getUranus(t):
      temp=[]
      temp.append(vsop87b_nano.uranus_l(t))
      temp.append(vsop87b_nano.uranus_b(t))
      temp.append(vsop87b_nano.uranus_r(t))
      return temp
   ...
   def getVenus(t):
      temp=[]
      temp.append(vsop87b_nano.venus_l(t))
      temp.append(vsop87b_nano.venus_b(t))
      temp.append(vsop87b_nano.venus_r(t))
      return temp
