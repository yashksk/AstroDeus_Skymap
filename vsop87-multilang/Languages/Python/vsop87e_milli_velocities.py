...
class vsop87e_milli_velocities :
   ...
   def getEarth(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.earth_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.earth_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.earth_z(t) / 365250.0)
      return temp
   ...
   def getJupiter(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.jupiter_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.jupiter_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.jupiter_z(t) / 365250.0)
      return temp
   ...
   def getMars(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.mars_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.mars_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.mars_z(t) / 365250.0)
      return temp
   ...
   def getMercury(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.mercury_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.mercury_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.mercury_z(t) / 365250.0)
      return temp
   ...
   def getNeptune(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.neptune_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.neptune_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.neptune_z(t) / 365250.0)
      return temp
   ...
   def getSaturn(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.saturn_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.saturn_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.saturn_z(t) / 365250.0)
      return temp
   ...
   def getUranus(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.uranus_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.uranus_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.uranus_z(t) / 365250.0)
      return temp
   ...
   def getVenus(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.venus_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.venus_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.venus_z(t) / 365250.0)
      return temp
   ...
   def getSun(t):
      temp=[]
      temp.append(vsop87e_milli_velocities.sun_x(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.sun_y(t) / 365250.0)
      temp.append(vsop87e_milli_velocities.sun_z(t) / 365250.0)
      return temp
   ...
   def earth_x(t):
      ...
      earth_x_0+=-math.pow(t,exp)*     0.00007614486*     426.59819087600*math.sin( 3.24052535910 +      426.59819087600*t)
      earth_x_0+=-math.pow(t,exp)*     0.00003110838*   83996.84731811189*math.sin( 0.66875185215 +    83996.84731811189*t)
      earth_x_0+=-math.pow(t,exp)*     0.00001940284*     206.18554843720*math.sin( 1.01236647756 +      206.18554843720*t)
      earth_x_0+=-math.pow(t,exp)*     0.00001941229*     149.56319713460*math.sin( 4.79891913828 +      149.56319713460*t)
      earth_x_0+=-math.pow(t,exp)*     0.00001887816*     220.41264243880*math.sin( 3.89254735986 +      220.41264243880*t)
      ...
      earth_x_0+=-math.pow(t,exp)*     0.00001427281*     522.57741809380*math.sin( 3.86901277110 +      522.57741809380*t)
      earth_x_0+=-math.pow(t,exp)*     0.00001399119*     536.80451209540*math.sin( 0.47619416596 +      536.80451209540*t)
      earth_x_0+=-math.pow(t,exp)*     0.00001186109*      76.26607127560*math.sin( 0.77647243459 +       76.26607127560*t)
      ...
      earth_x_1+=math.pow(t,exp-1)*exp*     0.00001290723*math.cos( 5.95943124583 +    18849.22754997420*t)-math.pow(t,exp)*     0.00001290723*   18849.22754997420*math.sin( 5.95943124583 +    18849.22754997420*t)
      ...
      earth_x_2=0.0
      exp=2
      earth_x_2+=math.pow(t,exp-1)*exp*     0.00004098432*math.cos( 3.14159265359 +        0.00000000000*t)-math.pow(t,exp)*     0.00004098432*       0.00000000000*math.sin( 3.14159265359 +        0.00000000000*t)
      earth_x_2+=math.pow(t,exp-1)*exp*     0.00002175689*math.cos( 4.39999849572 +    12566.15169998280*t)-math.pow(t,exp)*     0.00002175689*   12566.15169998280*math.sin( 4.39999849572 +    12566.15169998280*t)
   ...
   def earth_y(t):
      ...
      earth_y_0+=-math.pow(t,exp)*     0.00007623032*     426.59819087600*math.sin( 1.66896617535 +      426.59819087600*t)
      earth_y_0+=-math.pow(t,exp)*     0.00003110838*   83996.84731811189*math.sin( 5.38114091484 +    83996.84731811189*t)
      earth_y_0+=-math.pow(t,exp)*     0.00001962913*     206.18554843720*math.sin( 5.70756734336 +      206.18554843720*t)
      earth_y_0+=-math.pow(t,exp)*     0.00001940704*     149.56319713460*math.sin( 3.22808267633 +      149.56319713460*t)
      earth_y_0+=-math.pow(t,exp)*     0.00001890481*     220.41264243880*math.sin( 2.32098683748 +      220.41264243880*t)
      ...
      earth_y_0+=-math.pow(t,exp)*     0.00001429933*     522.57741809380*math.sin( 2.30184513257 +      522.57741809380*t)
      earth_y_0+=-math.pow(t,exp)*     0.00001398661*     536.80451209540*math.sin( 5.18874483163 +      536.80451209540*t)
      earth_y_0+=-math.pow(t,exp)*     0.00001185789*      76.26607127560*math.sin( 5.48845966910 +       76.26607127560*t)
      ...
      earth_y_1+=math.pow(t,exp-1)*exp*     0.00001290796*math.cos( 4.38860548540 +    18849.22754997420*t)-math.pow(t,exp)*     0.00001290796*   18849.22754997420*math.sin( 4.38860548540 +    18849.22754997420*t)

      earth_y_2=0.0
      exp=2
      earth_y_2+=math.pow(t,exp-1)*exp*     0.00005024394*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00005024394*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
      earth_y_2+=math.pow(t,exp-1)*exp*     0.00002178009*math.cos( 2.82957544235 +    12566.15169998280*t)-math.pow(t,exp)*     0.00002178009*   12566.15169998280*math.sin( 2.82957544235 +    12566.15169998280*t)
   ...
   def earth_z(t):
      ...
      earth_z_0+=-math.pow(t,exp)*     0.00004802048*      38.13303563780*math.sin( 4.58264723370 +       38.13303563780*t)
      earth_z_0+=-math.pow(t,exp)*     0.00001131046*      74.78159856730*math.sin( 5.75877139035 +       74.78159856730*t)
      earth_z_0+=-math.pow(t,exp)*     0.00001153742*       0.00000000000*math.sin( 3.14159265359 +        0.00000000000*t)
      ...
      earth_z_1+=math.pow(t,exp-1)*exp*     0.00005562680*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00005562680*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
      earth_z_1+=math.pow(t,exp-1)*exp*     0.00001903177*math.cos( 3.37061270964 +    12566.15169998280*t)-math.pow(t,exp)*     0.00001903177*   12566.15169998280*math.sin( 3.37061270964 +    12566.15169998280*t)

      earth_z_2=0.0
      exp=2
      earth_z_2+=math.pow(t,exp-1)*exp*     0.00009721959*math.cos( 5.15233725915 +     6283.07584999140*t)-math.pow(t,exp)*     0.00009721959*    6283.07584999140*math.sin( 5.15233725915 +     6283.07584999140*t)
   ...
   def jupiter_x(t):
      ...
      jupiter_x_0+=-math.pow(t,exp)*     0.00008644882*     639.89728631400*math.sin( 3.44286036345 +      639.89728631400*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00008215382*    1478.86657406440*math.sin( 5.56679457251 +     1478.86657406440*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00008685802*    1692.16566950240*math.sin( 0.38261930513 +     1692.16566950240*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00007420564*     956.28915597060*math.sin( 5.98378614130 +      956.28915597060*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00007509247*    1265.56747862640*math.sin( 0.92899131174 +     1265.56747862640*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00007648488*    1581.95934828300*math.sin( 0.14179788518 +     1581.95934828300*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00005313717*     526.50957135690*math.sin( 1.10494056939 +      526.50957135690*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00005213514*     532.87235883230*math.sin( 3.23235134289 +      532.87235883230*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00005784803*      14.22709400160*math.sin( 5.03723192214 +       14.22709400160*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00004618326*    1375.77379984580*math.sin( 3.75817737683 +     1375.77379984580*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00003936106*    1596.18644228460*math.sin( 4.30892684064 +     1596.18644228460*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00004563043*      95.97922721780*math.sin( 2.15085906522 +       95.97922721780*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00004327077*     220.41264243880*math.sin( 3.89002424313 +      220.41264243880*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00002951688*     309.27832265580*math.sin( 3.85995854320 +      309.27832265580*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00002857648*     117.31986822020*math.sin( 6.00878402632 +      117.31986822020*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00002488143*     433.71173787680*math.sin( 4.20187706224 +      433.71173787680*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00002672563*    1169.58825140860*math.sin( 3.18723991996 +     1169.58825140860*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00002384137*    1045.15483618760*math.sin( 5.96358219365 +     1045.15483618760*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001868284*    1155.36115740700*math.sin( 0.52057031963 +     1155.36115740700*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001936427*     625.67019231240*math.sin( 5.91866009507 +      625.67019231240*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001630097*     942.06206196900*math.sin( 4.41892602527 +      942.06206196900*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001440172*     853.19638175200*math.sin( 5.76918543554 +      853.19638175200*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001516494*      76.26607127560*math.sin( 0.81626038026 +       76.26607127560*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001360798*    1368.66025284500*math.sin( 1.34765113779 +     1368.66025284500*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001663482*     838.96928775040*math.sin( 1.94059445684 +      838.96928775040*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001032537*    1795.25844372100*math.sin( 0.08907922138 +     1795.25844372100*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001067098*     149.56319713460*math.sin( 5.07387579789 +      149.56319713460*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001087247*     527.24328453980*math.sin( 1.13406114807 +      527.24328453980*t)
      jupiter_x_0+=-math.pow(t,exp)*     0.00001079612*     532.13864564940*math.sin( 3.20528367741 +      532.13864564940*t)
      ...
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00009117208*math.cos( 1.78082300783 +      543.91805909620*t)-math.pow(t,exp)*     0.00009117208*     543.91805909620*math.sin( 1.78082300783 +      543.91805909620*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00008078237*math.cos( 6.16137042548 +      949.17560896980*t)-math.pow(t,exp)*     0.00008078237*     949.17560896980*math.sin( 6.16137042548 +      949.17560896980*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00007139253*math.cos( 3.17225778048 +      323.50541665740*t)-math.pow(t,exp)*     0.00007139253*     323.50541665740*math.sin( 3.17225778048 +      323.50541665740*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00003998647*math.cos( 4.57586236640 +      206.18554843720*t)-math.pow(t,exp)*     0.00003998647*     206.18554843720*math.sin( 4.57586236640 +      206.18554843720*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00004389657*math.cos( 1.14770871584 +      735.87651353180*t)-math.pow(t,exp)*     0.00004389657*     735.87651353180*math.sin( 1.14770871584 +      735.87651353180*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00003395920*math.cos( 2.90091460302 +      526.50957135690*t)-math.pow(t,exp)*     0.00003395920*     526.50957135690*math.sin( 2.90091460302 +      526.50957135690*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00003330163*math.cos( 1.43691666191 +      532.87235883230*t)-math.pow(t,exp)*     0.00003330163*     532.87235883230*math.sin( 1.43691666191 +      532.87235883230*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00003878456*math.cos( 3.33647235000 +       14.22709400160*t)-math.pow(t,exp)*     0.00003878456*      14.22709400160*math.sin( 3.33647235000 +       14.22709400160*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00003041505*math.cos( 1.65428068117 +      525.75881183150*t)-math.pow(t,exp)*     0.00003041505*     525.75881183150*math.sin( 1.65428068117 +      525.75881183150*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00002999010*math.cos( 2.68376980775 +      533.62311835770*t)-math.pow(t,exp)*     0.00002999010*     533.62311835770*math.sin( 2.68376980775 +      533.62311835770*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00002984688*math.cos( 2.59503648367 +      419.48464387520*t)-math.pow(t,exp)*     0.00002984688*     419.48464387520*math.sin( 2.59503648367 +      419.48464387520*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00002416946*math.cos( 3.60563658924 +      316.39186965660*t)-math.pow(t,exp)*     0.00002416946*     316.39186965660*math.sin( 3.60563658924 +      316.39186965660*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00002799836*math.cos( 4.89523847324 +      103.09277421860*t)-math.pow(t,exp)*     0.00002799836*     103.09277421860*math.sin( 4.89523847324 +      103.09277421860*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00002987393*math.cos( 0.80692150498 +     2118.76386037840*t)-math.pow(t,exp)*     0.00002987393*    2118.76386037840*math.sin( 0.80692150498 +     2118.76386037840*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001975662*math.cos( 5.08913465136 +      956.28915597060*t)-math.pow(t,exp)*     0.00001975662*     956.28915597060*math.sin( 5.08913465136 +      956.28915597060*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001851910*math.cos( 2.76941008977 +     1596.18644228460*t)-math.pow(t,exp)*     0.00001851910*    1596.18644228460*math.sin( 2.76941008977 +     1596.18644228460*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001770816*math.cos( 0.72643844818 +      742.99006053260*t)-math.pow(t,exp)*     0.00001770816*     742.99006053260*math.sin( 0.72643844818 +      742.99006053260*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001810452*math.cos( 3.84597080211 +       95.97922721780*t)-math.pow(t,exp)*     0.00001810452*      95.97922721780*math.sin( 3.84597080211 +       95.97922721780*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001532798*math.cos( 4.31369306820 +      117.31986822020*t)-math.pow(t,exp)*     0.00001532798*     117.31986822020*math.sin( 4.31369306820 +      117.31986822020*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001735409*math.cos( 2.18944094588 +      220.41264243880*t)-math.pow(t,exp)*     0.00001735409*     220.41264243880*math.sin( 2.18944094588 +      220.41264243880*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001902258*math.cos( 1.85937281972 +     1581.95934828300*t)-math.pow(t,exp)*     0.00001902258*    1581.95934828300*math.sin( 1.85937281972 +     1581.95934828300*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001572591*math.cos( 1.43756120627 +      639.89728631400*t)-math.pow(t,exp)*     0.00001572591*     639.89728631400*math.sin( 1.43756120627 +      639.89728631400*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001630801*math.cos( 1.41506089245 +     1045.15483618760*t)-math.pow(t,exp)*     0.00001630801*    1045.15483618760*math.sin( 1.41506089245 +     1045.15483618760*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001042283*math.cos( 2.52301939233 +      433.71173787680*t)-math.pow(t,exp)*     0.00001042283*     433.71173787680*math.sin( 2.52301939233 +      433.71173787680*t)
      jupiter_x_1+=math.pow(t,exp-1)*exp*     0.00001054423*math.cos( 2.50841911774 +     1265.56747862640*t)-math.pow(t,exp)*     0.00001054423*    1265.56747862640*math.sin( 2.50841911774 +     1265.56747862640*t)
      ...
      jupiter_x_2+=math.pow(t,exp-1)*exp*     0.00007044790*math.cos( 0.74164610282 +     1066.49547719000*t)-math.pow(t,exp)*     0.00007044790*    1066.49547719000*math.sin( 0.74164610282 +     1066.49547719000*t)
      jupiter_x_2+=math.pow(t,exp-1)*exp*     0.00005705577*math.cos( 3.63172956803 +     1052.26838318840*t)-math.pow(t,exp)*     0.00005705577*    1052.26838318840*math.sin( 3.63172956803 +     1052.26838318840*t)
      jupiter_x_2+=math.pow(t,exp-1)*exp*     0.00005237617*math.cos( 4.27483099739 +      515.46387109300*t)-math.pow(t,exp)*     0.00005237617*     515.46387109300*math.sin( 4.27483099739 +      515.46387109300*t)
      jupiter_x_2+=math.pow(t,exp-1)*exp*     0.00004035686*math.cos( 5.58417734606 +     1589.07289528380*t)-math.pow(t,exp)*     0.00004035686*    1589.07289528380*math.sin( 5.58417734606 +     1589.07289528380*t)
      jupiter_x_2+=math.pow(t,exp-1)*exp*     0.00003702934*math.cos( 0.07769815851 +      543.91805909620*t)-math.pow(t,exp)*     0.00003702934*     543.91805909620*math.sin( 0.07769815851 +      543.91805909620*t)
      jupiter_x_2+=math.pow(t,exp-1)*exp*     0.00001699253*math.cos( 2.44298781002 +      110.20632121940*t)-math.pow(t,exp)*     0.00001699253*     110.20632121940*math.sin( 2.44298781002 +      110.20632121940*t)
      jupiter_x_2+=math.pow(t,exp-1)*exp*     0.00001070085*math.cos( 2.35010899461 +      426.59819087600*t)-math.pow(t,exp)*     0.00001070085*     426.59819087600*math.sin( 2.35010899461 +      426.59819087600*t)
      jupiter_x_2+=math.pow(t,exp-1)*exp*     0.00001324360*math.cos( 1.63141799079 +       14.22709400160*t)-math.pow(t,exp)*     0.00001324360*      14.22709400160*math.sin( 1.63141799079 +       14.22709400160*t)
      ...
      jupiter_x_3+=math.pow(t,exp-1)*exp*     0.00003350618*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00003350618*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
      jupiter_x_3+=math.pow(t,exp-1)*exp*     0.00001786132*math.cos( 3.56550369113 +     1059.38193018920*t)-math.pow(t,exp)*     0.00001786132*    1059.38193018920*math.sin( 3.56550369113 +     1059.38193018920*t)
      jupiter_x_3+=math.pow(t,exp-1)*exp*     0.00001434074*math.cos( 5.98502536112 +      515.46387109300*t)-math.pow(t,exp)*     0.00001434074*     515.46387109300*math.sin( 5.98502536112 +      515.46387109300*t)
      jupiter_x_3+=math.pow(t,exp-1)*exp*     0.00001079157*math.cos( 5.42531629895 +     1066.49547719000*t)-math.pow(t,exp)*     0.00001079157*    1066.49547719000*math.sin( 5.42531629895 +     1066.49547719000*t)
      jupiter_x_3+=math.pow(t,exp-1)*exp*     0.00001013242*math.cos( 4.64773742759 +      543.91805909620*t)-math.pow(t,exp)*     0.00001013242*     543.91805909620*math.sin( 4.64773742759 +      543.91805909620*t)
      jupiter_x_3+=math.pow(t,exp-1)*exp*     0.00001074445*math.cos( 6.22324523848 +        7.11354700080*t)-math.pow(t,exp)*     0.00001074445*       7.11354700080*math.sin( 6.22324523848 +        7.11354700080*t)

      jupiter_x_4=0.0
      exp=4
      jupiter_x_4+=math.pow(t,exp-1)*exp*     0.00001760720*math.cos( 1.32863064568 +      522.57741809380*t)-math.pow(t,exp)*     0.00001760720*     522.57741809380*math.sin( 1.32863064568 +      522.57741809380*t)
      jupiter_x_4+=math.pow(t,exp-1)*exp*     0.00001716208*math.cos( 3.03331509801 +      536.80451209540*t)-math.pow(t,exp)*     0.00001716208*     536.80451209540*math.sin( 3.03331509801 +      536.80451209540*t)
   ...
   def jupiter_y(t):
      ...
      jupiter_y_0+=-math.pow(t,exp)*     0.00008616295*     639.89728631400*math.sin( 1.88432673589 +      639.89728631400*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00008155250*    1478.86657406440*math.sin( 4.00303466226 +     1478.86657406440*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00008724471*    1692.16566950240*math.sin( 5.09607077968 +     1692.16566950240*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00007407157*     956.28915597060*math.sin( 4.41139821796 +      956.28915597060*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00007612244*    1265.56747862640*math.sin( 5.59551514884 +     1265.56747862640*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00007771810*    1581.95934828300*math.sin( 4.83345042174 +     1581.95934828300*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00005317804*     526.50957135690*math.sin( 5.81740415262 +      526.50957135690*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00005212049*     532.87235883230*math.sin( 1.66178652182 +      532.87235883230*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00005779694*      14.22709400160*math.sin( 3.46910255172 +       14.22709400160*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00004523994*    1375.77379984580*math.sin( 2.18377830705 +     1375.77379984580*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00003936117*    1596.18644228460*math.sin( 2.73830533792 +     1596.18644228460*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00004560167*      95.97922721780*math.sin( 3.71314128422 +       95.97922721780*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00004315104*     220.41264243880*math.sin( 2.32571714706 +      220.41264243880*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00003233079*     625.67019231240*math.sin( 4.76624918569 +      625.67019231240*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00003143497*     309.27832265580*math.sin( 5.59546424392 +      309.27832265580*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00002855098*     117.31986822020*math.sin( 4.44236932266 +      117.31986822020*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00002493551*     433.71173787680*math.sin( 2.63229075589 +      433.71173787680*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00002253179*     838.96928775040*math.sin( 4.28438309510 +      838.96928775040*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00002669715*    1169.58825140860*math.sin( 1.61858602910 +     1169.58825140860*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00002360832*    1155.36115740700*math.sin( 4.60394012299 +     1155.36115740700*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00002407297*    1045.15483618760*math.sin( 4.33193163020 +     1045.15483618760*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00001446641*     853.19638175200*math.sin( 4.19563248990 +      853.19638175200*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00001430793*     942.06206196900*math.sin( 3.24847402298 +      942.06206196900*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00001515123*      76.26607127560*math.sin( 5.52831163402 +       76.26607127560*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00001049240*    1795.25844372100*math.sin( 4.83710121026 +     1795.25844372100*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00001068309*     149.56319713460*math.sin( 3.50234523972 +      149.56319713460*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00001001392*    1272.68102562720*math.sin( 1.50933910971 +     1272.68102562720*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00001086691*     527.24328453980*math.sin( 5.84673086007 +      527.24328453980*t)
      jupiter_y_0+=-math.pow(t,exp)*     0.00001078483*     532.13864564940*math.sin( 1.63448489409 +      532.13864564940*t)
      ...
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00009113996*math.cos( 0.21022418619 +      543.91805909620*t)-math.pow(t,exp)*     0.00009113996*     543.91805909620*math.sin( 0.21022418619 +      543.91805909620*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00008101295*math.cos( 4.58123045927 +      949.17560896980*t)-math.pow(t,exp)*     0.00008101295*     949.17560896980*math.sin( 4.58123045927 +      949.17560896980*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00007141932*math.cos( 1.60339474172 +      323.50541665740*t)-math.pow(t,exp)*     0.00007141932*     323.50541665740*math.sin( 1.60339474172 +      323.50541665740*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00004284393*math.cos( 0.07490444220 +      206.18554843720*t)-math.pow(t,exp)*     0.00004284393*     206.18554843720*math.sin( 0.07490444220 +      206.18554843720*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00004343053*math.cos( 5.85522747181 +      735.87651353180*t)-math.pow(t,exp)*     0.00004343053*     735.87651353180*math.sin( 5.85522747181 +      735.87651353180*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00003398490*math.cos( 1.33033169180 +      526.50957135690*t)-math.pow(t,exp)*     0.00003398490*     526.50957135690*math.sin( 1.33033169180 +      526.50957135690*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00003328707*math.cos( 6.14951855343 +      532.87235883230*t)-math.pow(t,exp)*     0.00003328707*     532.87235883230*math.sin( 6.14951855343 +      532.87235883230*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00003148193*math.cos( 0.98470202558 +      419.48464387520*t)-math.pow(t,exp)*     0.00003148193*     419.48464387520*math.sin( 0.98470202558 +      419.48464387520*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00003871201*math.cos( 1.76872695106 +       14.22709400160*t)-math.pow(t,exp)*     0.00003871201*      14.22709400160*math.sin( 1.76872695106 +       14.22709400160*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00003041302*math.cos( 0.08329755674 +      525.75881183150*t)-math.pow(t,exp)*     0.00003041302*     525.75881183150*math.sin( 0.08329755674 +      525.75881183150*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00002998620*math.cos( 1.11280597644 +      533.62311835770*t)-math.pow(t,exp)*     0.00002998620*     533.62311835770*math.sin( 1.11280597644 +      533.62311835770*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00002972552*math.cos( 3.35303238649 +      103.09277421860*t)-math.pow(t,exp)*     0.00002972552*     103.09277421860*math.sin( 3.35303238649 +      103.09277421860*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00002325776*math.cos( 2.06697271149 +      316.39186965660*t)-math.pow(t,exp)*     0.00002325776*     316.39186965660*math.sin( 2.06697271149 +      316.39186965660*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00002987340*math.cos( 5.51944851941 +     2118.76386037840*t)-math.pow(t,exp)*     0.00002987340*    2118.76386037840*math.sin( 5.51944851941 +     2118.76386037840*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001873488*math.cos( 5.32656155620 +      742.99006053260*t)-math.pow(t,exp)*     0.00001873488*     742.99006053260*math.sin( 5.32656155620 +      742.99006053260*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001852299*math.cos( 1.19908749676 +     1596.18644228460*t)-math.pow(t,exp)*     0.00001852299*    1596.18644228460*math.sin( 1.19908749676 +     1596.18644228460*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001966492*math.cos( 3.51895000316 +      956.28915597060*t)-math.pow(t,exp)*     0.00001966492*     956.28915597060*math.sin( 3.51895000316 +      956.28915597060*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001805775*math.cos( 5.40302012288 +       95.97922721780*t)-math.pow(t,exp)*     0.00001805775*      95.97922721780*math.sin( 5.40302012288 +       95.97922721780*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001530303*math.cos( 2.74905823262 +      117.31986822020*t)-math.pow(t,exp)*     0.00001530303*     117.31986822020*math.sin( 2.74905823262 +      117.31986822020*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001727332*math.cos( 0.63018404294 +      220.41264243880*t)-math.pow(t,exp)*     0.00001727332*     220.41264243880*math.sin( 0.63018404294 +      220.41264243880*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001883583*math.cos( 0.29906423084 +     1581.95934828300*t)-math.pow(t,exp)*     0.00001883583*    1581.95934828300*math.sin( 0.29906423084 +     1581.95934828300*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001548330*math.cos( 6.17417483830 +      639.89728631400*t)-math.pow(t,exp)*     0.00001548330*     639.89728631400*math.sin( 6.17417483830 +      639.89728631400*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001635354*math.cos( 6.09268929177 +     1045.15483618760*t)-math.pow(t,exp)*     0.00001635354*    1045.15483618760*math.sin( 6.09268929177 +     1045.15483618760*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001259066*math.cos( 0.07170674498 +      625.67019231240*t)-math.pow(t,exp)*     0.00001259066*     625.67019231240*math.sin( 0.07170674498 +      625.67019231240*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001046522*math.cos( 0.95429910486 +      433.71173787680*t)-math.pow(t,exp)*     0.00001046522*     433.71173787680*math.sin( 0.95429910486 +      433.71173787680*t)
      jupiter_y_1+=math.pow(t,exp-1)*exp*     0.00001034932*math.cos( 0.98276277734 +     1265.56747862640*t)-math.pow(t,exp)*     0.00001034932*    1265.56747862640*math.sin( 0.98276277734 +     1265.56747862640*t)
      ...
      jupiter_y_2+=math.pow(t,exp-1)*exp*     0.00007044308*math.cos( 5.45405276738 +     1066.49547719000*t)-math.pow(t,exp)*     0.00007044308*    1066.49547719000*math.sin( 5.45405276738 +     1066.49547719000*t)
      jupiter_y_2+=math.pow(t,exp-1)*exp*     0.00005713988*math.cos( 2.05969938998 +     1052.26838318840*t)-math.pow(t,exp)*     0.00005713988*    1052.26838318840*math.sin( 2.05969938998 +     1052.26838318840*t)
      jupiter_y_2+=math.pow(t,exp-1)*exp*     0.00005281117*math.cos( 2.69489901888 +      515.46387109300*t)-math.pow(t,exp)*     0.00005281117*     515.46387109300*math.sin( 2.69489901888 +      515.46387109300*t)
      jupiter_y_2+=math.pow(t,exp-1)*exp*     0.00004035186*math.cos( 4.01341034017 +     1589.07289528380*t)-math.pow(t,exp)*     0.00004035186*    1589.07289528380*math.sin( 4.01341034017 +     1589.07289528380*t)
      jupiter_y_2+=math.pow(t,exp-1)*exp*     0.00003701007*math.cos( 4.79029127004 +      543.91805909620*t)-math.pow(t,exp)*     0.00003701007*     543.91805909620*math.sin( 4.79029127004 +      543.91805909620*t)
      jupiter_y_2+=math.pow(t,exp-1)*exp*     0.00001280839*math.cos( 1.47520232403 +      110.20632121940*t)-math.pow(t,exp)*     0.00001280839*     110.20632121940*math.sin( 1.47520232403 +      110.20632121940*t)
      jupiter_y_2+=math.pow(t,exp-1)*exp*     0.00001322342*math.cos( 0.05782252396 +       14.22709400160*t)-math.pow(t,exp)*     0.00001322342*      14.22709400160*math.sin( 0.05782252396 +       14.22709400160*t)
      ...
      jupiter_y_3+=math.pow(t,exp-1)*exp*     0.00004008677*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00004008677*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
      jupiter_y_3+=math.pow(t,exp-1)*exp*     0.00001780751*math.cos( 1.99283006102 +     1059.38193018920*t)-math.pow(t,exp)*     0.00001780751*    1059.38193018920*math.sin( 1.99283006102 +     1059.38193018920*t)
      jupiter_y_3+=math.pow(t,exp-1)*exp*     0.00001442439*math.cos( 4.40866193494 +      515.46387109300*t)-math.pow(t,exp)*     0.00001442439*     515.46387109300*math.sin( 4.40866193494 +      515.46387109300*t)
      jupiter_y_3+=math.pow(t,exp-1)*exp*     0.00001078368*math.cos( 3.85452121689 +     1066.49547719000*t)-math.pow(t,exp)*     0.00001078368*    1066.49547719000*math.sin( 3.85452121689 +     1066.49547719000*t)
      jupiter_y_3+=math.pow(t,exp-1)*exp*     0.00001012194*math.cos( 3.07729472515 +      543.91805909620*t)-math.pow(t,exp)*     0.00001012194*     543.91805909620*math.sin( 3.07729472515 +      543.91805909620*t)
      jupiter_y_3+=math.pow(t,exp-1)*exp*     0.00001056925*math.cos( 4.70176335380 +        7.11354700080*t)-math.pow(t,exp)*     0.00001056925*       7.11354700080*math.sin( 4.70176335380 +        7.11354700080*t)

      jupiter_y_4=0.0
      exp=4
      jupiter_y_4+=math.pow(t,exp-1)*exp*     0.00001760963*math.cos( 6.04159397216 +      522.57741809380*t)-math.pow(t,exp)*     0.00001760963*     522.57741809380*math.sin( 6.04159397216 +      522.57741809380*t)
      jupiter_y_4+=math.pow(t,exp-1)*exp*     0.00001714409*math.cos( 1.46206285710 +      536.80451209540*t)-math.pow(t,exp)*     0.00001714409*     536.80451209540*math.sin( 1.46206285710 +      536.80451209540*t)
   ...
   def jupiter_z(t):
      ...
      jupiter_z_0+=-math.pow(t,exp)*     0.00007533929*     213.29909543800*math.sin( 0.40110943079 +      213.29909543800*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00007444124*     103.09277421860*math.sin( 5.24190365992 +      103.09277421860*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00006931444*       7.11354700080*math.sin( 1.74968626255 +        7.11354700080*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00004791578*      38.13303563780*math.sin( 4.58130928279 +       38.13303563780*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00005167573*     426.59819087600*math.sin( 1.62389733122 +      426.59819087600*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00003790459*     110.20632121940*math.sin( 2.71176055906 +      110.20632121940*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00003795419*     632.78373931320*math.sin( 2.16708753358 +      632.78373931320*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00002453014*    1052.26838318840*math.sin( 2.96909485714 +     1052.26838318840*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00002459093*    1162.47470440780*math.sin( 2.99891481019 +     1162.47470440780*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00002011946*     419.48464387520*math.sin( 2.68549472534 +      419.48464387520*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00002161688*     846.08283475120*math.sin( 6.26716569996 +      846.08283475120*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00001632059*    1066.49547719000*math.sin( 0.64194850627 +     1066.49547719000*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00001449341*     949.17560896980*math.sin( 1.17106655090 +      949.17560896980*t)
      jupiter_z_0+=-math.pow(t,exp)*     0.00001100709*      74.78159856730*math.sin( 5.77066159190 +       74.78159856730*t)
      ...
      jupiter_z_1+=math.pow(t,exp-1)*exp*     0.00002105152*math.cos( 0.09490717318 +        7.11354700080*t)-math.pow(t,exp)*     0.00002105152*       7.11354700080*math.sin( 0.09490717318 +        7.11354700080*t)
      jupiter_z_1+=math.pow(t,exp-1)*exp*     0.00001229252*math.cos( 3.14222500244 +     1589.07289528380*t)-math.pow(t,exp)*     0.00001229252*    1589.07289528380*math.sin( 3.14222500244 +     1589.07289528380*t)
      ...
      jupiter_z_2+=math.pow(t,exp-1)*exp*     0.00003111783*math.cos( 3.13228615794 +      536.80451209540*t)-math.pow(t,exp)*     0.00003111783*     536.80451209540*math.sin( 3.13228615794 +      536.80451209540*t)
      jupiter_z_2+=math.pow(t,exp-1)*exp*     0.00002377492*math.cos( 0.95574455230 +      522.57741809380*t)-math.pow(t,exp)*     0.00002377492*     522.57741809380*math.sin( 0.95574455230 +      522.57741809380*t)
      jupiter_z_2+=math.pow(t,exp-1)*exp*     0.00001308861*math.cos( 2.05263727229 +     1059.38193018920*t)-math.pow(t,exp)*     0.00001308861*    1059.38193018920*math.sin( 2.05263727229 +     1059.38193018920*t)
   ...
   def mars_x(t):
      ...
      mars_x_0+=-math.pow(t,exp)*     0.00007117418*     426.59819087600*math.sin( 3.35582835022 +      426.59819087600*t)
      ...
      mars_x_0+=-math.pow(t,exp)*     0.00001980977*    1589.07289528380*math.sin( 4.76060234423 +     1589.07289528380*t)
      ...
      mars_x_0+=-math.pow(t,exp)*     0.00001935640*     206.18554843720*math.sin( 1.01281554555 +      206.18554843720*t)
      mars_x_0+=-math.pow(t,exp)*     0.00001958162*    6684.74797174860*math.sin( 1.51914544555 +     6684.74797174860*t)
      mars_x_0+=-math.pow(t,exp)*     0.00001882589*     220.41264243880*math.sin( 3.89281844329 +      220.41264243880*t)
      mars_x_0+=-math.pow(t,exp)*     0.00001899230*     149.56319713460*math.sin( 4.79118006044 +      149.56319713460*t)
      mars_x_0+=-math.pow(t,exp)*     0.00001878785*    6283.07584999140*math.sin( 1.68734377004 +     6283.07584999140*t)
      ...
      mars_x_0+=-math.pow(t,exp)*     0.00001395167*     522.57741809380*math.sin( 3.86838914853 +      522.57741809380*t)
      mars_x_0+=-math.pow(t,exp)*     0.00001202216*      76.26607127560*math.sin( 0.79285185429 +       76.26607127560*t)
      mars_x_0+=-math.pow(t,exp)*     0.00001364897*     536.80451209540*math.sin( 0.47624575868 +      536.80451209540*t)
      ...
      mars_x_1+=math.pow(t,exp-1)*exp*     0.00001506382*math.cos( 3.28863699080 +     1059.38193018920*t)-math.pow(t,exp)*     0.00001506382*    1059.38193018920*math.sin( 3.28863699080 +     1059.38193018920*t)
   ...
   def mars_y(t):
      ...
      mars_y_0+=-math.pow(t,exp)*     0.00007124907*     426.59819087600*math.sin( 1.78378681583 +      426.59819087600*t)
      ...
      mars_y_0+=-math.pow(t,exp)*     0.00001980388*    1589.07289528380*math.sin( 3.18938664693 +     1589.07289528380*t)
      ...
      mars_y_0+=-math.pow(t,exp)*     0.00001959001*     206.18554843720*math.sin( 5.70640609056 +      206.18554843720*t)
      mars_y_0+=-math.pow(t,exp)*     0.00001956411*    6684.74797174860*math.sin( 6.23095843554 +     6684.74797174860*t)
      mars_y_0+=-math.pow(t,exp)*     0.00001885394*     220.41264243880*math.sin( 2.32103716064 +      220.41264243880*t)
      mars_y_0+=-math.pow(t,exp)*     0.00001898728*     149.56319713460*math.sin( 3.22034182982 +      149.56319713460*t)
      mars_y_0+=-math.pow(t,exp)*     0.00001697214*    2544.31441988340*math.sin( 0.81869636263 +     2544.31441988340*t)
      mars_y_0+=-math.pow(t,exp)*     0.00001874200*    6283.07584999140*math.sin( 0.11372848779 +     6283.07584999140*t)
      ...
      mars_y_0+=-math.pow(t,exp)*     0.00001398506*     522.57741809380*math.sin( 2.29986358218 +      522.57741809380*t)
      mars_y_0+=-math.pow(t,exp)*     0.00001201901*      76.26607127560*math.sin( 5.50485513560 +       76.26607127560*t)
      mars_y_0+=-math.pow(t,exp)*     0.00001365144*     536.80451209540*math.sin( 5.18887775599 +      536.80451209540*t)
      ...
      mars_y_1+=math.pow(t,exp-1)*exp*     0.00001505462*math.cos( 1.71640125299 +     1059.38193018920*t)-math.pow(t,exp)*     0.00001505462*    1059.38193018920*math.sin( 1.71640125299 +     1059.38193018920*t)
      ...
      mars_y_3=0.0
      exp=3
      mars_y_3+=math.pow(t,exp-1)*exp*     0.00001451417*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00001451417*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
   ...
   def mars_z(t):
      ...
      mars_z_0+=-math.pow(t,exp)*     0.00004801930*      38.13303563780*math.sin( 4.58262362363 +       38.13303563780*t)
      mars_z_0+=-math.pow(t,exp)*     0.00001321976*   13362.44970679920*math.sin( 4.78186604114 +    13362.44970679920*t)
      mars_z_0+=-math.pow(t,exp)*     0.00001130585*      74.78159856730*math.sin( 5.75854380515 +       74.78159856730*t)
      ...
      mars_z_2+=math.pow(t,exp-1)*exp*     0.00005933274*math.cos( 3.14159265359 +        0.00000000000*t)-math.pow(t,exp)*     0.00005933274*       0.00000000000*math.sin( 3.14159265359 +        0.00000000000*t)
   ...
   def mercury_x(t):
      ...
      mercury_x_0+=-math.pow(t,exp)*     0.00007626285*     426.59819087600*math.sin( 3.24347023009 +      426.59819087600*t)
      mercury_x_0+=-math.pow(t,exp)*     0.00004433373*  156527.41884944518*math.sin( 0.80236674527 +   156527.41884944518*t)
      mercury_x_0+=-math.pow(t,exp)*     0.00001941401*     206.18554843720*math.sin( 1.01217625416 +      206.18554843720*t)
      mercury_x_0+=-math.pow(t,exp)*     0.00001940365*     149.56319713460*math.sin( 4.79909733719 +      149.56319713460*t)
      mercury_x_0+=-math.pow(t,exp)*     0.00001888858*     220.41264243880*math.sin( 3.89255617078 +      220.41264243880*t)
      mercury_x_0+=-math.pow(t,exp)*     0.00001434125*     522.57741809380*math.sin( 3.86895692507 +      522.57741809380*t)
      mercury_x_0+=-math.pow(t,exp)*     0.00001406213*     536.80451209540*math.sin( 0.47615061971 +      536.80451209540*t)
      mercury_x_0+=-math.pow(t,exp)*     0.00001186821*      76.26607127560*math.sin( 0.77658632871 +       76.26607127560*t)
      ...
      mercury_x_1+=math.pow(t,exp-1)*exp*     0.00008783198*math.cos( 5.73285747425 +   104351.61256629678*t)-math.pow(t,exp)*     0.00008783198*  104351.61256629678*math.sin( 5.73285747425 +   104351.61256629678*t)
      ...
      mercury_x_2+=math.pow(t,exp-1)*exp*     0.00001259780*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00001259780*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
   ...
   def mercury_y(t):
      ...
      mercury_y_0+=-math.pow(t,exp)*     0.00007634888*     426.59819087600*math.sin( 1.67192689093 +      426.59819087600*t)
      mercury_y_0+=-math.pow(t,exp)*     0.00004450056*  156527.41884944518*math.sin( 5.52354907071 +   156527.41884944518*t)
      mercury_y_0+=-math.pow(t,exp)*     0.00001963685*     206.18554843720*math.sin( 5.70771850410 +      206.18554843720*t)
      mercury_y_0+=-math.pow(t,exp)*     0.00001891507*     220.41264243880*math.sin( 2.32099579498 +      220.41264243880*t)
      mercury_y_0+=-math.pow(t,exp)*     0.00001939835*     149.56319713460*math.sin( 3.22826367093 +      149.56319713460*t)
      mercury_y_0+=-math.pow(t,exp)*     0.00001436593*     522.57741809380*math.sin( 2.30163308407 +      522.57741809380*t)
      mercury_y_0+=-math.pow(t,exp)*     0.00001405828*     536.80451209540*math.sin( 5.18871358903 +      536.80451209540*t)
      mercury_y_0+=-math.pow(t,exp)*     0.00001186503*      76.26607127560*math.sin( 5.48857209638 +       76.26607127560*t)
      ...
      mercury_y_1+=math.pow(t,exp-1)*exp*     0.00008858156*math.cos( 4.16852401867 +   104351.61256629678*t)-math.pow(t,exp)*     0.00008858156*  104351.61256629678*math.sin( 4.16852401867 +   104351.61256629678*t)
      ...
      mercury_y_2=0.0
      exp=2
      mercury_y_2+=math.pow(t,exp-1)*exp*     0.00004556343*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00004556343*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
   ...
   def mercury_z(t):
      ...
      mercury_z_0+=-math.pow(t,exp)*     0.00004802047*      38.13303563780*math.sin( 4.58264625090 +       38.13303563780*t)
      mercury_z_0+=-math.pow(t,exp)*     0.00002575002*  130439.51570787099*math.sin( 1.62646731545 +   130439.51570787099*t)
      mercury_z_0+=-math.pow(t,exp)*     0.00001131032*      74.78159856730*math.sin( 5.75872803701 +       74.78159856730*t)
      ...
      mercury_z_2+=math.pow(t,exp-1)*exp*     0.00001183345*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00001183345*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
   ...
   def neptune_x(t):
      ...
      neptune_x_0+=-math.pow(t,exp)*     0.00007541736*      70.32818044240*math.sin( 2.77784746848 +       70.32818044240*t)
      ...
      neptune_x_0+=-math.pow(t,exp)*     0.00004733138*      79.23501669220*math.sin( 4.09748778484 +       79.23501669220*t)
      ...
      neptune_x_0+=-math.pow(t,exp)*     0.00002720471*     109.94568878850*math.sin( 3.82305971632 +      109.94568878850*t)
      ...
      neptune_x_0+=-math.pow(t,exp)*     0.00002084772*     137.03302416240*math.sin( 2.83683424533 +      137.03302416240*t)
      ...
      neptune_x_0+=-math.pow(t,exp)*     0.00001157153*     148.07872442630*math.sin( 2.64764912073 +      148.07872442630*t)
      ...
      neptune_x_1+=math.pow(t,exp-1)*exp*     0.00004909885*math.cos( 2.09371107061 +       73.29712585900*t)-math.pow(t,exp)*     0.00004909885*      73.29712585900*math.sin( 2.09371107061 +       73.29712585900*t)
      neptune_x_1+=math.pow(t,exp-1)*exp*     0.00002745912*math.cos( 4.06264400609 +       77.75054398390*t)-math.pow(t,exp)*     0.00002745912*      77.75054398390*math.sin( 4.06264400609 +       77.75054398390*t)
      ...
      neptune_x_1+=math.pow(t,exp-1)*exp*     0.00001284677*math.cos( 6.02457823347 +       74.78159856730*t)-math.pow(t,exp)*     0.00001284677*      74.78159856730*math.sin( 6.02457823347 +       74.78159856730*t)

      neptune_x_2=0.0
      exp=2
      neptune_x_2+=math.pow(t,exp-1)*exp*     0.00005415923*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00005415923*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
   ...
   def neptune_y(t):
      ...
      neptune_y_0+=-math.pow(t,exp)*     0.00005316026*      71.81265315070*math.sin( 0.78719997386 +       71.81265315070*t)
      neptune_y_0+=-math.pow(t,exp)*     0.00004650708*      37.61177077600*math.sin( 4.81540983294 +       37.61177077600*t)
      neptune_y_0+=-math.pow(t,exp)*     0.00004734186*      79.23501669220*math.sin( 2.52644981654 +       79.23501669220*t)
      ...
      neptune_y_0+=-math.pow(t,exp)*     0.00002668054*     109.94568878850*math.sin( 2.31251521781 +      109.94568878850*t)
      ...
      neptune_y_0+=-math.pow(t,exp)*     0.00002058823*     137.03302416240*math.sin( 4.38545017091 +      137.03302416240*t)
      ...
      neptune_y_0+=-math.pow(t,exp)*     0.00001731599*      70.32818044240*math.sin( 4.14499314089 +       70.32818044240*t)
      ...
      neptune_y_0+=-math.pow(t,exp)*     0.00001173918*     148.07872442630*math.sin( 1.08646707548 +      148.07872442630*t)
      ...
      neptune_y_1+=math.pow(t,exp-1)*exp*     0.00004955216*math.cos( 0.51750137679 +       73.29712585900*t)-math.pow(t,exp)*     0.00004955216*      73.29712585900*math.sin( 0.51750137679 +       73.29712585900*t)
      neptune_y_1+=math.pow(t,exp-1)*exp*     0.00002746565*math.cos( 2.49189874649 +       77.75054398390*t)-math.pow(t,exp)*     0.00002746565*      77.75054398390*math.sin( 2.49189874649 +       77.75054398390*t)
      ...
      neptune_y_1+=math.pow(t,exp-1)*exp*     0.00001292006*math.cos( 4.45882418895 +       74.78159856730*t)-math.pow(t,exp)*     0.00001292006*      74.78159856730*math.sin( 4.45882418895 +       74.78159856730*t)
      ...
      neptune_y_2+=math.pow(t,exp-1)*exp*     0.00003651208*math.cos( 3.14159265359 +        0.00000000000*t)-math.pow(t,exp)*     0.00003651208*       0.00000000000*math.sin( 3.14159265359 +        0.00000000000*t)
   ...
   def neptune_z(t):
      ...
      neptune_z_0+=-math.pow(t,exp)*     0.00009774680*      73.29712585900*math.sin( 2.80201767484 +       73.29712585900*t)
      neptune_z_0+=-math.pow(t,exp)*     0.00004119576*      77.75054398390*math.sin( 1.67942813460 +       77.75054398390*t)
      ...
      neptune_z_0+=-math.pow(t,exp)*     0.00001865261*      71.81265315070*math.sin( 5.05510390418 +       71.81265315070*t)
      ...
      neptune_z_1+=math.pow(t,exp-1)*exp*     0.00009597674*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00009597674*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
      ...
      neptune_z_1+=math.pow(t,exp-1)*exp*     0.00003891340*math.cos( 5.46760868569 +       76.26607127560*t)-math.pow(t,exp)*     0.00003891340*      76.26607127560*math.sin( 5.46760868569 +       76.26607127560*t)
   ...
   def saturn_x(t):
      ...
      saturn_x_0+=-math.pow(t,exp)*     0.00009943629*       3.93215326310*math.sin( 0.84628173449 +        3.93215326310*t)
      ...
      saturn_x_0+=-math.pow(t,exp)*     0.00008207194*     742.99006053260*math.sin( 2.47939755305 +      742.99006053260*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00009112965*    1052.26838318840*math.sin( 4.32466741251 +     1052.26838318840*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00006717261*     838.96928775040*math.sin( 5.51887462475 +      838.96928775040*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00007155271*      95.97922721780*math.sin( 2.18154617097 +       95.97922721780*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00006195302*     846.08283475120*math.sin( 2.44963609645 +      846.08283475120*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00006322091*     309.27832265580*math.sin( 0.83910039496 +      309.27832265580*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00006242626*     536.80451209540*math.sin( 0.31189331943 +      536.80451209540*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00006073312*     440.82528487760*math.sin( 6.15905920767 +      440.82528487760*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00005342763*     412.37109687440*math.sin( 3.60061388095 +      412.37109687440*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00005192695*     210.85141488320*math.sin( 4.54584457909 +      210.85141488320*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00005151002*     215.74677599280*math.sin( 0.34669532534 +      215.74677599280*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00003791450*     422.66603761290*math.sin( 5.99767294831 +      422.66603761290*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00003761760*     212.33588759150*math.sin( 3.72112918055 +      212.33588759150*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00003746363*     214.26230328450*math.sin( 1.16965138821 +      214.26230328450*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00003113686*     213.25091132820*math.sin( 0.84631897443 +      213.25091132820*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00003112752*     213.34727954780*math.sin( 4.04410367056 +      213.34727954780*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00003674488*      76.26607127560*math.sin( 6.08210209796 +       76.26607127560*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002987869*     625.67019231240*math.sin( 0.04173236626 +      625.67019231240*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00004110608*     137.03302416240*math.sin( 5.96149429852 +      137.03302416240*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002953858*     138.51749687070*math.sin( 5.39165103860 +      138.51749687070*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002904839*      85.82729883120*math.sin( 1.13559078868 +       85.82729883120*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002827199*     330.61896365820*math.sin( 0.73271261848 +      330.61896365820*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00003362357*     437.64389113990*math.sin( 1.42090450141 +      437.64389113990*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002633264*     288.08069400530*math.sin( 5.40645069358 +      288.08069400530*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002712559*     203.73786788240*math.sin( 0.96814009180 +      203.73786788240*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002619094*     127.47179660680*math.sin( 5.49345540359 +      127.47179660680*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002527038*     628.85158605010*math.sin( 5.09752990899 +      628.85158605010*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002921516*    1066.49547719000*math.sin( 4.16131118972 +     1066.49547719000*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002507576*       9.56122755560*math.sin( 1.49473969257 +        9.56122755560*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002469402*    1155.36115740700*math.sin( 5.27363716895 +     1155.36115740700*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002424948*     222.86032299360*math.sin( 3.97128259353 +      222.86032299360*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00003128610*    1368.66025284500*math.sin( 4.05501447962 +     1368.66025284500*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002308453*     430.53034413910*math.sin( 3.67822395107 +      430.53034413910*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002162294*     340.77089204480*math.sin( 3.26942373483 +      340.77089204480*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002912305*       3.18139373770*math.sin( 1.76894623285 +        3.18139373770*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002094767*     423.41679713830*math.sin( 3.55759987109 +      423.41679713830*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002334618*     388.46515523820*math.sin( 5.86791070843 +      388.46515523820*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00002099584*       1.48447270830*math.sin( 2.04767412721 +        1.48447270830*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001634380*      12.53017297220*math.sin( 4.54319346061 +       12.53017297220*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001635508*     212.77783057620*math.sin( 2.19968869780 +      212.77783057620*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001632293*     213.82036029980*math.sin( 2.69164822165 +      213.82036029980*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001499061*      52.69019803950*math.sin( 3.60176796862 +       52.69019803950*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001460800*     429.77958461370*math.sin( 5.92457418931 +      429.77958461370*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001537964*     860.30992875280*math.sin( 4.78543539924 +      860.30992875280*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001465687*     949.17560896980*math.sin( 5.69105697536 +      949.17560896980*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001417710*     350.33211960040*math.sin( 5.41419900810 +      350.33211960040*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001148005*     942.06206196900*math.sin( 0.19267134900 +      942.06206196900*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001111390*     234.63973644040*math.sin( 0.47907481744 +      234.63973644040*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001070652*    1059.38193018920*math.sin( 2.16320626061 +     1059.38193018920*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001019407*    1471.75302706360*math.sin( 5.00697904753 +     1471.75302706360*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001009190*     265.98929347750*math.sin( 1.34289487761 +      265.98929347750*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001089142*     362.86229257260*math.sin( 5.82690567831 +      362.86229257260*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001092000*     173.94221952280*math.sin( 1.13562597855 +      173.94221952280*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001173633*    1685.05212250160*math.sin( 3.79592491893 +     1685.05212250160*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001118048*     703.63318461740*math.sin( 3.46624216870 +      703.63318461740*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001150262*     200.76892246580*math.sin( 3.74704110250 +      200.76892246580*t)
      saturn_x_0+=-math.pow(t,exp)*     0.00001008026*     225.82926841020*math.sin( 1.08825703500 +      225.82926841020*t)
      ...
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00009870350*math.cos( 5.20065401876 +      202.25339517410*t)-math.pow(t,exp)*     0.00009870350*     202.25339517410*math.sin( 5.20065401876 +      202.25339517410*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00008706840*math.cos( 6.03495025016 +      224.34479570190*t)-math.pow(t,exp)*     0.00008706840*     224.34479570190*math.sin( 6.03495025016 +      224.34479570190*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00005497618*math.cos( 4.40350640238 +      440.82528487760*t)-math.pow(t,exp)*     0.00005497618*     440.82528487760*math.sin( 4.40350640238 +      440.82528487760*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00005515449*math.cos( 2.60541189759 +       11.04570026390*t)-math.pow(t,exp)*     0.00005515449*      11.04570026390*math.sin( 2.60541189759 +       11.04570026390*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00003699033*math.cos( 1.36420047437 +      522.57741809380*t)-math.pow(t,exp)*     0.00003699033*     522.57741809380*math.sin( 1.36420047437 +      522.57741809380*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00003570311*math.cos( 5.10832701277 +      412.37109687440*t)-math.pow(t,exp)*     0.00003570311*     412.37109687440*math.sin( 5.10832701277 +      412.37109687440*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00002741305*math.cos( 4.09776900851 +      149.56319713460*t)-math.pow(t,exp)*     0.00002741305*     149.56319713460*math.sin( 4.09776900851 +      149.56319713460*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00002761279*math.cos( 3.96260867581 +       95.97922721780*t)-math.pow(t,exp)*     0.00002761279*      95.97922721780*math.sin( 3.96260867581 +       95.97922721780*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001876093*math.cos( 2.52381113890 +        3.93215326310*t)-math.pow(t,exp)*     0.00001876093*       3.93215326310*math.sin( 2.52381113890 +        3.93215326310*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001765306*math.cos( 0.75684456614 +      277.03499374140*t)-math.pow(t,exp)*     0.00001765306*     277.03499374140*math.sin( 0.75684456614 +      277.03499374140*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001692588*math.cos( 4.74243609118 +      536.80451209540*t)-math.pow(t,exp)*     0.00001692588*     536.80451209540*math.sin( 4.74243609118 +      536.80451209540*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001688471*math.cos( 3.98271487594 +      422.66603761290*t)-math.pow(t,exp)*     0.00001688471*     422.66603761290*math.sin( 3.98271487594 +      422.66603761290*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001544657*math.cos( 5.30307291724 +      330.61896365820*t)-math.pow(t,exp)*     0.00001544657*     330.61896365820*math.sin( 5.30307291724 +      330.61896365820*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001467039*math.cos( 0.00015438412 +      529.69096509460*t)-math.pow(t,exp)*     0.00001467039*     529.69096509460*math.sin( 0.00015438412 +      529.69096509460*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001366833*math.cos( 2.02865467887 +     1066.49547719000*t)-math.pow(t,exp)*     0.00001366833*    1066.49547719000*math.sin( 2.02865467887 +     1066.49547719000*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001330039*math.cos( 5.06312198727 +      234.63973644040*t)-math.pow(t,exp)*     0.00001330039*     234.63973644040*math.sin( 5.06312198727 +      234.63973644040*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001511486*math.cos( 6.23276511633 +        3.18139373770*t)-math.pow(t,exp)*     0.00001511486*       3.18139373770*math.sin( 6.23276511633 +        3.18139373770*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001270679*math.cos( 2.40338510736 +      415.55249061210*t)-math.pow(t,exp)*     0.00001270679*     415.55249061210*math.sin( 2.40338510736 +      415.55249061210*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001128732*math.cos( 5.45795307607 +      423.41679713830*t)-math.pow(t,exp)*     0.00001128732*     423.41679713830*math.sin( 5.45795307607 +      423.41679713830*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001126065*math.cos( 2.88172300482 +      860.30992875280*t)-math.pow(t,exp)*     0.00001126065*     860.30992875280*math.sin( 2.88172300482 +      860.30992875280*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001100929*math.cos( 4.07698729757 +      429.77958461370*t)-math.pow(t,exp)*     0.00001100929*     429.77958461370*math.sin( 4.07698729757 +      429.77958461370*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001271587*math.cos( 0.09494045392 +      742.99006053260*t)-math.pow(t,exp)*     0.00001271587*     742.99006053260*math.sin( 0.09494045392 +      742.99006053260*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001341894*math.cos( 2.98929529398 +      210.85141488320*t)-math.pow(t,exp)*     0.00001341894*     210.85141488320*math.sin( 2.98929529398 +      210.85141488320*t)
      saturn_x_1+=math.pow(t,exp-1)*exp*     0.00001330665*math.cos( 1.90899526877 +      215.74677599280*t)-math.pow(t,exp)*     0.00001330665*     215.74677599280*math.sin( 1.90899526877 +      215.74677599280*t)
      ...
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00007248688*math.cos( 5.70261917802 +      110.20632121940*t)-math.pow(t,exp)*     0.00007248688*     110.20632121940*math.sin( 5.70261917802 +      110.20632121940*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00004651894*math.cos( 1.83710425038 +      647.01083331480*t)-math.pow(t,exp)*     0.00004651894*     647.01083331480*math.sin( 1.83710425038 +      647.01083331480*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00004922180*math.cos( 3.08463039042 +      216.48048917570*t)-math.pow(t,exp)*     0.00004922180*     216.48048917570*math.sin( 3.08463039042 +      216.48048917570*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00004775993*math.cos( 1.81695167893 +      210.11770170030*t)-math.pow(t,exp)*     0.00004775993*     210.11770170030*math.sin( 1.81695167893 +      210.11770170030*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00004165287*math.cos( 5.32887778584 +      316.39186965660*t)-math.pow(t,exp)*     0.00004165287*     316.39186965660*math.sin( 5.32887778584 +      316.39186965660*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00003507416*math.cos( 0.78248949398 +      853.19638175200*t)-math.pow(t,exp)*     0.00003507416*     853.19638175200*math.sin( 0.78248949398 +      853.19638175200*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00002659711*math.cos( 3.16731450403 +      209.36694217490*t)-math.pow(t,exp)*     0.00002659711*     209.36694217490*math.sin( 3.16731450403 +      209.36694217490*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00002537339*math.cos( 2.65097652412 +      440.82528487760*t)-math.pow(t,exp)*     0.00002537339*     440.82528487760*math.sin( 2.65097652412 +      440.82528487760*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00002567381*math.cos( 1.74024227844 +      217.23124870110*t)-math.pow(t,exp)*     0.00002567381*     217.23124870110*math.sin( 1.74024227844 +      217.23124870110*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00002502759*math.cos( 4.69464279172 +      117.31986822020*t)-math.pow(t,exp)*     0.00002502759*     117.31986822020*math.sin( 4.69464279172 +      117.31986822020*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00002506135*math.cos( 1.74809205533 +      103.09277421860*t)-math.pow(t,exp)*     0.00002506135*     103.09277421860*math.sin( 1.74809205533 +      103.09277421860*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00002128734*math.cos( 0.28416516589 +      632.78373931320*t)-math.pow(t,exp)*     0.00002128734*     632.78373931320*math.sin( 0.28416516589 +      632.78373931320*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00001842235*math.cos( 3.99299720318 +      323.50541665740*t)-math.pow(t,exp)*     0.00001842235*     323.50541665740*math.sin( 3.99299720318 +      323.50541665740*t)
      saturn_x_2+=math.pow(t,exp-1)*exp*     0.00001228190*math.cos( 0.42913693726 +      412.37109687440*t)-math.pow(t,exp)*     0.00001228190*     412.37109687440*math.sin( 0.42913693726 +      412.37109687440*t)
      ...
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00008992383*math.cos( 0.91696888396 +      433.71173787680*t)-math.pow(t,exp)*     0.00008992383*     433.71173787680*math.sin( 0.91696888396 +      433.71173787680*t)
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00007401493*math.cos( 1.78627385772 +      227.52618943960*t)-math.pow(t,exp)*     0.00007401493*     227.52618943960*math.sin( 1.78627385772 +      227.52618943960*t)
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00008043886*math.cos( 3.12863814419 +        7.11354700080*t)-math.pow(t,exp)*     0.00008043886*       7.11354700080*math.sin( 3.12863814419 +        7.11354700080*t)
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00004503883*math.cos( 2.24531651241 +      419.48464387520*t)-math.pow(t,exp)*     0.00004503883*     419.48464387520*math.sin( 2.24531651241 +      419.48464387520*t)
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00003467011*math.cos( 3.14591173603 +      199.07200143640*t)-math.pow(t,exp)*     0.00003467011*     199.07200143640*math.sin( 3.14591173603 +      199.07200143640*t)
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00002973756*math.cos( 6.00031256382 +      639.89728631400*t)-math.pow(t,exp)*     0.00002973756*     639.89728631400*math.sin( 6.00031256382 +      639.89728631400*t)
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00002341707*math.cos( 3.06091721419 +       14.22709400160*t)-math.pow(t,exp)*     0.00002341707*      14.22709400160*math.sin( 3.06091721419 +       14.22709400160*t)
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00001230371*math.cos( 4.38195871546 +      213.29909543800*t)-math.pow(t,exp)*     0.00001230371*     213.29909543800*math.sin( 4.38195871546 +      213.29909543800*t)
      saturn_x_3+=math.pow(t,exp-1)*exp*     0.00001023597*math.cos( 0.01138890289 +      647.01083331480*t)-math.pow(t,exp)*     0.00001023597*     647.01083331480*math.sin( 0.01138890289 +      647.01083331480*t)

      saturn_x_4=0.0
      exp=4
      saturn_x_4+=math.pow(t,exp-1)*exp*     0.00007957649*math.cos( 4.70523623227 +      206.18554843720*t)-math.pow(t,exp)*     0.00007957649*     206.18554843720*math.sin( 4.70523623227 +      206.18554843720*t)
      saturn_x_4+=math.pow(t,exp-1)*exp*     0.00007834416*math.cos( 0.13981692944 +      220.41264243880*t)-math.pow(t,exp)*     0.00007834416*     220.41264243880*math.sin( 0.13981692944 +      220.41264243880*t)
      saturn_x_4+=math.pow(t,exp-1)*exp*     0.00001510766*math.cos( 0.06561562614 +      227.52618943960*t)-math.pow(t,exp)*     0.00001510766*     227.52618943960*math.sin( 0.06561562614 +      227.52618943960*t)
      saturn_x_4+=math.pow(t,exp-1)*exp*     0.00001222718*math.cos( 5.41618706626 +      433.71173787680*t)-math.pow(t,exp)*     0.00001222718*     433.71173787680*math.sin( 5.41618706626 +      433.71173787680*t)
   ...
   def saturn_y(t):
      ...
      saturn_y_0+=-math.pow(t,exp)*     0.00009544823*      95.97922721780*math.sin( 3.48777857215 +       95.97922721780*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00007657437*     742.99006053260*math.sin( 1.16709831318 +      742.99006053260*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00006918461*     412.37109687440*math.sin( 1.17089073634 +      412.37109687440*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00009006036*    1052.26838318840*math.sin( 5.87854541021 +     1052.26838318840*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00006536938*     838.96928775040*math.sin( 0.84256190288 +      838.96928775040*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00006080448*     440.82528487760*math.sin( 4.58758307965 +      440.82528487760*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00006221723*     536.80451209540*math.sin( 5.03120156259 +      536.80451209540*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00004987241*     846.08283475120*math.sin( 0.92163133661 +      846.08283475120*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00005200364*     210.85141488320*math.sin( 2.97482811217 +      210.85141488320*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00005155105*     215.74677599280*math.sin( 5.05796992379 +      215.74677599280*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003791258*     422.66603761290*math.sin( 4.41806594234 +      422.66603761290*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003879403*       3.93215326310*math.sin( 3.38065334501 +        3.93215326310*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003767674*     212.33588759150*math.sin( 2.14954245794 +      212.33588759150*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003750939*     214.26230328450*math.sin( 5.88125435107 +      214.26230328450*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003118048*     213.25091132820*math.sin( 5.55799397309 +      213.25091132820*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003117166*     213.34727954780*math.sin( 2.47259779969 +      213.34727954780*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003816713*     625.67019231240*math.sin( 2.44107897815 +      625.67019231240*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003676804*      76.26607127560*math.sin( 4.51090470038 +       76.26607127560*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00004041434*     137.03302416240*math.sin( 1.24475045830 +      137.03302416240*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002909579*      85.82729883120*math.sin( 5.84815497128 +       85.82729883120*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002829614*     330.61896365820*math.sin( 5.44452944307 +      330.61896365820*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003366302*     437.64389113990*math.sin( 6.13299715431 +      437.64389113990*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002773819*     203.73786788240*math.sin( 5.61593446938 +      203.73786788240*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002637903*     288.08069400530*math.sin( 3.83678037157 +      288.08069400530*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002531663*     628.85158605010*math.sin( 3.52630260061 +      628.85158605010*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002520223*     138.51749687070*math.sin( 3.89344117733 +      138.51749687070*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002620709*     127.47179660680*math.sin( 0.69738696032 +      127.47179660680*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002913908*    1066.49547719000*math.sin( 2.58991935570 +     1066.49547719000*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002501957*       9.56122755560*math.sin( 6.19958027393 +        9.56122755560*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002449132*    1155.36115740700*math.sin( 0.54252658898 +     1155.36115740700*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002428822*     222.86032299360*math.sin( 2.39939798580 +      222.86032299360*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00003138264*    1368.66025284500*math.sin( 5.63040781132 +     1368.66025284500*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002268608*     430.53034413910*math.sin( 2.12403236555 +      430.53034413910*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002077451*     423.41679713830*math.sin( 1.95682583751 +      423.41679713830*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002670260*       3.18139373770*math.sin( 0.18164077956 +        3.18139373770*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002339111*     388.46515523820*math.sin( 4.29619046322 +      388.46515523820*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001636695*      12.53017297220*math.sin( 2.97402097142 +       12.53017297220*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00002127828*       1.48447270830*math.sin( 0.42532134789 +        1.48447270830*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001638713*     212.77783057620*math.sin( 0.62823227849 +      212.77783057620*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001633768*     213.82036029980*math.sin( 1.12043073218 +      213.82036029980*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001499907*      52.69019803950*math.sin( 5.16859292196 +       52.69019803950*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001462490*     429.77958461370*math.sin( 4.35286393311 +      429.77958461370*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001640707*     949.17560896980*math.sin( 2.04694637546 +      949.17560896980*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001539780*     860.30992875280*math.sin( 3.21449237414 +      860.30992875280*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001436654*     350.33211960040*math.sin( 3.84293514986 +      350.33211960040*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001276111*     340.77089204480*math.sin( 2.98754780759 +      340.77089204480*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001151687*     942.06206196900*math.sin( 1.78618989351 +      942.06206196900*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001112304*     234.63973644040*math.sin( 5.19114179785 +      234.63973644040*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001011157*    1471.75302706360*math.sin( 0.27252410682 +     1471.75302706360*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001162485*     200.76892246580*math.sin( 2.35044095493 +      200.76892246580*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001090717*     362.86229257260*math.sin( 4.25638263020 +      362.86229257260*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001090434*     173.94221952280*math.sin( 5.85087641969 +      173.94221952280*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001186448*    1685.05212250160*math.sin( 5.38322854424 +     1685.05212250160*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001120498*     703.63318461740*math.sin( 1.89478747163 +      703.63318461740*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001013844*    1059.38193018920*math.sin( 1.37562258871 +     1059.38193018920*t)
      saturn_y_0+=-math.pow(t,exp)*     0.00001009165*     225.82926841020*math.sin( 5.79971867848 +      225.82926841020*t)
      ...
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00009902653*math.cos( 3.60258639503 +      202.25339517410*t)-math.pow(t,exp)*     0.00009902653*     202.25339517410*math.sin( 3.60258639503 +      202.25339517410*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00008725278*math.cos( 4.46324685676 +      224.34479570190*t)-math.pow(t,exp)*     0.00008725278*     224.34479570190*math.sin( 4.46324685676 +      224.34479570190*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00006584549*math.cos( 4.07328504513 +      309.27832265580*t)-math.pow(t,exp)*     0.00006584549*     309.27832265580*math.sin( 4.07328504513 +      309.27832265580*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00005504485*math.cos( 2.83207431701 +      440.82528487760*t)-math.pow(t,exp)*     0.00005504485*     440.82528487760*math.sin( 2.83207431701 +      440.82528487760*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00005427246*math.cos( 1.03183073701 +       11.04570026390*t)-math.pow(t,exp)*     0.00005427246*      11.04570026390*math.sin( 1.03183073701 +       11.04570026390*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00004177277*math.cos( 3.01038599928 +      412.37109687440*t)-math.pow(t,exp)*     0.00004177277*     412.37109687440*math.sin( 3.01038599928 +      412.37109687440*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00004047069*math.cos( 5.17479134124 +       95.97922721780*t)-math.pow(t,exp)*     0.00004047069*      95.97922721780*math.sin( 5.17479134124 +       95.97922721780*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00002745113*math.cos( 2.52862121261 +      149.56319713460*t)-math.pow(t,exp)*     0.00002745113*     149.56319713460*math.sin( 2.52862121261 +      149.56319713460*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00002423372*math.cos( 2.64373010772 +      522.57741809380*t)-math.pow(t,exp)*     0.00002423372*     522.57741809380*math.sin( 2.64373010772 +      522.57741809380*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001744754*math.cos( 5.50576132273 +      277.03499374140*t)-math.pow(t,exp)*     0.00001744754*     277.03499374140*math.sin( 5.50576132273 +      277.03499374140*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001672526*math.cos( 3.18810844159 +      536.80451209540*t)-math.pow(t,exp)*     0.00001672526*     536.80451209540*math.sin( 3.18810844159 +      536.80451209540*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001692304*math.cos( 2.39926742035 +      422.66603761290*t)-math.pow(t,exp)*     0.00001692304*     422.66603761290*math.sin( 2.39926742035 +      422.66603761290*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001545875*math.cos( 3.73180287915 +      330.61896365820*t)-math.pow(t,exp)*     0.00001545875*     330.61896365820*math.sin( 3.73180287915 +      330.61896365820*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001360664*math.cos( 0.45530625979 +     1066.49547719000*t)-math.pow(t,exp)*     0.00001360664*    1066.49547719000*math.sin( 0.45530625979 +     1066.49547719000*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001332178*math.cos( 3.49199811942 +      234.63973644040*t)-math.pow(t,exp)*     0.00001332178*     234.63973644040*math.sin( 3.49199811942 +      234.63973644040*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001300561*math.cos( 0.83727576430 +      415.55249061210*t)-math.pow(t,exp)*     0.00001300561*     415.55249061210*math.sin( 0.83727576430 +      415.55249061210*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001393361*math.cos( 4.62211146668 +        3.18139373770*t)-math.pow(t,exp)*     0.00001393361*       3.18139373770*math.sin( 4.62211146668 +        3.18139373770*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001173958*math.cos( 2.72608805865 +      846.08283475120*t)-math.pow(t,exp)*     0.00001173958*     846.08283475120*math.sin( 2.72608805865 +      846.08283475120*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001314212*math.cos( 4.38807267093 +      625.67019231240*t)-math.pow(t,exp)*     0.00001314212*     625.67019231240*math.sin( 4.38807267093 +      625.67019231240*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001127628*math.cos( 3.87310113490 +      423.41679713830*t)-math.pow(t,exp)*     0.00001127628*     423.41679713830*math.sin( 3.87310113490 +      423.41679713830*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001127311*math.cos( 1.31087998856 +      860.30992875280*t)-math.pow(t,exp)*     0.00001127311*     860.30992875280*math.sin( 1.31087998856 +      860.30992875280*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001519756*math.cos( 6.12909098030 +        3.93215326310*t)-math.pow(t,exp)*     0.00001519756*       3.93215326310*math.sin( 6.12909098030 +        3.93215326310*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001102045*math.cos( 2.50535926173 +      429.77958461370*t)-math.pow(t,exp)*     0.00001102045*     429.77958461370*math.sin( 2.50535926173 +      429.77958461370*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001344507*math.cos( 1.41793614164 +      210.85141488320*t)-math.pow(t,exp)*     0.00001344507*     210.85141488320*math.sin( 1.41793614164 +      210.85141488320*t)
      saturn_y_1+=math.pow(t,exp-1)*exp*     0.00001331406*math.cos( 0.33834520814 +      215.74677599280*t)-math.pow(t,exp)*     0.00001331406*     215.74677599280*math.sin( 0.33834520814 +      215.74677599280*t)
      ...
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00006672789*math.cos( 4.24754247893 +      110.20632121940*t)-math.pow(t,exp)*     0.00006672789*     110.20632121940*math.sin( 4.24754247893 +      110.20632121940*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00004657269*math.cos( 0.26558212048 +      647.01083331480*t)-math.pow(t,exp)*     0.00004657269*     647.01083331480*math.sin( 0.26558212048 +      647.01083331480*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00004932685*math.cos( 1.51301176465 +      216.48048917570*t)-math.pow(t,exp)*     0.00004932685*     216.48048917570*math.sin( 1.51301176465 +      216.48048917570*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00004788186*math.cos( 0.24337888601 +      210.11770170030*t)-math.pow(t,exp)*     0.00004788186*     210.11770170030*math.sin( 0.24337888601 +      210.11770170030*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00004165917*math.cos( 3.73203571740 +      316.39186965660*t)-math.pow(t,exp)*     0.00004165917*     316.39186965660*math.sin( 3.73203571740 +      316.39186965660*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00003508567*math.cos( 5.49278691726 +      853.19638175200*t)-math.pow(t,exp)*     0.00003508567*     853.19638175200*math.sin( 5.49278691726 +      853.19638175200*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00002742669*math.cos( 6.21942410610 +      103.09277421860*t)-math.pow(t,exp)*     0.00002742669*     103.09277421860*math.sin( 6.21942410610 +      103.09277421860*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00002660411*math.cos( 1.58795353685 +      209.36694217490*t)-math.pow(t,exp)*     0.00002660411*     209.36694217490*math.sin( 1.58795353685 +      209.36694217490*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00002540502*math.cos( 1.07964699287 +      440.82528487760*t)-math.pow(t,exp)*     0.00002540502*     440.82528487760*math.sin( 1.07964699287 +      440.82528487760*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00002567284*math.cos( 0.16811215438 +      217.23124870110*t)-math.pow(t,exp)*     0.00002567284*     217.23124870110*math.sin( 0.16811215438 +      217.23124870110*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00002507213*math.cos( 3.11896693485 +      117.31986822020*t)-math.pow(t,exp)*     0.00002507213*     117.31986822020*math.sin( 3.11896693485 +      117.31986822020*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00002158545*math.cos( 4.99876489338 +      632.78373931320*t)-math.pow(t,exp)*     0.00002158545*     632.78373931320*math.sin( 4.99876489338 +      632.78373931320*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00001828667*math.cos( 2.43398377331 +      323.50541665740*t)-math.pow(t,exp)*     0.00001828667*     323.50541665740*math.sin( 2.43398377331 +      323.50541665740*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00001351292*math.cos( 4.81674779715 +      412.37109687440*t)-math.pow(t,exp)*     0.00001351292*     412.37109687440*math.sin( 4.81674779715 +      412.37109687440*t)
      saturn_y_2+=math.pow(t,exp-1)*exp*     0.00001177094*math.cos( 5.84487292439 +      309.27832265580*t)-math.pow(t,exp)*     0.00001177094*     309.27832265580*math.sin( 5.84487292439 +      309.27832265580*t)
      ...
      saturn_y_3+=math.pow(t,exp-1)*exp*     0.00009007608*math.cos( 5.62865492125 +      433.71173787680*t)-math.pow(t,exp)*     0.00009007608*     433.71173787680*math.sin( 5.62865492125 +      433.71173787680*t)
      saturn_y_3+=math.pow(t,exp-1)*exp*     0.00007415913*math.cos( 0.21442311819 +      227.52618943960*t)-math.pow(t,exp)*     0.00007415913*     227.52618943960*math.sin( 0.21442311819 +      227.52618943960*t)
      saturn_y_3+=math.pow(t,exp-1)*exp*     0.00008297360*math.cos( 1.52263020988 +        7.11354700080*t)-math.pow(t,exp)*     0.00008297360*       7.11354700080*math.sin( 1.52263020988 +        7.11354700080*t)
      saturn_y_3+=math.pow(t,exp-1)*exp*     0.00004505795*math.cos( 0.67249306339 +      419.48464387520*t)-math.pow(t,exp)*     0.00004505795*     419.48464387520*math.sin( 0.67249306339 +      419.48464387520*t)
      saturn_y_3+=math.pow(t,exp-1)*exp*     0.00003580670*math.cos( 1.51466198240 +      199.07200143640*t)-math.pow(t,exp)*     0.00003580670*     199.07200143640*math.sin( 1.51466198240 +      199.07200143640*t)
      saturn_y_3+=math.pow(t,exp-1)*exp*     0.00002981120*math.cos( 4.42869532103 +      639.89728631400*t)-math.pow(t,exp)*     0.00002981120*     639.89728631400*math.sin( 4.42869532103 +      639.89728631400*t)
      saturn_y_3+=math.pow(t,exp-1)*exp*     0.00002375829*math.cos( 1.46232991989 +       14.22709400160*t)-math.pow(t,exp)*     0.00002375829*      14.22709400160*math.sin( 1.46232991989 +       14.22709400160*t)
      saturn_y_3+=math.pow(t,exp-1)*exp*     0.00001023972*math.cos( 4.72338150445 +      647.01083331480*t)-math.pow(t,exp)*     0.00001023972*     647.01083331480*math.sin( 4.72338150445 +      647.01083331480*t)

      saturn_y_4=0.0
      exp=4
      saturn_y_4+=math.pow(t,exp-1)*exp*     0.00007976609*math.cos( 3.13229267905 +      206.18554843720*t)-math.pow(t,exp)*     0.00007976609*     206.18554843720*math.sin( 3.13229267905 +      206.18554843720*t)
      saturn_y_4+=math.pow(t,exp-1)*exp*     0.00007866134*math.cos( 4.84940259473 +      220.41264243880*t)-math.pow(t,exp)*     0.00007866134*     220.41264243880*math.sin( 4.84940259473 +      220.41264243880*t)
      saturn_y_4+=math.pow(t,exp-1)*exp*     0.00001514404*math.cos( 4.77675736118 +      227.52618943960*t)-math.pow(t,exp)*     0.00001514404*     227.52618943960*math.sin( 4.77675736118 +      227.52618943960*t)
      saturn_y_4+=math.pow(t,exp-1)*exp*     0.00001225220*math.cos( 3.84500353256 +      433.71173787680*t)-math.pow(t,exp)*     0.00001225220*     433.71173787680*math.sin( 3.84500353256 +      433.71173787680*t)
   ...
   def saturn_z(t):
      ...
      saturn_z_0+=-math.pow(t,exp)*     0.00009004046*     103.09277421860*math.sin( 1.38192071602 +      103.09277421860*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00005397142*     202.25339517410*math.sin( 5.13204682732 +      202.25339517410*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00004577011*      38.13303563780*math.sin( 4.56990158929 +       38.13303563780*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00003901809*     323.50541665740*math.sin( 3.71512735501 +      323.50541665740*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00003711659*     632.78373931320*math.sin( 5.05573795500 +      632.78373931320*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00003613072*     227.52618943960*math.sin( 3.35210458559 +      227.52618943960*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00003379535*      11.04570026390*math.sin( 2.13867177875 +       11.04570026390*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00003088992*     209.36694217490*math.sin( 3.62572857085 +      209.36694217490*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00002683108*     224.34479570190*math.sin( 4.87673933693 +      224.34479570190*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00002962647*     217.23124870110*math.sin( 0.46490184985 +      217.23124870110*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00002342675*     853.19638175200*math.sin( 1.34556621598 +      853.19638175200*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00002424180*      63.73589830340*math.sin( 2.92931088398 +       63.73589830340*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001701916*     735.87651353180*math.sin( 1.89892525654 +      735.87651353180*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001940777*      14.22709400160*math.sin( 4.59422357831 +       14.22709400160*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001989569*     199.07200143640*math.sin( 0.73166484127 +      199.07200143640*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001800493*     529.69096509460*math.sin( 5.12194244143 +      529.69096509460*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001423982*     522.57741809380*math.sin( 3.11558318997 +      522.57741809380*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001148029*     117.31986822020*math.sin( 4.41145011466 +      117.31986822020*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001092497*     216.48048917570*math.sin( 3.10679381209 +      216.48048917570*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001014889*     647.01083331480*math.sin( 1.97897277665 +      647.01083331480*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001097941*     210.11770170030*math.sin( 0.96097709156 +      210.11770170030*t)
      saturn_z_0+=-math.pow(t,exp)*     0.00001028445*     415.55249061210*math.sin( 2.11933097909 +      415.55249061210*t)
      ...
      saturn_z_1+=math.pow(t,exp-1)*exp*     0.00009114816*math.cos( 6.17205939393 +      639.89728631400*t)-math.pow(t,exp)*     0.00009114816*     639.89728631400*math.sin( 6.17205939393 +      639.89728631400*t)
      saturn_z_1+=math.pow(t,exp-1)*exp*     0.00007468572*math.cos( 0.93135975352 +      433.71173787680*t)-math.pow(t,exp)*     0.00007468572*     433.71173787680*math.sin( 0.93135975352 +      433.71173787680*t)
      saturn_z_1+=math.pow(t,exp-1)*exp*     0.00004965110*math.cos( 0.19046416304 +      316.39186965660*t)-math.pow(t,exp)*     0.00004965110*     316.39186965660*math.sin( 0.19046416304 +      316.39186965660*t)
      saturn_z_1+=math.pow(t,exp-1)*exp*     0.00003816033*math.cos( 4.38281692683 +      110.20632121940*t)-math.pow(t,exp)*     0.00003816033*     110.20632121940*math.sin( 4.38281692683 +      110.20632121940*t)
      saturn_z_1+=math.pow(t,exp-1)*exp*     0.00002723345*math.cos( 1.65580153042 +      227.52618943960*t)-math.pow(t,exp)*     0.00002723345*     227.52618943960*math.sin( 1.65580153042 +      227.52618943960*t)
      saturn_z_1+=math.pow(t,exp-1)*exp*     0.00001734454*math.cos( 3.51648726804 +      103.09277421860*t)-math.pow(t,exp)*     0.00001734454*     103.09277421860*math.sin( 3.51648726804 +      103.09277421860*t)
      saturn_z_1+=math.pow(t,exp-1)*exp*     0.00001541549*math.cos( 2.42323929864 +      199.07200143640*t)-math.pow(t,exp)*     0.00001541549*     199.07200143640*math.sin( 2.42323929864 +      199.07200143640*t)
      saturn_z_1+=math.pow(t,exp-1)*exp*     0.00001209044*math.cos( 2.91141318291 +       14.22709400160*t)-math.pow(t,exp)*     0.00001209044*      14.22709400160*math.sin( 2.91141318291 +       14.22709400160*t)
      ...
      saturn_z_2+=math.pow(t,exp-1)*exp*     0.00006866944*math.cos( 5.48420260868 +      426.59819087600*t)-math.pow(t,exp)*     0.00006866944*     426.59819087600*math.sin( 5.48420260868 +      426.59819087600*t)
      saturn_z_2+=math.pow(t,exp-1)*exp*     0.00002825589*math.cos( 1.36584703698 +        7.11354700080*t)-math.pow(t,exp)*     0.00002825589*       7.11354700080*math.sin( 1.36584703698 +        7.11354700080*t)
      saturn_z_2+=math.pow(t,exp-1)*exp*     0.00002645589*math.cos( 2.94607374034 +      419.48464387520*t)-math.pow(t,exp)*     0.00002645589*     419.48464387520*math.sin( 2.94607374034 +      419.48464387520*t)
      saturn_z_2+=math.pow(t,exp-1)*exp*     0.00003136555*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00003136555*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
      saturn_z_2+=math.pow(t,exp-1)*exp*     0.00001844271*math.cos( 5.43612384912 +      433.71173787680*t)-math.pow(t,exp)*     0.00001844271*     433.71173787680*math.sin( 5.43612384912 +      433.71173787680*t)
      saturn_z_2+=math.pow(t,exp-1)*exp*     0.00001055082*math.cos( 6.23890821882 +      227.52618943960*t)-math.pow(t,exp)*     0.00001055082*     227.52618943960*math.sin( 6.23890821882 +      227.52618943960*t)
      saturn_z_2+=math.pow(t,exp-1)*exp*     0.00001036141*math.cos( 4.33916742809 +      639.89728631400*t)-math.pow(t,exp)*     0.00001036141*     639.89728631400*math.sin( 4.33916742809 +      639.89728631400*t)

      saturn_z_3=0.0
      exp=3
      saturn_z_3+=math.pow(t,exp-1)*exp*     0.00004558118*math.cos( 1.70646871501 +      213.29909543800*t)-math.pow(t,exp)*     0.00004558118*     213.29909543800*math.sin( 1.70646871501 +      213.29909543800*t)
      saturn_z_3+=math.pow(t,exp-1)*exp*     0.00004777710*math.cos( 5.57723756330 +      206.18554843720*t)-math.pow(t,exp)*     0.00004777710*     206.18554843720*math.sin( 5.57723756330 +      206.18554843720*t)
      saturn_z_3+=math.pow(t,exp-1)*exp*     0.00003964164*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00003964164*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
      saturn_z_3+=math.pow(t,exp-1)*exp*     0.00002507526*math.cos( 4.64959056313 +      220.41264243880*t)-math.pow(t,exp)*     0.00002507526*     220.41264243880*math.sin( 4.64959056313 +      220.41264243880*t)
   ...
   def sun_x(t):
      ...
      sun_x_0+=-math.pow(t,exp)*     0.00007577257*     426.59819087600*math.sin( 3.24151897354 +      426.59819087600*t)
      sun_x_0+=-math.pow(t,exp)*     0.00001941380*     206.18554843720*math.sin( 1.01219474101 +      206.18554843720*t)
      sun_x_0+=-math.pow(t,exp)*     0.00001940649*     149.56319713460*math.sin( 4.79769963661 +      149.56319713460*t)
      sun_x_0+=-math.pow(t,exp)*     0.00001888831*     220.41264243880*math.sin( 3.89252804366 +      220.41264243880*t)
      sun_x_0+=-math.pow(t,exp)*     0.00001434208*     522.57741809380*math.sin( 3.86895363775 +      522.57741809380*t)
      sun_x_0+=-math.pow(t,exp)*     0.00001406367*     536.80451209540*math.sin( 0.47598335150 +      536.80451209540*t)
      sun_x_0+=-math.pow(t,exp)*     0.00001185835*      76.26607127560*math.sin( 0.77770585045 +       76.26607127560*t)

      sun_x_1=0.0
      exp=1
      sun_x_1+=math.pow(t,exp-1)*exp*     0.00001296073*math.cos( 3.14159265359 +        0.00000000000*t)-math.pow(t,exp)*     0.00001296073*       0.00000000000*math.sin( 3.14159265359 +        0.00000000000*t)
   ...
   def sun_y(t):
      ...
      sun_y_0+=-math.pow(t,exp)*     0.00007585830*     426.59819087600*math.sin( 1.66995483217 +      426.59819087600*t)
      sun_y_0+=-math.pow(t,exp)*     0.00001963743*     206.18554843720*math.sin( 5.70773655842 +      206.18554843720*t)
      sun_y_0+=-math.pow(t,exp)*     0.00001891503*     220.41264243880*math.sin( 2.32096821003 +      220.41264243880*t)
      sun_y_0+=-math.pow(t,exp)*     0.00001940124*     149.56319713460*math.sin( 3.22686130461 +      149.56319713460*t)
      sun_y_0+=-math.pow(t,exp)*     0.00001436841*     522.57741809380*math.sin( 2.30161968078 +      522.57741809380*t)
      sun_y_0+=-math.pow(t,exp)*     0.00001405975*     536.80451209540*math.sin( 5.18858607879 +      536.80451209540*t)
      sun_y_0+=-math.pow(t,exp)*     0.00001185515*      76.26607127560*math.sin( 5.48969329104 +       76.26607127560*t)
   ...
   def sun_z(t):
      ...
      sun_z_0+=-math.pow(t,exp)*     0.00004802048*      38.13303563780*math.sin( 4.58264723370 +       38.13303563780*t)
      sun_z_0+=-math.pow(t,exp)*     0.00001131046*      74.78159856730*math.sin( 5.75877139035 +       74.78159856730*t)
      sun_z_0+=-math.pow(t,exp)*     0.00001152656*       0.00000000000*math.sin( 3.14159265359 +        0.00000000000*t)
   ...
   def uranus_x(t):
      ...
      uranus_x_0+=-math.pow(t,exp)*     0.00004447622*     114.39910691340*math.sin( 0.29332757659 +      114.39910691340*t)
      ...
      uranus_x_0+=-math.pow(t,exp)*     0.00003383674*       7.11354700080*math.sin( 5.12516331582 +        7.11354700080*t)
      uranus_x_0+=-math.pow(t,exp)*     0.00003559276*       5.93789083320*math.sin( 1.47627607503 +        5.93789083320*t)
      uranus_x_0+=-math.pow(t,exp)*     0.00003577938*     137.03302416240*math.sin( 1.11558436434 +      137.03302416240*t)
      uranus_x_0+=-math.pow(t,exp)*     0.00002882392*     373.90799283650*math.sin( 2.76136583899 +      373.90799283650*t)
      uranus_x_0+=-math.pow(t,exp)*     0.00002576509*     277.03499374140*math.sin( 3.84663423210 +      277.03499374140*t)
      ...
      uranus_x_0+=-math.pow(t,exp)*     0.00001862003*      42.58645376270*math.sin( 1.67534522569 +       42.58645376270*t)
      ...
      uranus_x_0+=-math.pow(t,exp)*     0.00001495017*     220.41264243880*math.sin( 0.22268077239 +      220.41264243880*t)
      ...
      uranus_x_0+=-math.pow(t,exp)*     0.00001346494*     288.08069400530*math.sin( 5.46766563529 +      288.08069400530*t)
      ...
      uranus_x_0+=-math.pow(t,exp)*     0.00001335202*     380.12776796000*math.sin( 2.17623376867 +      380.12776796000*t)
      ...
      uranus_x_1+=math.pow(t,exp-1)*exp*     0.00002834328*math.cos( 4.88889623484 +      213.29909543800*t)-math.pow(t,exp)*     0.00002834328*     213.29909543800*math.sin( 4.88889623484 +      213.29909543800*t)
      ...
      uranus_x_1+=math.pow(t,exp-1)*exp*     0.00001941329*math.cos( 2.39889176495 +       39.61750834610*t)-math.pow(t,exp)*     0.00001941329*      39.61750834610*math.sin( 2.39889176495 +       39.61750834610*t)
      ...
      uranus_x_2+=math.pow(t,exp-1)*exp*     0.00002336552*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00002336552*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
      ...
      uranus_x_3=0.0
      exp=3
      uranus_x_3+=math.pow(t,exp-1)*exp*     0.00001309056*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00001309056*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
   ...
   def uranus_y(t):
      ...
      uranus_y_0+=-math.pow(t,exp)*     0.00004444318*     114.39910691340*math.sin( 5.00535023482 +      114.39910691340*t)
      ...
      uranus_y_0+=-math.pow(t,exp)*     0.00003267474*       7.11354700080*math.sin( 3.51091793230 +        7.11354700080*t)
      uranus_y_0+=-math.pow(t,exp)*     0.00003575402*     137.03302416240*math.sin( 5.83965751946 +      137.03302416240*t)
      ...
      uranus_y_0+=-math.pow(t,exp)*     0.00001862236*      42.58645376270*math.sin( 0.10443785448 +       42.58645376270*t)
      ...
      uranus_y_0+=-math.pow(t,exp)*     0.00001489632*     220.41264243880*math.sin( 4.93446380217 +      220.41264243880*t)
      ...
      uranus_y_0+=-math.pow(t,exp)*     0.00001346599*     288.08069400530*math.sin( 3.89240128209 +      288.08069400530*t)
      ...
      uranus_y_0+=-math.pow(t,exp)*     0.00001337666*     380.12776796000*math.sin( 3.74890794163 +      380.12776796000*t)
      ...
      uranus_y_1+=math.pow(t,exp-1)*exp*     0.00002848200*math.cos( 3.32823493525 +      213.29909543800*t)-math.pow(t,exp)*     0.00002848200*     213.29909543800*math.sin( 3.32823493525 +      213.29909543800*t)
      ...
      uranus_y_1+=math.pow(t,exp-1)*exp*     0.00001939375*math.cos( 0.82770216932 +       39.61750834610*t)-math.pow(t,exp)*     0.00001939375*      39.61750834610*math.sin( 0.82770216932 +       39.61750834610*t)
      ...
      uranus_y_3=0.0
      exp=3
      uranus_y_3+=math.pow(t,exp-1)*exp*     0.00001214019*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00001214019*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)
   ...
   def uranus_z(t):
      ...
      uranus_z_0+=-math.pow(t,exp)*     0.00008239051*      77.75054398390*math.sin( 0.34223137462 +       77.75054398390*t)
      uranus_z_0+=-math.pow(t,exp)*     0.00007950169*      85.82729883120*math.sin( 0.72564903051 +       85.82729883120*t)
      uranus_z_0+=-math.pow(t,exp)*     0.00006868135*       2.96894541660*math.sin( 0.81403748021 +        2.96894541660*t)
      ...
      uranus_z_0+=-math.pow(t,exp)*     0.00002965471*      35.16409022120*math.sin( 6.14354111880 +       35.16409022120*t)
      ...
      uranus_z_0+=-math.pow(t,exp)*     0.00002006709*      39.61750834610*math.sin( 0.75959407190 +       39.61750834610*t)
      ...
      uranus_z_0+=-math.pow(t,exp)*     0.00001512017*     213.29909543800*math.sin( 0.10355104309 +      213.29909543800*t)
      uranus_z_0+=-math.pow(t,exp)*     0.00001508924*     222.86032299360*math.sin( 2.26195448553 +      222.86032299360*t)
      uranus_z_0+=-math.pow(t,exp)*     0.00001215921*      38.13303563780*math.sin( 3.32019275533 +       38.13303563780*t)
      ...
      uranus_z_1+=math.pow(t,exp-1)*exp*     0.00007551644*math.cos( 5.49304247639 +       76.26607127560*t)-math.pow(t,exp)*     0.00007551644*      76.26607127560*math.sin( 5.49304247639 +       76.26607127560*t)
      ...
      uranus_z_2+=math.pow(t,exp-1)*exp*     0.00001601722*math.cos( 3.14159265359 +        0.00000000000*t)-math.pow(t,exp)*     0.00001601722*       0.00000000000*math.sin( 3.14159265359 +        0.00000000000*t)
   ...
   def venus_x(t):
      ...
      venus_x_0+=-math.pow(t,exp)*     0.00007580097*     426.59819087600*math.sin( 3.24082423116 +      426.59819087600*t)
      venus_x_0+=-math.pow(t,exp)*     0.00002800281*    2352.86615377180*math.sin( 0.33147492492 +     2352.86615377180*t)
      venus_x_0+=-math.pow(t,exp)*     0.00001941046*     206.18554843720*math.sin( 1.01223495801 +      206.18554843720*t)
      venus_x_0+=-math.pow(t,exp)*     0.00001940890*     149.56319713460*math.sin( 4.79784874503 +      149.56319713460*t)
      venus_x_0+=-math.pow(t,exp)*     0.00001888495*     220.41264243880*math.sin( 3.89252933583 +      220.41264243880*t)
      venus_x_0+=-math.pow(t,exp)*     0.00001949669*    1577.34354244780*math.sin( 4.23196016801 +     1577.34354244780*t)
      venus_x_0+=-math.pow(t,exp)*     0.00001432104*     522.57741809380*math.sin( 3.86896784957 +      522.57741809380*t)
      venus_x_0+=-math.pow(t,exp)*     0.00001404162*     536.80451209540*math.sin( 0.47599536907 +      536.80451209540*t)
      venus_x_0+=-math.pow(t,exp)*     0.00001185750*      76.26607127560*math.sin( 0.77749524757 +       76.26607127560*t)
      ...
      venus_x_1+=math.pow(t,exp-1)*exp*     0.00006510400*math.cos( 2.19289888883 +    10213.28554621100*t)-math.pow(t,exp)*     0.00006510400*   10213.28554621100*math.sin( 2.19289888883 +    10213.28554621100*t)
   ...
   def venus_y(t):
      ...
      venus_y_0+=-math.pow(t,exp)*     0.00007588666*     426.59819087600*math.sin( 1.66926320091 +      426.59819087600*t)
      venus_y_0+=-math.pow(t,exp)*     0.00002789807*    2352.86615377180*math.sin( 5.04214523606 +     2352.86615377180*t)
      venus_y_0+=-math.pow(t,exp)*     0.00001963479*     206.18554843720*math.sin( 5.70770249220 +      206.18554843720*t)
      venus_y_0+=-math.pow(t,exp)*     0.00001891167*     220.41264243880*math.sin( 2.32097062559 +      220.41264243880*t)
      venus_y_0+=-math.pow(t,exp)*     0.00001940366*     149.56319713460*math.sin( 3.22701063208 +      149.56319713460*t)
      venus_y_0+=-math.pow(t,exp)*     0.00001933868*    1577.34354244780*math.sin( 5.80597990261 +     1577.34354244780*t)
      venus_y_0+=-math.pow(t,exp)*     0.00001434763*     522.57741809380*math.sin( 2.30169867665 +      522.57741809380*t)
      venus_y_0+=-math.pow(t,exp)*     0.00001403769*     536.80451209540*math.sin( 5.18861278314 +      536.80451209540*t)
      venus_y_0+=-math.pow(t,exp)*     0.00001185430*      76.26607127560*math.sin( 5.48948269493 +       76.26607127560*t)
      ...
      venus_y_1+=math.pow(t,exp-1)*exp*     0.00005968061*math.cos( 3.60854941167 +    10213.28554621100*t)-math.pow(t,exp)*     0.00005968061*   10213.28554621100*math.sin( 3.60854941167 +    10213.28554621100*t)

      venus_y_2=0.0
      exp=2
      venus_y_2+=math.pow(t,exp-1)*exp*     0.00002062969*math.cos( 3.14159265359 +        0.00000000000*t)-math.pow(t,exp)*     0.00002062969*       0.00000000000*math.sin( 3.14159265359 +        0.00000000000*t)
   ...
   def venus_z(t):
      ...
      venus_z_0+=-math.pow(t,exp)*     0.00004802048*      38.13303563780*math.sin( 4.58264723370 +       38.13303563780*t)
      venus_z_0+=-math.pow(t,exp)*     0.00001130978*      74.78159856730*math.sin( 5.75878690645 +       74.78159856730*t)
      ...
      venus_z_1+=math.pow(t,exp-1)*exp*     0.00001264986*math.cos( 3.71037501321 +    20426.57109242200*t)-math.pow(t,exp)*     0.00001264986*   20426.57109242200*math.sin( 3.71037501321 +    20426.57109242200*t)
      venus_z_1+=math.pow(t,exp-1)*exp*     0.00001497542*math.cos( 0.00000000000 +        0.00000000000*t)-math.pow(t,exp)*     0.00001497542*       0.00000000000*math.sin( 0.00000000000 +        0.00000000000*t)

      venus_z_2=0.0
      exp=2
      venus_z_2+=math.pow(t,exp-1)*exp*     0.00009148022*math.cos( 3.34791005272 +    10213.28554621100*t)-math.pow(t,exp)*     0.00009148022*   10213.28554621100*math.sin( 3.34791005272 +    10213.28554621100*t)
