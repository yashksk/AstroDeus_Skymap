...
class vsop87c_pico :
   ...
   def getEarth(t):
      temp=[]
      temp.append(vsop87c_pico.earth_x(t))
      temp.append(vsop87c_pico.earth_y(t))
      temp.append(vsop87c_pico.earth_z(t))
      return temp
   ...
   def getJupiter(t):
      temp=[]
      temp.append(vsop87c_pico.jupiter_x(t))
      temp.append(vsop87c_pico.jupiter_y(t))
      temp.append(vsop87c_pico.jupiter_z(t))
      return temp
   ...
   def getMars(t):
      temp=[]
      temp.append(vsop87c_pico.mars_x(t))
      temp.append(vsop87c_pico.mars_y(t))
      temp.append(vsop87c_pico.mars_z(t))
      return temp
   ...
   def getMercury(t):
      temp=[]
      temp.append(vsop87c_pico.mercury_x(t))
      temp.append(vsop87c_pico.mercury_y(t))
      temp.append(vsop87c_pico.mercury_z(t))
      return temp
   ...
   def getNeptune(t):
      temp=[]
      temp.append(vsop87c_pico.neptune_x(t))
      temp.append(vsop87c_pico.neptune_y(t))
      temp.append(vsop87c_pico.neptune_z(t))
      return temp
   ...
   def getSaturn(t):
      temp=[]
      temp.append(vsop87c_pico.saturn_x(t))
      temp.append(vsop87c_pico.saturn_y(t))
      temp.append(vsop87c_pico.saturn_z(t))
      return temp
   ...
   def getUranus(t):
      temp=[]
      temp.append(vsop87c_pico.uranus_x(t))
      temp.append(vsop87c_pico.uranus_y(t))
      temp.append(vsop87c_pico.uranus_z(t))
      return temp
   ...
   def getVenus(t):
      temp=[]
      temp.append(vsop87c_pico.venus_x(t))
      temp.append(vsop87c_pico.venus_y(t))
      temp.append(vsop87c_pico.venus_z(t))
      return temp
