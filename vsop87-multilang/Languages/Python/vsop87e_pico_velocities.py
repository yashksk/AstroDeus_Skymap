...
class vsop87e_pico_velocities :
   ...
   def getEarth(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.earth_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.earth_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.earth_z(t) / 365250.0)
      return temp
   ...
   def getJupiter(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.jupiter_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.jupiter_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.jupiter_z(t) / 365250.0)
      return temp
   ...
   def getMars(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.mars_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.mars_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.mars_z(t) / 365250.0)
      return temp
   ...
   def getMercury(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.mercury_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.mercury_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.mercury_z(t) / 365250.0)
      return temp
   ...
   def getNeptune(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.neptune_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.neptune_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.neptune_z(t) / 365250.0)
      return temp
   ...
   def getSaturn(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.saturn_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.saturn_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.saturn_z(t) / 365250.0)
      return temp
   ...
   def getUranus(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.uranus_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.uranus_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.uranus_z(t) / 365250.0)
      return temp
   ...
   def getVenus(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.venus_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.venus_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.venus_z(t) / 365250.0)
      return temp
   ...
   def getSun(t):
      temp=[]
      temp.append(vsop87e_pico_velocities.sun_x(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.sun_y(t) / 365250.0)
      temp.append(vsop87e_pico_velocities.sun_z(t) / 365250.0)
      return temp
