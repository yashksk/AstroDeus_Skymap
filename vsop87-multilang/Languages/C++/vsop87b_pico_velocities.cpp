...
#include "vsop87b_pico_velocities.h"
#include <math.h>


void vsop87b_pico_velocities::getEarth(double t,double temp[]){
   temp[0]=vsop87b_pico_velocities::earth_l(t) / 365250.0;
   temp[1]=vsop87b_pico_velocities::earth_b(t) / 365250.0;
   temp[2]=vsop87b_pico_velocities::earth_r(t) / 365250.0;
}

void vsop87b_pico_velocities::getJupiter(double t,double temp[]){
   temp[0]=vsop87b_pico_velocities::jupiter_l(t) / 365250.0;
   temp[1]=vsop87b_pico_velocities::jupiter_b(t) / 365250.0;
   temp[2]=vsop87b_pico_velocities::jupiter_r(t) / 365250.0;
}

void vsop87b_pico_velocities::getMars(double t,double temp[]){
   temp[0]=vsop87b_pico_velocities::mars_l(t) / 365250.0;
   temp[1]=vsop87b_pico_velocities::mars_b(t) / 365250.0;
   temp[2]=vsop87b_pico_velocities::mars_r(t) / 365250.0;
}

void vsop87b_pico_velocities::getMercury(double t,double temp[]){
   temp[0]=vsop87b_pico_velocities::mercury_l(t) / 365250.0;
   temp[1]=vsop87b_pico_velocities::mercury_b(t) / 365250.0;
   temp[2]=vsop87b_pico_velocities::mercury_r(t) / 365250.0;
}

void vsop87b_pico_velocities::getNeptune(double t,double temp[]){
   temp[0]=vsop87b_pico_velocities::neptune_l(t) / 365250.0;
   temp[1]=vsop87b_pico_velocities::neptune_b(t) / 365250.0;
   temp[2]=vsop87b_pico_velocities::neptune_r(t) / 365250.0;
}

void vsop87b_pico_velocities::getSaturn(double t,double temp[]){
   temp[0]=vsop87b_pico_velocities::saturn_l(t) / 365250.0;
   temp[1]=vsop87b_pico_velocities::saturn_b(t) / 365250.0;
   temp[2]=vsop87b_pico_velocities::saturn_r(t) / 365250.0;
}

void vsop87b_pico_velocities::getUranus(double t,double temp[]){
   temp[0]=vsop87b_pico_velocities::uranus_l(t) / 365250.0;
   temp[1]=vsop87b_pico_velocities::uranus_b(t) / 365250.0;
   temp[2]=vsop87b_pico_velocities::uranus_r(t) / 365250.0;
}

void vsop87b_pico_velocities::getVenus(double t,double temp[]){
   temp[0]=vsop87b_pico_velocities::venus_l(t) / 365250.0;
   temp[1]=vsop87b_pico_velocities::venus_b(t) / 365250.0;
   temp[2]=vsop87b_pico_velocities::venus_r(t) / 365250.0;
}

double vsop87b_pico_velocities::earth_l(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::earth_b(double t){
   double exp=0.0;
   return 0;
}

double vsop87b_pico_velocities::earth_r(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::jupiter_l(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::jupiter_b(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::jupiter_r(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::mars_l(double t){
   double exp=0.0;
   double mars_l_0=0.0;
   exp=0;
...
double vsop87b_pico_velocities::mars_b(double t){
   double exp=0.0;
   double mars_b_0=0.0;
   exp=0;
...
double vsop87b_pico_velocities::mars_r(double t){
   double exp=0.0;
   double mars_r_0=0.0;
   exp=0;
...
double vsop87b_pico_velocities::mercury_l(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::mercury_b(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::mercury_r(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::neptune_l(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::neptune_b(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::neptune_r(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::saturn_l(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::saturn_b(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::saturn_r(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::uranus_l(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::uranus_b(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::uranus_r(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::venus_l(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::venus_b(double t){
   double exp=0.0;
...
double vsop87b_pico_velocities::venus_r(double t){
   double exp=0.0;
