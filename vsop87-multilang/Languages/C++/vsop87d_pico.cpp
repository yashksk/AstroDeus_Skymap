...
#include "vsop87d_pico.h"
#include <math.h>


void vsop87d_pico::getEarth(double t,double temp[]){
   temp[0]=vsop87d_pico::earth_l(t);
   temp[1]=vsop87d_pico::earth_b(t);
   temp[2]=vsop87d_pico::earth_r(t);
}

void vsop87d_pico::getJupiter(double t,double temp[]){
   temp[0]=vsop87d_pico::jupiter_l(t);
   temp[1]=vsop87d_pico::jupiter_b(t);
   temp[2]=vsop87d_pico::jupiter_r(t);
}

void vsop87d_pico::getMars(double t,double temp[]){
   temp[0]=vsop87d_pico::mars_l(t);
   temp[1]=vsop87d_pico::mars_b(t);
   temp[2]=vsop87d_pico::mars_r(t);
}

void vsop87d_pico::getMercury(double t,double temp[]){
   temp[0]=vsop87d_pico::mercury_l(t);
   temp[1]=vsop87d_pico::mercury_b(t);
   temp[2]=vsop87d_pico::mercury_r(t);
}

void vsop87d_pico::getNeptune(double t,double temp[]){
   temp[0]=vsop87d_pico::neptune_l(t);
   temp[1]=vsop87d_pico::neptune_b(t);
   temp[2]=vsop87d_pico::neptune_r(t);
}

void vsop87d_pico::getSaturn(double t,double temp[]){
   temp[0]=vsop87d_pico::saturn_l(t);
   temp[1]=vsop87d_pico::saturn_b(t);
   temp[2]=vsop87d_pico::saturn_r(t);
}

void vsop87d_pico::getUranus(double t,double temp[]){
   temp[0]=vsop87d_pico::uranus_l(t);
   temp[1]=vsop87d_pico::uranus_b(t);
   temp[2]=vsop87d_pico::uranus_r(t);
}

void vsop87d_pico::getVenus(double t,double temp[]){
   temp[0]=vsop87d_pico::venus_l(t);
   temp[1]=vsop87d_pico::venus_b(t);
   temp[2]=vsop87d_pico::venus_r(t);
}

double vsop87d_pico::earth_l(double t){
...
double vsop87d_pico::earth_b(double t){
   return 0;
}

double vsop87d_pico::earth_r(double t){
...
double vsop87d_pico::jupiter_l(double t){
...
double vsop87d_pico::jupiter_b(double t){
...
double vsop87d_pico::jupiter_r(double t){
...
double vsop87d_pico::mars_l(double t){
   double mars_l_0=0.0;
...
double vsop87d_pico::mars_b(double t){
   double mars_b_0=0.0;
...
double vsop87d_pico::mars_r(double t){
   double mars_r_0=0.0;
...
double vsop87d_pico::mercury_l(double t){
...
double vsop87d_pico::mercury_b(double t){
...
double vsop87d_pico::mercury_r(double t){
...
double vsop87d_pico::neptune_l(double t){
...
double vsop87d_pico::neptune_b(double t){
...
double vsop87d_pico::neptune_r(double t){
...
double vsop87d_pico::saturn_l(double t){
...
double vsop87d_pico::saturn_b(double t){
...
double vsop87d_pico::saturn_r(double t){
...
double vsop87d_pico::uranus_l(double t){
...
double vsop87d_pico::uranus_b(double t){
...
double vsop87d_pico::uranus_r(double t){
...
double vsop87d_pico::venus_l(double t){
...
double vsop87d_pico::venus_b(double t){
...
double vsop87d_pico::venus_r(double t){
