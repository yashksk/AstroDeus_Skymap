...
#include "vsop87d_nano.h"
#include <math.h>


void vsop87d_nano::getEarth(double t,double temp[]){
   temp[0]=vsop87d_nano::earth_l(t);
   temp[1]=vsop87d_nano::earth_b(t);
   temp[2]=vsop87d_nano::earth_r(t);
}

void vsop87d_nano::getJupiter(double t,double temp[]){
   temp[0]=vsop87d_nano::jupiter_l(t);
   temp[1]=vsop87d_nano::jupiter_b(t);
   temp[2]=vsop87d_nano::jupiter_r(t);
}

void vsop87d_nano::getMars(double t,double temp[]){
   temp[0]=vsop87d_nano::mars_l(t);
   temp[1]=vsop87d_nano::mars_b(t);
   temp[2]=vsop87d_nano::mars_r(t);
}

void vsop87d_nano::getMercury(double t,double temp[]){
   temp[0]=vsop87d_nano::mercury_l(t);
   temp[1]=vsop87d_nano::mercury_b(t);
   temp[2]=vsop87d_nano::mercury_r(t);
}

void vsop87d_nano::getNeptune(double t,double temp[]){
   temp[0]=vsop87d_nano::neptune_l(t);
   temp[1]=vsop87d_nano::neptune_b(t);
   temp[2]=vsop87d_nano::neptune_r(t);
}

void vsop87d_nano::getSaturn(double t,double temp[]){
   temp[0]=vsop87d_nano::saturn_l(t);
   temp[1]=vsop87d_nano::saturn_b(t);
   temp[2]=vsop87d_nano::saturn_r(t);
}

void vsop87d_nano::getUranus(double t,double temp[]){
   temp[0]=vsop87d_nano::uranus_l(t);
   temp[1]=vsop87d_nano::uranus_b(t);
   temp[2]=vsop87d_nano::uranus_r(t);
}

void vsop87d_nano::getVenus(double t,double temp[]){
   temp[0]=vsop87d_nano::venus_l(t);
   temp[1]=vsop87d_nano::venus_b(t);
   temp[2]=vsop87d_nano::venus_r(t);
}

double vsop87d_nano::earth_l(double t){
...
double vsop87d_nano::earth_b(double t){
   return 0;
}

double vsop87d_nano::earth_r(double t){
...
double vsop87d_nano::jupiter_l(double t){
...
double vsop87d_nano::jupiter_b(double t){
...
double vsop87d_nano::jupiter_r(double t){
...
double vsop87d_nano::mars_l(double t){
   double mars_l_0=0.0;
...
double vsop87d_nano::mars_b(double t){
   double mars_b_0=0.0;
...
double vsop87d_nano::mars_r(double t){
   double mars_r_0=0.0;
...
double vsop87d_nano::mercury_l(double t){
...
double vsop87d_nano::mercury_b(double t){
...
double vsop87d_nano::mercury_r(double t){
...
double vsop87d_nano::neptune_l(double t){
...
double vsop87d_nano::neptune_b(double t){
...
double vsop87d_nano::neptune_r(double t){
...
double vsop87d_nano::saturn_l(double t){
...
double vsop87d_nano::saturn_b(double t){
...
double vsop87d_nano::saturn_r(double t){
...
double vsop87d_nano::uranus_l(double t){
...
double vsop87d_nano::uranus_b(double t){
...
double vsop87d_nano::uranus_r(double t){
...
double vsop87d_nano::venus_l(double t){
...
double vsop87d_nano::venus_b(double t){
...
double vsop87d_nano::venus_r(double t){
