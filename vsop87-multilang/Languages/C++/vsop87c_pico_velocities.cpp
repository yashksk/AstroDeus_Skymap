...
#include "vsop87c_pico_velocities.h"
#include <math.h>


void vsop87c_pico_velocities::getEarth(double t,double temp[]){
   temp[0]=vsop87c_pico_velocities::earth_x(t) / 365250.0;
   temp[1]=vsop87c_pico_velocities::earth_y(t) / 365250.0;
   temp[2]=vsop87c_pico_velocities::earth_z(t) / 365250.0;
}

void vsop87c_pico_velocities::getJupiter(double t,double temp[]){
   temp[0]=vsop87c_pico_velocities::jupiter_x(t) / 365250.0;
   temp[1]=vsop87c_pico_velocities::jupiter_y(t) / 365250.0;
   temp[2]=vsop87c_pico_velocities::jupiter_z(t) / 365250.0;
}

void vsop87c_pico_velocities::getMars(double t,double temp[]){
   temp[0]=vsop87c_pico_velocities::mars_x(t) / 365250.0;
   temp[1]=vsop87c_pico_velocities::mars_y(t) / 365250.0;
   temp[2]=vsop87c_pico_velocities::mars_z(t) / 365250.0;
}

void vsop87c_pico_velocities::getMercury(double t,double temp[]){
   temp[0]=vsop87c_pico_velocities::mercury_x(t) / 365250.0;
   temp[1]=vsop87c_pico_velocities::mercury_y(t) / 365250.0;
   temp[2]=vsop87c_pico_velocities::mercury_z(t) / 365250.0;
}

void vsop87c_pico_velocities::getNeptune(double t,double temp[]){
   temp[0]=vsop87c_pico_velocities::neptune_x(t) / 365250.0;
   temp[1]=vsop87c_pico_velocities::neptune_y(t) / 365250.0;
   temp[2]=vsop87c_pico_velocities::neptune_z(t) / 365250.0;
}

void vsop87c_pico_velocities::getSaturn(double t,double temp[]){
   temp[0]=vsop87c_pico_velocities::saturn_x(t) / 365250.0;
   temp[1]=vsop87c_pico_velocities::saturn_y(t) / 365250.0;
   temp[2]=vsop87c_pico_velocities::saturn_z(t) / 365250.0;
}

void vsop87c_pico_velocities::getUranus(double t,double temp[]){
   temp[0]=vsop87c_pico_velocities::uranus_x(t) / 365250.0;
   temp[1]=vsop87c_pico_velocities::uranus_y(t) / 365250.0;
   temp[2]=vsop87c_pico_velocities::uranus_z(t) / 365250.0;
}

void vsop87c_pico_velocities::getVenus(double t,double temp[]){
   temp[0]=vsop87c_pico_velocities::venus_x(t) / 365250.0;
   temp[1]=vsop87c_pico_velocities::venus_y(t) / 365250.0;
   temp[2]=vsop87c_pico_velocities::venus_z(t) / 365250.0;
}

double vsop87c_pico_velocities::earth_x(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::earth_y(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::earth_z(double t){
   double exp=0.0;
   return 0;
}

double vsop87c_pico_velocities::jupiter_x(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::jupiter_y(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::jupiter_z(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::mars_x(double t){
   double exp=0.0;
   double mars_x_0=0.0;
   exp=0;
...
double vsop87c_pico_velocities::mars_y(double t){
   double exp=0.0;
   double mars_y_0=0.0;
   exp=0;
...
double vsop87c_pico_velocities::mars_z(double t){
   double exp=0.0;
   double mars_z_0=0.0;
   exp=0;
...
double vsop87c_pico_velocities::mercury_x(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::mercury_y(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::mercury_z(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::neptune_x(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::neptune_y(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::neptune_z(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::saturn_x(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::saturn_y(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::saturn_z(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::uranus_x(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::uranus_y(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::uranus_z(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::venus_x(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::venus_y(double t){
   double exp=0.0;
...
double vsop87c_pico_velocities::venus_z(double t){
   double exp=0.0;
