...
#include "vsop87_nano.h"
#include <math.h>


void vsop87_nano::getEmb(double t,double temp[]){
   temp[0]=vsop87_nano::emb_a(t);
   temp[1]=vsop87_nano::emb_l(t);
   temp[2]=vsop87_nano::emb_k(t);
   temp[3]=vsop87_nano::emb_h(t);
   temp[4]=vsop87_nano::emb_q(t);
   temp[5]=vsop87_nano::emb_p(t);
}

void vsop87_nano::getJupiter(double t,double temp[]){
   temp[0]=vsop87_nano::jupiter_a(t);
   temp[1]=vsop87_nano::jupiter_l(t);
   temp[2]=vsop87_nano::jupiter_k(t);
   temp[3]=vsop87_nano::jupiter_h(t);
   temp[4]=vsop87_nano::jupiter_q(t);
   temp[5]=vsop87_nano::jupiter_p(t);
}

void vsop87_nano::getMars(double t,double temp[]){
   temp[0]=vsop87_nano::mars_a(t);
   temp[1]=vsop87_nano::mars_l(t);
   temp[2]=vsop87_nano::mars_k(t);
   temp[3]=vsop87_nano::mars_h(t);
   temp[4]=vsop87_nano::mars_q(t);
   temp[5]=vsop87_nano::mars_p(t);
}

void vsop87_nano::getMercury(double t,double temp[]){
   temp[0]=vsop87_nano::mercury_a(t);
   temp[1]=vsop87_nano::mercury_l(t);
   temp[2]=vsop87_nano::mercury_k(t);
   temp[3]=vsop87_nano::mercury_h(t);
   temp[4]=vsop87_nano::mercury_q(t);
   temp[5]=vsop87_nano::mercury_p(t);
}

void vsop87_nano::getNeptune(double t,double temp[]){
   temp[0]=vsop87_nano::neptune_a(t);
   temp[1]=vsop87_nano::neptune_l(t);
   temp[2]=vsop87_nano::neptune_k(t);
   temp[3]=vsop87_nano::neptune_h(t);
   temp[4]=vsop87_nano::neptune_q(t);
   temp[5]=vsop87_nano::neptune_p(t);
}

void vsop87_nano::getSaturn(double t,double temp[]){
   temp[0]=vsop87_nano::saturn_a(t);
   temp[1]=vsop87_nano::saturn_l(t);
   temp[2]=vsop87_nano::saturn_k(t);
   temp[3]=vsop87_nano::saturn_h(t);
   temp[4]=vsop87_nano::saturn_q(t);
   temp[5]=vsop87_nano::saturn_p(t);
}

void vsop87_nano::getUranus(double t,double temp[]){
   temp[0]=vsop87_nano::uranus_a(t);
   temp[1]=vsop87_nano::uranus_l(t);
   temp[2]=vsop87_nano::uranus_k(t);
   temp[3]=vsop87_nano::uranus_h(t);
   temp[4]=vsop87_nano::uranus_q(t);
   temp[5]=vsop87_nano::uranus_p(t);
}

void vsop87_nano::getVenus(double t,double temp[]){
   temp[0]=vsop87_nano::venus_a(t);
   temp[1]=vsop87_nano::venus_l(t);
   temp[2]=vsop87_nano::venus_k(t);
   temp[3]=vsop87_nano::venus_h(t);
   temp[4]=vsop87_nano::venus_q(t);
   temp[5]=vsop87_nano::venus_p(t);
}

double vsop87_nano::emb_a(double t){
   double emb_a_0=0.0;
...
double vsop87_nano::emb_l(double t){
   double emb_l_0=0.0;
...
double vsop87_nano::emb_k(double t){
   double emb_k_0=0.0;
...
double vsop87_nano::emb_h(double t){
   double emb_h_0=0.0;
...
double vsop87_nano::emb_q(double t){
   double emb_q_1=0.0;
...
double vsop87_nano::emb_p(double t){
   return 0;
}

double vsop87_nano::jupiter_a(double t){
...
double vsop87_nano::jupiter_l(double t){
...
double vsop87_nano::jupiter_k(double t){
...
double vsop87_nano::jupiter_h(double t){
...
double vsop87_nano::jupiter_q(double t){
...
double vsop87_nano::jupiter_p(double t){
...
double vsop87_nano::mars_a(double t){
   double mars_a_0=0.0;
...
double vsop87_nano::mars_l(double t){
   double mars_l_0=0.0;
...
double vsop87_nano::mars_k(double t){
   double mars_k_0=0.0;
...
double vsop87_nano::mars_h(double t){
   double mars_h_0=0.0;
...
double vsop87_nano::mars_q(double t){
   double mars_q_0=0.0;
...
double vsop87_nano::mars_p(double t){
   double mars_p_0=0.0;
...
double vsop87_nano::mercury_a(double t){
...
double vsop87_nano::mercury_l(double t){
...
double vsop87_nano::mercury_k(double t){
...
double vsop87_nano::mercury_h(double t){
...
double vsop87_nano::mercury_q(double t){
...
double vsop87_nano::mercury_p(double t){
...
double vsop87_nano::neptune_a(double t){
...
double vsop87_nano::neptune_l(double t){
...
double vsop87_nano::neptune_k(double t){
...
double vsop87_nano::neptune_h(double t){
...
double vsop87_nano::neptune_q(double t){
...
double vsop87_nano::neptune_p(double t){
...
double vsop87_nano::saturn_a(double t){
...
double vsop87_nano::saturn_l(double t){
...
double vsop87_nano::saturn_k(double t){
...
double vsop87_nano::saturn_h(double t){
...
double vsop87_nano::saturn_q(double t){
...
double vsop87_nano::saturn_p(double t){
...
double vsop87_nano::uranus_a(double t){
...
double vsop87_nano::uranus_l(double t){
...
double vsop87_nano::uranus_k(double t){
...
double vsop87_nano::uranus_h(double t){
...
double vsop87_nano::uranus_q(double t){
...
double vsop87_nano::uranus_p(double t){
...
double vsop87_nano::venus_a(double t){
...
double vsop87_nano::venus_l(double t){
...
double vsop87_nano::venus_k(double t){
...
double vsop87_nano::venus_h(double t){
...
double vsop87_nano::venus_q(double t){
...
double vsop87_nano::venus_p(double t){
