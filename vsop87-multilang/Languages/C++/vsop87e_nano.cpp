...
#include "vsop87e_nano.h"
#include <math.h>


void vsop87e_nano::getEarth(double t,double temp[]){
   temp[0]=vsop87e_nano::earth_x(t);
   temp[1]=vsop87e_nano::earth_y(t);
   temp[2]=vsop87e_nano::earth_z(t);
}

void vsop87e_nano::getJupiter(double t,double temp[]){
   temp[0]=vsop87e_nano::jupiter_x(t);
   temp[1]=vsop87e_nano::jupiter_y(t);
   temp[2]=vsop87e_nano::jupiter_z(t);
}

void vsop87e_nano::getMars(double t,double temp[]){
   temp[0]=vsop87e_nano::mars_x(t);
   temp[1]=vsop87e_nano::mars_y(t);
   temp[2]=vsop87e_nano::mars_z(t);
}

void vsop87e_nano::getMercury(double t,double temp[]){
   temp[0]=vsop87e_nano::mercury_x(t);
   temp[1]=vsop87e_nano::mercury_y(t);
   temp[2]=vsop87e_nano::mercury_z(t);
}

void vsop87e_nano::getNeptune(double t,double temp[]){
   temp[0]=vsop87e_nano::neptune_x(t);
   temp[1]=vsop87e_nano::neptune_y(t);
   temp[2]=vsop87e_nano::neptune_z(t);
}

void vsop87e_nano::getSaturn(double t,double temp[]){
   temp[0]=vsop87e_nano::saturn_x(t);
   temp[1]=vsop87e_nano::saturn_y(t);
   temp[2]=vsop87e_nano::saturn_z(t);
}

void vsop87e_nano::getUranus(double t,double temp[]){
   temp[0]=vsop87e_nano::uranus_x(t);
   temp[1]=vsop87e_nano::uranus_y(t);
   temp[2]=vsop87e_nano::uranus_z(t);
}

void vsop87e_nano::getVenus(double t,double temp[]){
   temp[0]=vsop87e_nano::venus_x(t);
   temp[1]=vsop87e_nano::venus_y(t);
   temp[2]=vsop87e_nano::venus_z(t);
}

void vsop87e_nano::getSun(double t,double temp[]){
   temp[0]=vsop87e_nano::sun_x(t);
   temp[1]=vsop87e_nano::sun_y(t);
   temp[2]=vsop87e_nano::sun_z(t);
}

double vsop87e_nano::earth_x(double t){
...
double vsop87e_nano::earth_y(double t){
...
double vsop87e_nano::earth_z(double t){
...
double vsop87e_nano::jupiter_x(double t){
...
double vsop87e_nano::jupiter_y(double t){
...
double vsop87e_nano::jupiter_z(double t){
...
double vsop87e_nano::mars_x(double t){
   double mars_x_0=0.0;
...
double vsop87e_nano::mars_y(double t){
   double mars_y_0=0.0;
...
double vsop87e_nano::mars_z(double t){
   double mars_z_0=0.0;
...
double vsop87e_nano::mercury_x(double t){
...
double vsop87e_nano::mercury_y(double t){
...
double vsop87e_nano::mercury_z(double t){
...
double vsop87e_nano::neptune_x(double t){
...
double vsop87e_nano::neptune_y(double t){
...
double vsop87e_nano::neptune_z(double t){
...
double vsop87e_nano::saturn_x(double t){
...
double vsop87e_nano::saturn_y(double t){
...
double vsop87e_nano::saturn_z(double t){
...
double vsop87e_nano::sun_x(double t){
   double sun_x_0=0.0;
...
double vsop87e_nano::sun_y(double t){
   double sun_y_0=0.0;
...
double vsop87e_nano::sun_z(double t){
   return 0;
}

double vsop87e_nano::uranus_x(double t){
...
double vsop87e_nano::uranus_y(double t){
...
double vsop87e_nano::uranus_z(double t){
...
double vsop87e_nano::venus_x(double t){
...
double vsop87e_nano::venus_y(double t){
...
double vsop87e_nano::venus_z(double t){
