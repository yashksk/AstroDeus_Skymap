...
#include "vsop87e_pico.h"
#include <math.h>


void vsop87e_pico::getEarth(double t,double temp[]){
   temp[0]=vsop87e_pico::earth_x(t);
   temp[1]=vsop87e_pico::earth_y(t);
   temp[2]=vsop87e_pico::earth_z(t);
}

void vsop87e_pico::getJupiter(double t,double temp[]){
   temp[0]=vsop87e_pico::jupiter_x(t);
   temp[1]=vsop87e_pico::jupiter_y(t);
   temp[2]=vsop87e_pico::jupiter_z(t);
}

void vsop87e_pico::getMars(double t,double temp[]){
   temp[0]=vsop87e_pico::mars_x(t);
   temp[1]=vsop87e_pico::mars_y(t);
   temp[2]=vsop87e_pico::mars_z(t);
}

void vsop87e_pico::getMercury(double t,double temp[]){
   temp[0]=vsop87e_pico::mercury_x(t);
   temp[1]=vsop87e_pico::mercury_y(t);
   temp[2]=vsop87e_pico::mercury_z(t);
}

void vsop87e_pico::getNeptune(double t,double temp[]){
   temp[0]=vsop87e_pico::neptune_x(t);
   temp[1]=vsop87e_pico::neptune_y(t);
   temp[2]=vsop87e_pico::neptune_z(t);
}

void vsop87e_pico::getSaturn(double t,double temp[]){
   temp[0]=vsop87e_pico::saturn_x(t);
   temp[1]=vsop87e_pico::saturn_y(t);
   temp[2]=vsop87e_pico::saturn_z(t);
}

void vsop87e_pico::getUranus(double t,double temp[]){
   temp[0]=vsop87e_pico::uranus_x(t);
   temp[1]=vsop87e_pico::uranus_y(t);
   temp[2]=vsop87e_pico::uranus_z(t);
}

void vsop87e_pico::getVenus(double t,double temp[]){
   temp[0]=vsop87e_pico::venus_x(t);
   temp[1]=vsop87e_pico::venus_y(t);
   temp[2]=vsop87e_pico::venus_z(t);
}

void vsop87e_pico::getSun(double t,double temp[]){
   temp[0]=vsop87e_pico::sun_x(t);
   temp[1]=vsop87e_pico::sun_y(t);
   temp[2]=vsop87e_pico::sun_z(t);
}

double vsop87e_pico::earth_x(double t){
...
double vsop87e_pico::earth_y(double t){
...
double vsop87e_pico::earth_z(double t){
   return 0;
}

double vsop87e_pico::jupiter_x(double t){
...
double vsop87e_pico::jupiter_y(double t){
...
double vsop87e_pico::jupiter_z(double t){
...
double vsop87e_pico::mars_x(double t){
   double mars_x_0=0.0;
...
double vsop87e_pico::mars_y(double t){
   double mars_y_0=0.0;
...
double vsop87e_pico::mars_z(double t){
   double mars_z_0=0.0;
...
double vsop87e_pico::mercury_x(double t){
...
double vsop87e_pico::mercury_y(double t){
...
double vsop87e_pico::mercury_z(double t){
...
double vsop87e_pico::neptune_x(double t){
...
double vsop87e_pico::neptune_y(double t){
...
double vsop87e_pico::neptune_z(double t){
...
double vsop87e_pico::saturn_x(double t){
...
double vsop87e_pico::saturn_y(double t){
...
double vsop87e_pico::saturn_z(double t){
...
double vsop87e_pico::sun_x(double t){
   return 0;
}

double vsop87e_pico::sun_y(double t){
   return 0;
}

double vsop87e_pico::sun_z(double t){
   return 0;
}

double vsop87e_pico::uranus_x(double t){
...
double vsop87e_pico::uranus_y(double t){
...
double vsop87e_pico::uranus_z(double t){
...
double vsop87e_pico::venus_x(double t){
...
double vsop87e_pico::venus_y(double t){
...
double vsop87e_pico::venus_z(double t){
