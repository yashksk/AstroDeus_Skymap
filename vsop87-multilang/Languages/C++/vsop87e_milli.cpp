...
#include "vsop87e_milli.h"
#include <math.h>


void vsop87e_milli::getEarth(double t,double temp[]){
   temp[0]=vsop87e_milli::earth_x(t);
   temp[1]=vsop87e_milli::earth_y(t);
   temp[2]=vsop87e_milli::earth_z(t);
}

void vsop87e_milli::getJupiter(double t,double temp[]){
   temp[0]=vsop87e_milli::jupiter_x(t);
   temp[1]=vsop87e_milli::jupiter_y(t);
   temp[2]=vsop87e_milli::jupiter_z(t);
}

void vsop87e_milli::getMars(double t,double temp[]){
   temp[0]=vsop87e_milli::mars_x(t);
   temp[1]=vsop87e_milli::mars_y(t);
   temp[2]=vsop87e_milli::mars_z(t);
}

void vsop87e_milli::getMercury(double t,double temp[]){
   temp[0]=vsop87e_milli::mercury_x(t);
   temp[1]=vsop87e_milli::mercury_y(t);
   temp[2]=vsop87e_milli::mercury_z(t);
}

void vsop87e_milli::getNeptune(double t,double temp[]){
   temp[0]=vsop87e_milli::neptune_x(t);
   temp[1]=vsop87e_milli::neptune_y(t);
   temp[2]=vsop87e_milli::neptune_z(t);
}

void vsop87e_milli::getSaturn(double t,double temp[]){
   temp[0]=vsop87e_milli::saturn_x(t);
   temp[1]=vsop87e_milli::saturn_y(t);
   temp[2]=vsop87e_milli::saturn_z(t);
}

void vsop87e_milli::getUranus(double t,double temp[]){
   temp[0]=vsop87e_milli::uranus_x(t);
   temp[1]=vsop87e_milli::uranus_y(t);
   temp[2]=vsop87e_milli::uranus_z(t);
}

void vsop87e_milli::getVenus(double t,double temp[]){
   temp[0]=vsop87e_milli::venus_x(t);
   temp[1]=vsop87e_milli::venus_y(t);
   temp[2]=vsop87e_milli::venus_z(t);
}

void vsop87e_milli::getSun(double t,double temp[]){
   temp[0]=vsop87e_milli::sun_x(t);
   temp[1]=vsop87e_milli::sun_y(t);
   temp[2]=vsop87e_milli::sun_z(t);
}

double vsop87e_milli::earth_x(double t){
...
double vsop87e_milli::earth_y(double t){
...
double vsop87e_milli::earth_z(double t){
...
double vsop87e_milli::jupiter_x(double t){
...
double vsop87e_milli::jupiter_y(double t){
...
double vsop87e_milli::jupiter_z(double t){
...
double vsop87e_milli::mars_x(double t){
   double mars_x_0=0.0;
...
double vsop87e_milli::mars_y(double t){
   double mars_y_0=0.0;
...
double vsop87e_milli::mars_z(double t){
   double mars_z_0=0.0;
...
double vsop87e_milli::mercury_x(double t){
...
double vsop87e_milli::mercury_y(double t){
...
double vsop87e_milli::mercury_z(double t){
...
double vsop87e_milli::neptune_x(double t){
...
double vsop87e_milli::neptune_y(double t){
...
double vsop87e_milli::neptune_z(double t){
...
double vsop87e_milli::saturn_x(double t){
...
double vsop87e_milli::saturn_y(double t){
...
double vsop87e_milli::saturn_z(double t){
...
double vsop87e_milli::sun_x(double t){
   double sun_x_0=0.0;
...
double vsop87e_milli::sun_y(double t){
   double sun_y_0=0.0;
...
double vsop87e_milli::sun_z(double t){
   double sun_z_0=0.0;
...
double vsop87e_milli::uranus_x(double t){
...
double vsop87e_milli::uranus_y(double t){
...
double vsop87e_milli::uranus_z(double t){
...
double vsop87e_milli::venus_x(double t){
...
double vsop87e_milli::venus_y(double t){
...
double vsop87e_milli::venus_z(double t){
