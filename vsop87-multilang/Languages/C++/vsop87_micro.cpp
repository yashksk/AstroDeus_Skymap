...
#include "vsop87_micro.h"
#include <math.h>


void vsop87_micro::getEmb(double t,double temp[]){
   temp[0]=vsop87_micro::emb_a(t);
   temp[1]=vsop87_micro::emb_l(t);
   temp[2]=vsop87_micro::emb_k(t);
   temp[3]=vsop87_micro::emb_h(t);
   temp[4]=vsop87_micro::emb_q(t);
   temp[5]=vsop87_micro::emb_p(t);
}

void vsop87_micro::getJupiter(double t,double temp[]){
   temp[0]=vsop87_micro::jupiter_a(t);
   temp[1]=vsop87_micro::jupiter_l(t);
   temp[2]=vsop87_micro::jupiter_k(t);
   temp[3]=vsop87_micro::jupiter_h(t);
   temp[4]=vsop87_micro::jupiter_q(t);
   temp[5]=vsop87_micro::jupiter_p(t);
}

void vsop87_micro::getMars(double t,double temp[]){
   temp[0]=vsop87_micro::mars_a(t);
   temp[1]=vsop87_micro::mars_l(t);
   temp[2]=vsop87_micro::mars_k(t);
   temp[3]=vsop87_micro::mars_h(t);
   temp[4]=vsop87_micro::mars_q(t);
   temp[5]=vsop87_micro::mars_p(t);
}

void vsop87_micro::getMercury(double t,double temp[]){
   temp[0]=vsop87_micro::mercury_a(t);
   temp[1]=vsop87_micro::mercury_l(t);
   temp[2]=vsop87_micro::mercury_k(t);
   temp[3]=vsop87_micro::mercury_h(t);
   temp[4]=vsop87_micro::mercury_q(t);
   temp[5]=vsop87_micro::mercury_p(t);
}

void vsop87_micro::getNeptune(double t,double temp[]){
   temp[0]=vsop87_micro::neptune_a(t);
   temp[1]=vsop87_micro::neptune_l(t);
   temp[2]=vsop87_micro::neptune_k(t);
   temp[3]=vsop87_micro::neptune_h(t);
   temp[4]=vsop87_micro::neptune_q(t);
   temp[5]=vsop87_micro::neptune_p(t);
}

void vsop87_micro::getSaturn(double t,double temp[]){
   temp[0]=vsop87_micro::saturn_a(t);
   temp[1]=vsop87_micro::saturn_l(t);
   temp[2]=vsop87_micro::saturn_k(t);
   temp[3]=vsop87_micro::saturn_h(t);
   temp[4]=vsop87_micro::saturn_q(t);
   temp[5]=vsop87_micro::saturn_p(t);
}

void vsop87_micro::getUranus(double t,double temp[]){
   temp[0]=vsop87_micro::uranus_a(t);
   temp[1]=vsop87_micro::uranus_l(t);
   temp[2]=vsop87_micro::uranus_k(t);
   temp[3]=vsop87_micro::uranus_h(t);
   temp[4]=vsop87_micro::uranus_q(t);
   temp[5]=vsop87_micro::uranus_p(t);
}

void vsop87_micro::getVenus(double t,double temp[]){
   temp[0]=vsop87_micro::venus_a(t);
   temp[1]=vsop87_micro::venus_l(t);
   temp[2]=vsop87_micro::venus_k(t);
   temp[3]=vsop87_micro::venus_h(t);
   temp[4]=vsop87_micro::venus_q(t);
   temp[5]=vsop87_micro::venus_p(t);
}

double vsop87_micro::emb_a(double t){
   double emb_a_0=0.0;
...
double vsop87_micro::emb_l(double t){
   double emb_l_0=0.0;
...
double vsop87_micro::emb_k(double t){
   double emb_k_0=0.0;
...
double vsop87_micro::emb_h(double t){
   double emb_h_0=0.0;
...
double vsop87_micro::emb_q(double t){
   double emb_q_1=0.0;
...
double vsop87_micro::emb_p(double t){
   double emb_p_1=0.0;
...
double vsop87_micro::jupiter_a(double t){
...
double vsop87_micro::jupiter_l(double t){
...
double vsop87_micro::jupiter_k(double t){
...
double vsop87_micro::jupiter_h(double t){
...
double vsop87_micro::jupiter_q(double t){
...
double vsop87_micro::jupiter_p(double t){
...
double vsop87_micro::mars_a(double t){
   double mars_a_0=0.0;
...
double vsop87_micro::mars_l(double t){
   double mars_l_0=0.0;
...
double vsop87_micro::mars_k(double t){
   double mars_k_0=0.0;
...
double vsop87_micro::mars_h(double t){
   double mars_h_0=0.0;
...
double vsop87_micro::mars_q(double t){
   double mars_q_0=0.0;
...
double vsop87_micro::mars_p(double t){
   double mars_p_0=0.0;
...
double vsop87_micro::mercury_a(double t){
...
double vsop87_micro::mercury_l(double t){
...
double vsop87_micro::mercury_k(double t){
...
double vsop87_micro::mercury_h(double t){
...
double vsop87_micro::mercury_q(double t){
...
double vsop87_micro::mercury_p(double t){
...
double vsop87_micro::neptune_a(double t){
...
double vsop87_micro::neptune_l(double t){
...
double vsop87_micro::neptune_k(double t){
...
double vsop87_micro::neptune_h(double t){
...
double vsop87_micro::neptune_q(double t){
...
double vsop87_micro::neptune_p(double t){
...
double vsop87_micro::saturn_a(double t){
...
double vsop87_micro::saturn_l(double t){
...
double vsop87_micro::saturn_k(double t){
...
double vsop87_micro::saturn_h(double t){
...
double vsop87_micro::saturn_q(double t){
...
double vsop87_micro::saturn_p(double t){
...
double vsop87_micro::uranus_a(double t){
...
double vsop87_micro::uranus_l(double t){
...
double vsop87_micro::uranus_k(double t){
...
double vsop87_micro::uranus_h(double t){
...
double vsop87_micro::uranus_q(double t){
...
double vsop87_micro::uranus_p(double t){
...
double vsop87_micro::venus_a(double t){
...
double vsop87_micro::venus_l(double t){
...
double vsop87_micro::venus_k(double t){
...
double vsop87_micro::venus_h(double t){
...
double vsop87_micro::venus_q(double t){
...
double vsop87_micro::venus_p(double t){
