...
unit vsop87b_nano_velocities;

interface
uses Math;

procedure vsop87b_nano_velocities_getEarth(t: Double;var temp: array of Double);
procedure vsop87b_nano_velocities_getJupiter(t: Double;var temp: array of Double);
procedure vsop87b_nano_velocities_getMars(t: Double;var temp: array of Double);
procedure vsop87b_nano_velocities_getMercury(t: Double;var temp: array of Double);
procedure vsop87b_nano_velocities_getNeptune(t: Double;var temp: array of Double);
procedure vsop87b_nano_velocities_getSaturn(t: Double;var temp: array of Double);
procedure vsop87b_nano_velocities_getUranus(t: Double;var temp: array of Double);
procedure vsop87b_nano_velocities_getVenus(t: Double;var temp: array of Double);

implementation



function vsop87b_nano_velocities_earth_l(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_earth_l := earth_l_0+earth_l_1;
end;

function vsop87b_nano_velocities_earth_b(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_earth_b := earth_b_1;
end;

function vsop87b_nano_velocities_earth_r(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_earth_r := earth_r_0+earth_r_1;
end;

function vsop87b_nano_velocities_jupiter_l(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_jupiter_l := jupiter_l_0+jupiter_l_1;
end;

function vsop87b_nano_velocities_jupiter_b(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_jupiter_b := jupiter_b_0;
end;

function vsop87b_nano_velocities_jupiter_r(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_jupiter_r := jupiter_r_0+jupiter_r_1;
end;

function vsop87b_nano_velocities_mars_l(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_mars_l := mars_l_0+mars_l_1;
end;

function vsop87b_nano_velocities_mars_b(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_mars_b := mars_b_0+mars_b_1;
end;

function vsop87b_nano_velocities_mars_r(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_mars_r := mars_r_0+mars_r_1;
end;

function vsop87b_nano_velocities_mercury_l(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_mercury_l := mercury_l_0+mercury_l_1;
end;

function vsop87b_nano_velocities_mercury_b(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_mercury_b := mercury_b_0+mercury_b_1;
end;

function vsop87b_nano_velocities_mercury_r(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_mercury_r := mercury_r_0+mercury_r_1;
end;

function vsop87b_nano_velocities_neptune_l(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_neptune_l := neptune_l_0+neptune_l_1;
end;

function vsop87b_nano_velocities_neptune_b(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_neptune_b := neptune_b_0;
end;

function vsop87b_nano_velocities_neptune_r(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_neptune_r := neptune_r_0+neptune_r_1;
end;

function vsop87b_nano_velocities_saturn_l(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_saturn_l := saturn_l_0+saturn_l_1+saturn_l_2;
end;

function vsop87b_nano_velocities_saturn_b(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_saturn_b := saturn_b_0+saturn_b_1;
end;

function vsop87b_nano_velocities_saturn_r(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_saturn_r := saturn_r_0+saturn_r_1+saturn_r_2;
end;

function vsop87b_nano_velocities_uranus_l(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_uranus_l := uranus_l_0+uranus_l_1;
end;

function vsop87b_nano_velocities_uranus_b(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_uranus_b := uranus_b_0;
end;

function vsop87b_nano_velocities_uranus_r(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_uranus_r := uranus_r_0+uranus_r_1;
end;

function vsop87b_nano_velocities_venus_l(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_venus_l := venus_l_0+venus_l_1;
end;

function vsop87b_nano_velocities_venus_b(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_venus_b := venus_b_0+venus_b_1;
end;

function vsop87b_nano_velocities_venus_r(t: Double): Double;
   var exp: Double=0.0;
...
begin
   ...
   vsop87b_nano_velocities_venus_r := venus_r_0;
end;

procedure vsop87b_nano_velocities_getEarth(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87b_nano_velocities_earth_l(t) / 365250.0;
   temp[1]:=vsop87b_nano_velocities_earth_b(t) / 365250.0;
   temp[2]:=vsop87b_nano_velocities_earth_r(t) / 365250.0;
end;

procedure vsop87b_nano_velocities_getJupiter(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87b_nano_velocities_jupiter_l(t) / 365250.0;
   temp[1]:=vsop87b_nano_velocities_jupiter_b(t) / 365250.0;
   temp[2]:=vsop87b_nano_velocities_jupiter_r(t) / 365250.0;
end;

procedure vsop87b_nano_velocities_getMars(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87b_nano_velocities_mars_l(t) / 365250.0;
   temp[1]:=vsop87b_nano_velocities_mars_b(t) / 365250.0;
   temp[2]:=vsop87b_nano_velocities_mars_r(t) / 365250.0;
end;

procedure vsop87b_nano_velocities_getMercury(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87b_nano_velocities_mercury_l(t) / 365250.0;
   temp[1]:=vsop87b_nano_velocities_mercury_b(t) / 365250.0;
   temp[2]:=vsop87b_nano_velocities_mercury_r(t) / 365250.0;
end;

procedure vsop87b_nano_velocities_getNeptune(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87b_nano_velocities_neptune_l(t) / 365250.0;
   temp[1]:=vsop87b_nano_velocities_neptune_b(t) / 365250.0;
   temp[2]:=vsop87b_nano_velocities_neptune_r(t) / 365250.0;
end;

procedure vsop87b_nano_velocities_getSaturn(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87b_nano_velocities_saturn_l(t) / 365250.0;
   temp[1]:=vsop87b_nano_velocities_saturn_b(t) / 365250.0;
   temp[2]:=vsop87b_nano_velocities_saturn_r(t) / 365250.0;
end;

procedure vsop87b_nano_velocities_getUranus(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87b_nano_velocities_uranus_l(t) / 365250.0;
   temp[1]:=vsop87b_nano_velocities_uranus_b(t) / 365250.0;
   temp[2]:=vsop87b_nano_velocities_uranus_r(t) / 365250.0;
end;

procedure vsop87b_nano_velocities_getVenus(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87b_nano_velocities_venus_l(t) / 365250.0;
   temp[1]:=vsop87b_nano_velocities_venus_b(t) / 365250.0;
   temp[2]:=vsop87b_nano_velocities_venus_r(t) / 365250.0;
end;
end.