...
procedure vsop87b_nano_getEarth(t: Double;var temp: array of Double);
procedure vsop87b_nano_getJupiter(t: Double;var temp: array of Double);
procedure vsop87b_nano_getMars(t: Double;var temp: array of Double);
procedure vsop87b_nano_getMercury(t: Double;var temp: array of Double);
procedure vsop87b_nano_getNeptune(t: Double;var temp: array of Double);
procedure vsop87b_nano_getSaturn(t: Double;var temp: array of Double);
procedure vsop87b_nano_getUranus(t: Double;var temp: array of Double);
procedure vsop87b_nano_getVenus(t: Double;var temp: array of Double);
