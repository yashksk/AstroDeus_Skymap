...
procedure vsop87d_nano_velocities_getEarth(t: Double;var temp: array of Double);
procedure vsop87d_nano_velocities_getJupiter(t: Double;var temp: array of Double);
procedure vsop87d_nano_velocities_getMars(t: Double;var temp: array of Double);
procedure vsop87d_nano_velocities_getMercury(t: Double;var temp: array of Double);
procedure vsop87d_nano_velocities_getNeptune(t: Double;var temp: array of Double);
procedure vsop87d_nano_velocities_getSaturn(t: Double;var temp: array of Double);
procedure vsop87d_nano_velocities_getUranus(t: Double;var temp: array of Double);
procedure vsop87d_nano_velocities_getVenus(t: Double;var temp: array of Double);
