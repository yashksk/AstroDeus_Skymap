...
procedure vsop87c_nano_getEarth(t: Double;var temp: array of Double);
procedure vsop87c_nano_getJupiter(t: Double;var temp: array of Double);
procedure vsop87c_nano_getMars(t: Double;var temp: array of Double);
procedure vsop87c_nano_getMercury(t: Double;var temp: array of Double);
procedure vsop87c_nano_getNeptune(t: Double;var temp: array of Double);
procedure vsop87c_nano_getSaturn(t: Double;var temp: array of Double);
procedure vsop87c_nano_getUranus(t: Double;var temp: array of Double);
procedure vsop87c_nano_getVenus(t: Double;var temp: array of Double);

implementation



function vsop87c_nano_earth_x(t: Double): Double;
...
begin
   ...
   vsop87c_nano_earth_x := earth_x_0+earth_x_1;
end;

function vsop87c_nano_earth_y(t: Double): Double;
...
begin
   ...
   vsop87c_nano_earth_y := earth_y_0+earth_y_1;
end;

function vsop87c_nano_earth_z(t: Double): Double;
begin

   vsop87c_nano_earth_z := 0;
end;

function vsop87c_nano_jupiter_x(t: Double): Double;
...
begin
   ...
   vsop87c_nano_jupiter_x := jupiter_x_0+jupiter_x_1+jupiter_x_2;
end;

function vsop87c_nano_jupiter_y(t: Double): Double;
...
begin
   ...
   vsop87c_nano_jupiter_y := jupiter_y_0+jupiter_y_1+jupiter_y_2;
end;

function vsop87c_nano_jupiter_z(t: Double): Double;
...
begin
   ...
   vsop87c_nano_jupiter_z := jupiter_z_0+jupiter_z_1;
end;

function vsop87c_nano_mars_x(t: Double): Double;
...
begin
   ...
   vsop87c_nano_mars_x := mars_x_0+mars_x_1;
end;

function vsop87c_nano_mars_y(t: Double): Double;
...
begin
   ...
   vsop87c_nano_mars_y := mars_y_0+mars_y_1;
end;

function vsop87c_nano_mars_z(t: Double): Double;
...
begin
   ...
   vsop87c_nano_mars_z := mars_z_0+mars_z_1;
end;

function vsop87c_nano_mercury_x(t: Double): Double;
...
begin
   ...
   vsop87c_nano_mercury_x := mercury_x_0+mercury_x_1;
end;

function vsop87c_nano_mercury_y(t: Double): Double;
...
begin
   ...
   vsop87c_nano_mercury_y := mercury_y_0+mercury_y_1;
end;

function vsop87c_nano_mercury_z(t: Double): Double;
...
begin
   ...
   vsop87c_nano_mercury_z := mercury_z_0+mercury_z_1;
end;

function vsop87c_nano_neptune_x(t: Double): Double;
...
begin
   ...
   vsop87c_nano_neptune_x := neptune_x_0+neptune_x_1+neptune_x_2;
end;

function vsop87c_nano_neptune_y(t: Double): Double;
...
begin
   ...
   vsop87c_nano_neptune_y := neptune_y_0+neptune_y_1+neptune_y_2;
end;

function vsop87c_nano_neptune_z(t: Double): Double;
...
begin
   ...
   vsop87c_nano_neptune_z := neptune_z_0+neptune_z_1+neptune_z_2;
end;

function vsop87c_nano_saturn_x(t: Double): Double;
...
begin
   ...
   vsop87c_nano_saturn_x := saturn_x_0+saturn_x_1+saturn_x_2;
end;

function vsop87c_nano_saturn_y(t: Double): Double;
...
begin
   ...
   vsop87c_nano_saturn_y := saturn_y_0+saturn_y_1+saturn_y_2;
end;

function vsop87c_nano_saturn_z(t: Double): Double;
...
begin
   ...
   vsop87c_nano_saturn_z := saturn_z_0+saturn_z_1+saturn_z_2;
end;

function vsop87c_nano_uranus_x(t: Double): Double;
...
begin
   ...
   vsop87c_nano_uranus_x := uranus_x_0+uranus_x_1+uranus_x_2;
end;

function vsop87c_nano_uranus_y(t: Double): Double;
...
begin
   ...
   vsop87c_nano_uranus_y := uranus_y_0+uranus_y_1+uranus_y_2;
end;

function vsop87c_nano_uranus_z(t: Double): Double;
...
begin
   ...
   vsop87c_nano_uranus_z := uranus_z_0+uranus_z_1+uranus_z_2;
end;

function vsop87c_nano_venus_x(t: Double): Double;
...
begin
   ...
   vsop87c_nano_venus_x := venus_x_0;
end;

function vsop87c_nano_venus_y(t: Double): Double;
...
begin
   ...
   vsop87c_nano_venus_y := venus_y_0;
end;

function vsop87c_nano_venus_z(t: Double): Double;
...
begin
   ...
   vsop87c_nano_venus_z := venus_z_0+venus_z_1;
end;

procedure vsop87c_nano_getEarth(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87c_nano_earth_x(t);
   temp[1]:=vsop87c_nano_earth_y(t);
   temp[2]:=vsop87c_nano_earth_z(t);
end;

procedure vsop87c_nano_getJupiter(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87c_nano_jupiter_x(t);
   temp[1]:=vsop87c_nano_jupiter_y(t);
   temp[2]:=vsop87c_nano_jupiter_z(t);
end;

procedure vsop87c_nano_getMars(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87c_nano_mars_x(t);
   temp[1]:=vsop87c_nano_mars_y(t);
   temp[2]:=vsop87c_nano_mars_z(t);
end;

procedure vsop87c_nano_getMercury(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87c_nano_mercury_x(t);
   temp[1]:=vsop87c_nano_mercury_y(t);
   temp[2]:=vsop87c_nano_mercury_z(t);
end;

procedure vsop87c_nano_getNeptune(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87c_nano_neptune_x(t);
   temp[1]:=vsop87c_nano_neptune_y(t);
   temp[2]:=vsop87c_nano_neptune_z(t);
end;

procedure vsop87c_nano_getSaturn(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87c_nano_saturn_x(t);
   temp[1]:=vsop87c_nano_saturn_y(t);
   temp[2]:=vsop87c_nano_saturn_z(t);
end;

procedure vsop87c_nano_getUranus(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87c_nano_uranus_x(t);
   temp[1]:=vsop87c_nano_uranus_y(t);
   temp[2]:=vsop87c_nano_uranus_z(t);
end;

procedure vsop87c_nano_getVenus(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87c_nano_venus_x(t);
   temp[1]:=vsop87c_nano_venus_y(t);
   temp[2]:=vsop87c_nano_venus_z(t);
end;
end.