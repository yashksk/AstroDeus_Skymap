...
procedure vsop87a_micro_velocities_getEarth(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getEmb(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getJupiter(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getMars(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getMercury(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getNeptune(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getSaturn(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getUranus(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getVenus(t: Double;var temp: array of Double);
procedure vsop87a_micro_velocities_getMoon(var earth: array of Double; var emb: array of Double;var temp: array of Double);
