...
procedure vsop87_micro_getEmb(t: Double;var temp: array of Double);
procedure vsop87_micro_getJupiter(t: Double;var temp: array of Double);
procedure vsop87_micro_getMars(t: Double;var temp: array of Double);
procedure vsop87_micro_getMercury(t: Double;var temp: array of Double);
procedure vsop87_micro_getNeptune(t: Double;var temp: array of Double);
procedure vsop87_micro_getSaturn(t: Double;var temp: array of Double);
procedure vsop87_micro_getUranus(t: Double;var temp: array of Double);
procedure vsop87_micro_getVenus(t: Double;var temp: array of Double);

implementation



function vsop87_micro_emb_a(t: Double): Double;
   var emb_a_0: Double=0.0;
begin

   emb_a_0:=emb_a_0 +      1.00000101778 * Cos( 0.00000000000 +        0.00000000000*t);

   vsop87_micro_emb_a := emb_a_0;
end;

function vsop87_micro_emb_l(t: Double): Double;
...
begin
   ...
   vsop87_micro_emb_l := emb_l_0+emb_l_1;
end;

function vsop87_micro_emb_k(t: Double): Double;
...
begin
   ...
   vsop87_micro_emb_k := emb_k_0+emb_k_1;
end;

function vsop87_micro_emb_h(t: Double): Double;
...
begin
   ...
   vsop87_micro_emb_h := emb_h_0+emb_h_1;
end;

function vsop87_micro_emb_q(t: Double): Double;
...
begin
   ...
   vsop87_micro_emb_q := emb_q_1;
end;

function vsop87_micro_emb_p(t: Double): Double;
...
begin
   ...
   vsop87_micro_emb_p := emb_p_1;
end;

function vsop87_micro_jupiter_a(t: Double): Double;
...
begin
   ...
   vsop87_micro_jupiter_a := jupiter_a_0+jupiter_a_1;
end;

function vsop87_micro_jupiter_l(t: Double): Double;
...
begin
   ...
   vsop87_micro_jupiter_l := jupiter_l_0+jupiter_l_1+jupiter_l_2;
end;

function vsop87_micro_jupiter_k(t: Double): Double;
...
begin
   ...
   vsop87_micro_jupiter_k := jupiter_k_0+jupiter_k_1+jupiter_k_2;
end;

function vsop87_micro_jupiter_h(t: Double): Double;
...
begin
   ...
   vsop87_micro_jupiter_h := jupiter_h_0+jupiter_h_1;
end;

function vsop87_micro_jupiter_q(t: Double): Double;
...
begin
   ...
   vsop87_micro_jupiter_q := jupiter_q_0+jupiter_q_1;
end;

function vsop87_micro_jupiter_p(t: Double): Double;
...
begin
   ...
   vsop87_micro_jupiter_p := jupiter_p_0+jupiter_p_1;
end;

function vsop87_micro_mars_a(t: Double): Double;
   var mars_a_0: Double=0.0;
begin

   mars_a_0:=mars_a_0 +      1.52367934191 * Cos( 0.00000000000 +        0.00000000000*t);

   vsop87_micro_mars_a := mars_a_0;
end;

function vsop87_micro_mars_l(t: Double): Double;
...
begin
   ...
   vsop87_micro_mars_l := mars_l_0+mars_l_1;
end;

function vsop87_micro_mars_k(t: Double): Double;
...
begin
   ...
   vsop87_micro_mars_k := mars_k_0+mars_k_1+mars_k_2;
end;

function vsop87_micro_mars_h(t: Double): Double;
...
begin
   ...
   vsop87_micro_mars_h := mars_h_0+mars_h_1+mars_h_2;
end;

function vsop87_micro_mars_q(t: Double): Double;
...
begin
   ...
   vsop87_micro_mars_q := mars_q_0+mars_q_1;
end;

function vsop87_micro_mars_p(t: Double): Double;
...
begin
   ...
   vsop87_micro_mars_p := mars_p_0+mars_p_1;
end;

function vsop87_micro_mercury_a(t: Double): Double;
   var mercury_a_0: Double=0.0;
begin

   mercury_a_0:=mercury_a_0 +      0.38709830982 * Cos( 0.00000000000 +        0.00000000000*t);

   vsop87_micro_mercury_a := mercury_a_0;
end;

function vsop87_micro_mercury_l(t: Double): Double;
...
begin
   ...
   vsop87_micro_mercury_l := mercury_l_0+mercury_l_1;
end;

function vsop87_micro_mercury_k(t: Double): Double;
...
begin
   ...
   vsop87_micro_mercury_k := mercury_k_0+mercury_k_1;
end;

function vsop87_micro_mercury_h(t: Double): Double;
...
begin
   ...
   vsop87_micro_mercury_h := mercury_h_0+mercury_h_1;
end;

function vsop87_micro_mercury_q(t: Double): Double;
...
begin
   ...
   vsop87_micro_mercury_q := mercury_q_0+mercury_q_1;
end;

function vsop87_micro_mercury_p(t: Double): Double;
...
begin
   ...
   vsop87_micro_mercury_p := mercury_p_0+mercury_p_1;
end;

function vsop87_micro_neptune_a(t: Double): Double;
...
begin
   ...
   vsop87_micro_neptune_a := neptune_a_0+neptune_a_1;
end;

function vsop87_micro_neptune_l(t: Double): Double;
...
begin
   ...
   vsop87_micro_neptune_l := neptune_l_0+neptune_l_1;
end;

function vsop87_micro_neptune_k(t: Double): Double;
...
begin
   ...
   vsop87_micro_neptune_k := neptune_k_0;
end;

function vsop87_micro_neptune_h(t: Double): Double;
...
begin
   ...
   vsop87_micro_neptune_h := neptune_h_0;
end;

function vsop87_micro_neptune_q(t: Double): Double;
   var neptune_q_0: Double=0.0;
begin

   neptune_q_0:=neptune_q_0 +      0.01029147819 * Cos( 3.14159265359 +        0.00000000000*t);

   vsop87_micro_neptune_q := neptune_q_0;
end;

function vsop87_micro_neptune_p(t: Double): Double;
   var neptune_p_0: Double=0.0;
begin

   neptune_p_0:=neptune_p_0 +      0.01151683985 * Cos( 0.00000000000 +        0.00000000000*t);

   vsop87_micro_neptune_p := neptune_p_0;
end;

function vsop87_micro_saturn_a(t: Double): Double;
...
begin
   ...
   vsop87_micro_saturn_a := saturn_a_0+saturn_a_1+saturn_a_2;
end;

function vsop87_micro_saturn_l(t: Double): Double;
...
begin
   ...
   vsop87_micro_saturn_l := saturn_l_0+saturn_l_1+saturn_l_2+saturn_l_3;
end;

function vsop87_micro_saturn_k(t: Double): Double;
...
begin
   ...
   vsop87_micro_saturn_k := saturn_k_0+saturn_k_1+saturn_k_2;
end;

function vsop87_micro_saturn_h(t: Double): Double;
...
begin
   ...
   vsop87_micro_saturn_h := saturn_h_0+saturn_h_1+saturn_h_2;
end;

function vsop87_micro_saturn_q(t: Double): Double;
...
begin
   ...
   vsop87_micro_saturn_q := saturn_q_0+saturn_q_1;
end;

function vsop87_micro_saturn_p(t: Double): Double;
...
begin
   ...
   vsop87_micro_saturn_p := saturn_p_0+saturn_p_1;
end;

function vsop87_micro_uranus_a(t: Double): Double;
...
begin
   ...
   vsop87_micro_uranus_a := uranus_a_0+uranus_a_1;
end;

function vsop87_micro_uranus_l(t: Double): Double;
...
begin
   ...
   vsop87_micro_uranus_l := uranus_l_0+uranus_l_1;
end;

function vsop87_micro_uranus_k(t: Double): Double;
...
begin
   ...
   vsop87_micro_uranus_k := uranus_k_0+uranus_k_1;
end;

function vsop87_micro_uranus_h(t: Double): Double;
...
begin
   ...
   vsop87_micro_uranus_h := uranus_h_0+uranus_h_1;
end;

function vsop87_micro_uranus_q(t: Double): Double;
...
begin
   ...
   vsop87_micro_uranus_q := uranus_q_0+uranus_q_1;
end;

function vsop87_micro_uranus_p(t: Double): Double;
...
begin
   ...
   vsop87_micro_uranus_p := uranus_p_0+uranus_p_1;
end;

function vsop87_micro_venus_a(t: Double): Double;
   var venus_a_0: Double=0.0;
begin

   venus_a_0:=venus_a_0 +      0.72332981996 * Cos( 0.00000000000 +        0.00000000000*t);

   vsop87_micro_venus_a := venus_a_0;
end;

function vsop87_micro_venus_l(t: Double): Double;
...
begin
   ...
   vsop87_micro_venus_l := venus_l_0+venus_l_1;
end;

function vsop87_micro_venus_k(t: Double): Double;
...
begin
   ...
   vsop87_micro_venus_k := venus_k_0+venus_k_1;
end;

function vsop87_micro_venus_h(t: Double): Double;
...
begin
   ...
   vsop87_micro_venus_h := venus_h_0+venus_h_1;
end;

function vsop87_micro_venus_q(t: Double): Double;
...
begin
   ...
   vsop87_micro_venus_q := venus_q_0+venus_q_1;
end;

function vsop87_micro_venus_p(t: Double): Double;
...
begin
   ...
   vsop87_micro_venus_p := venus_p_0+venus_p_1;
end;

procedure vsop87_micro_getEmb(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87_micro_emb_a(t);
   temp[1]:=vsop87_micro_emb_l(t);
   temp[2]:=vsop87_micro_emb_k(t);
   temp[3]:=vsop87_micro_emb_h(t);
   temp[4]:=vsop87_micro_emb_q(t);
   temp[5]:=vsop87_micro_emb_p(t);
end;

procedure vsop87_micro_getJupiter(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87_micro_jupiter_a(t);
   temp[1]:=vsop87_micro_jupiter_l(t);
   temp[2]:=vsop87_micro_jupiter_k(t);
   temp[3]:=vsop87_micro_jupiter_h(t);
   temp[4]:=vsop87_micro_jupiter_q(t);
   temp[5]:=vsop87_micro_jupiter_p(t);
end;

procedure vsop87_micro_getMars(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87_micro_mars_a(t);
   temp[1]:=vsop87_micro_mars_l(t);
   temp[2]:=vsop87_micro_mars_k(t);
   temp[3]:=vsop87_micro_mars_h(t);
   temp[4]:=vsop87_micro_mars_q(t);
   temp[5]:=vsop87_micro_mars_p(t);
end;

procedure vsop87_micro_getMercury(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87_micro_mercury_a(t);
   temp[1]:=vsop87_micro_mercury_l(t);
   temp[2]:=vsop87_micro_mercury_k(t);
   temp[3]:=vsop87_micro_mercury_h(t);
   temp[4]:=vsop87_micro_mercury_q(t);
   temp[5]:=vsop87_micro_mercury_p(t);
end;

procedure vsop87_micro_getNeptune(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87_micro_neptune_a(t);
   temp[1]:=vsop87_micro_neptune_l(t);
   temp[2]:=vsop87_micro_neptune_k(t);
   temp[3]:=vsop87_micro_neptune_h(t);
   temp[4]:=vsop87_micro_neptune_q(t);
   temp[5]:=vsop87_micro_neptune_p(t);
end;

procedure vsop87_micro_getSaturn(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87_micro_saturn_a(t);
   temp[1]:=vsop87_micro_saturn_l(t);
   temp[2]:=vsop87_micro_saturn_k(t);
   temp[3]:=vsop87_micro_saturn_h(t);
   temp[4]:=vsop87_micro_saturn_q(t);
   temp[5]:=vsop87_micro_saturn_p(t);
end;

procedure vsop87_micro_getUranus(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87_micro_uranus_a(t);
   temp[1]:=vsop87_micro_uranus_l(t);
   temp[2]:=vsop87_micro_uranus_k(t);
   temp[3]:=vsop87_micro_uranus_h(t);
   temp[4]:=vsop87_micro_uranus_q(t);
   temp[5]:=vsop87_micro_uranus_p(t);
end;

procedure vsop87_micro_getVenus(t: Double;var temp: array of Double);
begin
   temp[0]:=vsop87_micro_venus_a(t);
   temp[1]:=vsop87_micro_venus_l(t);
   temp[2]:=vsop87_micro_venus_k(t);
   temp[3]:=vsop87_micro_venus_h(t);
   temp[4]:=vsop87_micro_venus_q(t);
   temp[5]:=vsop87_micro_venus_p(t);
end;
end.