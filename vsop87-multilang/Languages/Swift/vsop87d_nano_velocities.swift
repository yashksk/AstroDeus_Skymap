...
class vsop87d_nano_velocities{
   ...
   static func venus_r(t:Double)->Double{
      ...
      venus_r_0 += -1 * 0.00489824185 * 10213.28554621100 * sin(4.02151832268 + 10213.28554621100*t)
   ...
   static func venus_b(t:Double)->Double{
      ...
      venus_b_1 += pow(t,0) * 1 * 0.00513347602 * cos(1.80364310797 + 10213.28554621100*t) - pow(t,1) * 0.00513347602 * 10213.28554621100 * sin(1.80364310797 + 10213.28554621100*t)
   ...
   static func uranus_r(t:Double)->Double{
      ...
      uranus_r_0 += -1 * 0.00143705902 * 11.04570026390 * sin(1.38368574483 + 11.04570026390*t)
      uranus_r_0 += -1 * 0.00161858251 * 148.07872442630 * sin(2.79137863469 + 148.07872442630*t)
      uranus_r_0 += -1 * 0.00190521915 * 1.48447270830 * sin(1.99809364502 + 1.48447270830*t)
      uranus_r_0 += -1 * 0.00243508222 * 71.81265315070 * sin(1.57086595074 + 71.81265315070*t)
      uranus_r_0 += -1 * 0.00338525522 * 138.51749687070 * sin(1.58002682946 + 138.51749687070*t)
      uranus_r_0 += -1 * 0.00496404171 * 454.90936652730 * sin(1.40139934716 + 454.90936652730*t)
      uranus_r_0 += -1 * 0.00602248144 * 63.73589830340 * sin(3.86003820462 + 63.73589830340*t)
      uranus_r_0 += -1 * 0.00649321851 * 76.26607127560 * sin(4.52247298119 + 76.26607127560*t)
   ...
   static func uranus_b(t:Double)->Double{
      ...
      uranus_b_1 += pow(t,0) * 1 * 0.00206366162 * cos(4.12394311407 + 74.78159856730*t) - pow(t,1) * 0.00206366162 * 74.78159856730 * sin(4.12394311407 + 74.78159856730*t)
   ...
   static func uranus_l(t:Double)->Double{
      ...
      uranus_l_1 += pow(t,0) * 1 * 0.00154458244 * cos(5.24201658072 + 74.78159856730*t) - pow(t,1) * 0.00154458244 * 74.78159856730 * sin(5.24201658072 + 74.78159856730*t)
      ...
      uranus_l_0 += -1 * 0.00272328132 * 149.56319713460 * sin(3.35823710524 + 149.56319713460*t)
      uranus_l_0 += -1 * 0.00365981718 * 73.29712585900 * sin(1.89962189068 + 73.29712585900*t)
   ...
   static func saturn_r(t:Double)->Double{
      ...
      saturn_r_2 += pow(t,1) * 2 * 0.00436902464 * cos(4.78671673044 + 213.29909543800*t) - pow(t,2) * 0.00436902464 * 213.29909543800 * sin(4.78671673044 + 213.29909543800*t)

      var saturn_r_1: Double = 0.0

      saturn_r_1 += pow(t,0) * 1 * 0.00143891176 * cos(1.40744864239 + 7.11354700080*t) - pow(t,1) * 0.00143891176 * 7.11354700080 * sin(1.40744864239 + 7.11354700080*t)
      saturn_r_1 += pow(t,0) * 1 * 0.00186261540 * cos(3.14159265359 + 0.00000000000*t) - pow(t,1) * 0.00186261540 * 0.00000000000 * sin(3.14159265359 + 0.00000000000*t)
      saturn_r_1 += pow(t,0) * 1 * 0.00188491375 * cos(0.47215719444 + 220.41264243880*t) - pow(t,1) * 0.00188491375 * 220.41264243880 * sin(0.47215719444 + 220.41264243880*t)
      saturn_r_1 += pow(t,0) * 1 * 0.00341394136 * cos(5.79635773960 + 426.59819087600*t) - pow(t,1) * 0.00341394136 * 426.59819087600 * sin(5.79635773960 + 426.59819087600*t)
      saturn_r_1 += pow(t,0) * 1 * 0.00506577574 * cos(0.71114650941 + 206.18554843720*t) - pow(t,1) * 0.00506577574 * 206.18554843720 * sin(0.71114650941 + 206.18554843720*t)
      ...
      saturn_r_0 += -1 * 0.00108974737 * 110.20632121940 * sin(3.29313595577 + 110.20632121940*t)
      saturn_r_0 += -1 * 0.00140617548 * 632.78373931320 * sin(5.70406652991 + 632.78373931320*t)
      saturn_r_0 += -1 * 0.00361778433 * 7.11354700080 * sin(3.13904303264 + 7.11354700080*t)
      saturn_r_0 += -1 * 0.00371684449 * 220.41264243880 * sin(2.27114833428 + 220.41264243880*t)
      saturn_r_0 += -1 * 0.00547506899 * 103.09277421860 * sin(5.01532628454 + 103.09277421860*t)
      saturn_r_0 += -1 * 0.00821891059 * 316.39186965660 * sin(5.93520025371 + 316.39186965660*t)
   ...
   static func saturn_b(t:Double)->Double{
      ...
      saturn_b_1 += pow(t,0) * 1 * 0.00397554998 * cos(5.33289992556 + 213.29909543800*t) - pow(t,1) * 0.00397554998 * 213.29909543800 * sin(5.33289992556 + 213.29909543800*t)

      var saturn_b_0: Double = 0.0

      saturn_b_0 += -1 * 0.00240348303 * 426.59819087600 * sin(2.85238489390 + 426.59819087600*t)
   ...
   static func saturn_l(t:Double)->Double{
      ...
      saturn_l_2 += pow(t,1) * 2 * 0.00116441181 * cos(1.17987850633 + 7.11354700080*t) - pow(t,2) * 0.00116441181 * 7.11354700080 * sin(1.17987850633 + 7.11354700080*t)

      var saturn_l_1: Double = 0.0

      saturn_l_1 += pow(t,0) * 1 * 0.00107678770 * cos(2.27769911872 + 206.18554843720*t) - pow(t,1) * 0.00107678770 * 206.18554843720 * sin(2.27769911872 + 206.18554843720*t)
      saturn_l_1 += pow(t,0) * 1 * 0.00564347566 * cos(2.88500136429 + 7.11354700080*t) - pow(t,1) * 0.00564347566 * 7.11354700080 * sin(2.88500136429 + 7.11354700080*t)
      ...
      saturn_l_0 += -1 * 0.00206816296 * 103.09277421860 * sin(0.24658366938 + 103.09277421860*t)
      saturn_l_0 += -1 * 0.00350769223 * 426.59819087600 * sin(3.30329903015 + 426.59819087600*t)
      saturn_l_0 += -1 * 0.00398379386 * 206.18554843720 * sin(0.52112025957 + 206.18554843720*t)
   ...
   static func neptune_r(t:Double)->Double{
      ...
      neptune_r_1 += pow(t,0) * 1 * 0.00236338502 * cos(0.70498011235 + 38.13303563780*t) - pow(t,1) * 0.00236338502 * 38.13303563780 * sin(0.70498011235 + 38.13303563780*t)

      var neptune_r_0: Double = 0.0

      neptune_r_0 += -1 * 0.00100895397 * 73.29712585900 * sin(0.37702748681 + 73.29712585900*t)
      neptune_r_0 += -1 * 0.00121801825 * 76.26607127560 * sin(5.79754444303 + 76.26607127560*t)
      neptune_r_0 += -1 * 0.00135134095 * 39.61750834610 * sin(3.37220607384 + 39.61750834610*t)
      neptune_r_0 += -1 * 0.00274571970 * 175.16605980020 * sin(1.84552256801 + 175.16605980020*t)
      neptune_r_0 += -1 * 0.00495725642 * 491.55792945680 * sin(1.57105654815 + 491.55792945680*t)
      neptune_r_0 += -1 * 0.00537760613 * 35.16409022120 * sin(4.52113902845 + 35.16409022120*t)
      neptune_r_0 += -1 * 0.00807830737 * 1.48447270830 * sin(5.18592836167 + 1.48447270830*t)
   ...
   static func neptune_b(t:Double)->Double{
      ...
      neptune_b_1 += pow(t,0) * 1 * 0.00227279214 * cos(3.80793089870 + 38.13303563780*t) - pow(t,1) * 0.00227279214 * 38.13303563780 * sin(3.80793089870 + 38.13303563780*t)
   ...
   static func neptune_l(t:Double)->Double{
      ...
      neptune_l_0 += -1 * 0.00124531845 * 36.64856292950 * sin(4.83008090682 + 36.64856292950*t)
   ...
   static func mercury_r(t:Double)->Double{
      ...
      mercury_r_1 += pow(t,0) * 1 * 0.00217347739 * cos(4.65617158663 + 26087.90314157420*t) - pow(t,1) * 0.00217347739 * 26087.90314157420 * sin(4.65617158663 + 26087.90314157420*t)

      var mercury_r_0: Double = 0.0

      mercury_r_0 += -1 * 0.00121281763 * 78263.70942472259 * sin(6.01064153805 + 78263.70942472259*t)
      mercury_r_0 += -1 * 0.00795525557 * 52175.80628314840 * sin(2.95989690096 + 52175.80628314840*t)
   ...
   static func mercury_b(t:Double)->Double{
      ...
      mercury_b_1 += pow(t,0) * 1 * 0.00146233668 * cos(3.14159265359 + 0.00000000000*t) - pow(t,1) * 0.00146233668 * 0.00000000000 * sin(3.14159265359 + 0.00000000000*t)
      mercury_b_1 += pow(t,0) * 1 * 0.00429151362 * cos(3.50169780393 + 26087.90314157420*t) - pow(t,1) * 0.00429151362 * 26087.90314157420 * sin(3.50169780393 + 26087.90314157420*t)

      var mercury_b_0: Double = 0.0

      mercury_b_0 += -1 * 0.00129778770 * 104351.61256629678 * sin(4.83232503961 + 104351.61256629678*t)
      mercury_b_0 += -1 * 0.00543251810 * 78263.70942472259 * sin(1.79644363963 + 78263.70942472259*t)
   ...
   static func mercury_l(t:Double)->Double{
      ...
      mercury_l_1 += pow(t,0) * 1 * 0.00303471395 * cos(3.05565472363 + 52175.80628314840*t) - pow(t,1) * 0.00303471395 * 52175.80628314840 * sin(3.05565472363 + 52175.80628314840*t)
      ...
      mercury_l_0 += -1 * 0.00165590362 * 104351.61256629678 * sin(4.11969163181 + 104351.61256629678*t)
      mercury_l_0 += -1 * 0.00855346843 * 78263.70942472259 * sin(1.16520322351 + 78263.70942472259*t)
   ...
   static func mars_r(t:Double)->Double{
      ...
      mars_r_1 += pow(t,0) * 1 * 0.00103175886 * cos(2.37071845682 + 6681.22485339960*t) - pow(t,1) * 0.00103175886 * 6681.22485339960 * sin(2.37071845682 + 6681.22485339960*t)
      ...
      mars_r_0 += -1 * 0.00660776357 * 6681.22485339960 * sin(3.81783442097 + 6681.22485339960*t)
   ...
   static func mars_b(t:Double)->Double{
      ...
      mars_b_1 += pow(t,0) * 1 * 0.00350068845 * cos(5.36847836211 + 3340.61242669980*t) - pow(t,1) * 0.00350068845 * 3340.61242669980 * sin(5.36847836211 + 3340.61242669980*t)

      var mars_b_0: Double = 0.0

      mars_b_0 += -1 * 0.00289104742 * 0.00000000000 * sin(0.00000000000 + 0.00000000000*t)
      mars_b_0 += -1 * 0.00298033234 * 6681.22485339960 * sin(4.10616996243 + 6681.22485339960*t)
   ...
   static func mars_l(t:Double)->Double{
      ...
      mars_l_1 += pow(t,0) * 1 * 0.00164901343 * cos(3.92631250962 + 6681.22485339960*t) - pow(t,1) * 0.00164901343 * 6681.22485339960 * sin(3.92631250962 + 6681.22485339960*t)
   ...
   static func jupiter_r(t:Double)->Double{
      ...
      jupiter_r_0 += -1 * 0.00187647391 * 522.57741809380 * sin(2.07590380082 + 522.57741809380*t)
      jupiter_r_0 += -1 * 0.00282029465 * 632.78373931320 * sin(2.57419879933 + 632.78373931320*t)
      jupiter_r_0 += -1 * 0.00610599902 * 1059.38193018920 * sin(3.84115365602 + 1059.38193018920*t)
   ...
   static func jupiter_b(t:Double)->Double{
      ...
      jupiter_b_1 += pow(t,0) * 1 * 0.00177351787 * cos(5.70166488486 + 529.69096509460*t) - pow(t,1) * 0.00177351787 * 529.69096509460 * sin(5.70166488486 + 529.69096509460*t)

      var jupiter_b_0: Double = 0.0

      jupiter_b_0 += -1 * 0.00110090358 * 0.00000000000 * sin(0.00000000000 + 0.00000000000*t)
      jupiter_b_0 += -1 * 0.00109971634 * 1059.38193018920 * sin(3.90809347389 + 1059.38193018920*t)
   ...
   static func jupiter_l(t:Double)->Double{
      ...
      jupiter_l_1 += pow(t,0) * 1 * 0.00228918538 * cos(6.02647464016 + 7.11354700080*t) - pow(t,1) * 0.00228918538 * 7.11354700080 * sin(6.02647464016 + 7.11354700080*t)
      jupiter_l_1 += pow(t,0) * 1 * 0.00489741194 * cos(4.22066689928 + 529.69096509460*t) - pow(t,1) * 0.00489741194 * 529.69096509460 * sin(4.22066689928 + 529.69096509460*t)
      ...
      jupiter_l_0 += -1 * 0.00306389180 * 1059.38193018920 * sin(5.41734729976 + 1059.38193018920*t)
      jupiter_l_0 += -1 * 0.00573610145 * 7.11354700080 * sin(1.44406205976 + 7.11354700080*t)
   ...
   static func earth_r(t:Double)->Double{
      ...
      earth_r_1 += pow(t,0) * 1 * 0.00103018608 * cos(1.10748969588 + 6283.07584999140*t) - pow(t,1) * 0.00103018608 * 6283.07584999140 * sin(1.10748969588 + 6283.07584999140*t)
   ...
   static func earth_l(t:Double)->Double{
      ...
      earth_l_1 += pow(t,0) * 1 * 0.00206058863 * cos(2.67823455584 + 6283.07584999140*t) - pow(t,1) * 0.00206058863 * 6283.07584999140 * sin(2.67823455584 + 6283.07584999140*t)
