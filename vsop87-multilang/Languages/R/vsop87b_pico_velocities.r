...
vsop87b_pico_velocities_getMercury <- function(t){
...
vsop87b_pico_velocities_getVenus <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_velocities_getEarth <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_velocities_getMars <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_velocities_getJupiter <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_velocities_getSaturn <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_velocities_getUranus <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_velocities_getNeptune <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_venus_r_velocity <- function(t){
    venus_r_0 = 0.0;
...
vsop87b_pico_venus_b_velocity <- function(t){
    venus_b_0 = 0.0;
...
vsop87b_pico_venus_l_velocity <- function(t){
    venus_l_1 = 0.0;

    venus_l_1 = venus_l_1 + t^0 * 1 *  10213.28554621638 * cos( 0.00000000000 +        0.00000000000*t) - t^1 *  10213.28554621638 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t);
...
vsop87b_pico_uranus_r_velocity <- function(t){
    uranus_r_1 = 0.0;

    uranus_r_1 = uranus_r_1 + t^0 * 1 *      0.01479896629 * cos( 3.67205697578 +       74.78159856730*t) - t^1 *      0.01479896629 *       74.78159856730 * sin( 3.67205697578 +       74.78159856730*t);
...
vsop87b_pico_uranus_b_velocity <- function(t){
    uranus_b_0 = 0.0;
...
vsop87b_pico_uranus_l_velocity <- function(t){
    uranus_l_1 = 0.0;

    uranus_l_1 = uranus_l_1 + t^0 * 1 *     74.78159860910 * cos( 0.00000000000 +        0.00000000000*t) - t^1 *     74.78159860910 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t);
...
vsop87b_pico_saturn_r_velocity <- function(t){
    saturn_r_1 = 0.0;

    saturn_r_1 = saturn_r_1 + t^0 * 1 *      0.06182981340 * cos( 0.25843511480 +      213.29909543800*t) - t^1 *      0.06182981340 *      213.29909543800 * sin( 0.25843511480 +      213.29909543800*t);
...
vsop87b_pico_saturn_b_velocity <- function(t){
    saturn_b_0 = 0.0;
...
vsop87b_pico_saturn_l_velocity <- function(t){
    saturn_l_1 = 0.0;

    saturn_l_1 = saturn_l_1 + t^0 * 1 *      0.01297370862 * cos( 1.82834923978 +      213.29909543800*t) - t^1 *      0.01297370862 *      213.29909543800 * sin( 1.82834923978 +      213.29909543800*t);
    saturn_l_1 = saturn_l_1 + t^0 * 1 *    213.29909521690 * cos( 0.00000000000 +        0.00000000000*t) - t^1 *    213.29909521690 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t);
...
vsop87b_pico_neptune_r_velocity <- function(t){
    neptune_r_0 = 0.0;
...
vsop87b_pico_neptune_b_velocity <- function(t){
    neptune_b_0 = 0.0;
...
vsop87b_pico_neptune_l_velocity <- function(t){
    neptune_l_1 = 0.0;

    neptune_l_1 = neptune_l_1 + t^0 * 1 *     38.13303563957 * cos( 0.00000000000 +        0.00000000000*t) - t^1 *     38.13303563957 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t);
...
vsop87b_pico_mercury_r_velocity <- function(t){
    mercury_r_0 = 0.0;
...
vsop87b_pico_mercury_b_velocity <- function(t){
    mercury_b_0 = 0.0;
...
vsop87b_pico_mercury_l_velocity <- function(t){
    mercury_l_1 = 0.0;

    mercury_l_1 = mercury_l_1 + t^0 * 1 *      0.01131199811 * cos( 6.21874197797 +    26087.90314157420*t) - t^1 *      0.01131199811 *    26087.90314157420 * sin( 6.21874197797 +    26087.90314157420*t);
    mercury_l_1 = mercury_l_1 + t^0 * 1 *  26087.90313685529 * cos( 0.00000000000 +        0.00000000000*t) - t^1 *  26087.90313685529 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t);
...
vsop87b_pico_mars_r_velocity <- function(t){
    mars_r_1 = 0.0;

    mars_r_1 = mars_r_1 + t^0 * 1 *      0.01107433345 * cos( 2.03250524857 +     3340.61242669980*t) - t^1 *      0.01107433345 *     3340.61242669980 * sin( 2.03250524857 +     3340.61242669980*t);
...
vsop87b_pico_mars_b_velocity <- function(t){
    mars_b_0 = 0.0;
...
vsop87b_pico_mars_l_velocity <- function(t){
    mars_l_1 = 0.0;

    mars_l_1 = mars_l_1 + t^0 * 1 *      0.01457554523 * cos( 3.60433733236 +     3340.61242669980*t) - t^1 *      0.01457554523 *     3340.61242669980 * sin( 3.60433733236 +     3340.61242669980*t);
    mars_l_1 = mars_l_1 + t^0 * 1 *   3340.61242700512 * cos( 0.00000000000 +        0.00000000000*t) - t^1 *   3340.61242700512 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t);
...
vsop87b_pico_jupiter_r_velocity <- function(t){
    jupiter_r_1 = 0.0;

    jupiter_r_1 = jupiter_r_1 + t^0 * 1 *      0.01271801520 * cos( 2.64937512894 +      529.69096509460*t) - t^1 *      0.01271801520 *      529.69096509460 * sin( 2.64937512894 +      529.69096509460*t);
...
vsop87b_pico_jupiter_b_velocity <- function(t){
    jupiter_b_0 = 0.0;
...
vsop87b_pico_jupiter_l_velocity <- function(t){
    jupiter_l_1 = 0.0;

    jupiter_l_1 = jupiter_l_1 + t^0 * 1 *    529.69096508814 * cos( 0.00000000000 +        0.00000000000*t) - t^1 *    529.69096508814 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t);
...
vsop87b_pico_earth_r_velocity <- function(t){
    earth_r_0 = 0.0;
...
vsop87b_pico_earth_b_velocity <- function(t){
    return(0);
}

vsop87b_pico_earth_l_velocity <- function(t){
    earth_l_1 = 0.0;

    earth_l_1 = earth_l_1 + t^0 * 1 *   6283.07584999140 * cos( 0.00000000000 +        0.00000000000*t) - t^1 *   6283.07584999140 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t);
