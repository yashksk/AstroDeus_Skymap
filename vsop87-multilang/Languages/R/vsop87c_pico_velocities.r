...
vsop87c_pico_velocities_getMercury <- function(t){
...
vsop87c_pico_velocities_getVenus <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_velocities_getEarth <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_velocities_getMars <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_velocities_getJupiter <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_velocities_getSaturn <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_velocities_getUranus <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_velocities_getNeptune <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_venus_z_velocity <- function(t){
    venus_z_0 = 0.0;
...
vsop87c_pico_venus_y_velocity <- function(t){
    venus_y_0 = 0.0;
...
vsop87c_pico_venus_x_velocity <- function(t){
    venus_x_0 = 0.0;
...
vsop87c_pico_uranus_z_velocity <- function(t){
    uranus_z_1 = 0.0;
...
vsop87c_pico_uranus_y_velocity <- function(t){
    uranus_y_2 = 0.0;
...
vsop87c_pico_uranus_x_velocity <- function(t){
    uranus_x_2 = 0.0;
...
vsop87c_pico_saturn_z_velocity <- function(t){
    saturn_z_1 = 0.0;
...
vsop87c_pico_saturn_y_velocity <- function(t){
    saturn_y_1 = 0.0;
...
vsop87c_pico_saturn_x_velocity <- function(t){
    saturn_x_1 = 0.0;
...
vsop87c_pico_neptune_z_velocity <- function(t){
    neptune_z_1 = 0.0;
...
vsop87c_pico_neptune_y_velocity <- function(t){
    neptune_y_2 = 0.0;
...
vsop87c_pico_neptune_x_velocity <- function(t){
    neptune_x_2 = 0.0;
...
vsop87c_pico_mercury_z_velocity <- function(t){
    mercury_z_0 = 0.0;
...
vsop87c_pico_mercury_y_velocity <- function(t){
    mercury_y_0 = 0.0;
...
vsop87c_pico_mercury_x_velocity <- function(t){
    mercury_x_0 = 0.0;
...
vsop87c_pico_mars_z_velocity <- function(t){
    mars_z_0 = 0.0;
...
vsop87c_pico_mars_y_velocity <- function(t){
    mars_y_1 = 0.0;
...
vsop87c_pico_mars_x_velocity <- function(t){
    mars_x_1 = 0.0;
...
vsop87c_pico_jupiter_z_velocity <- function(t){
    jupiter_z_0 = 0.0;
...
vsop87c_pico_jupiter_y_velocity <- function(t){
    jupiter_y_1 = 0.0;
...
vsop87c_pico_jupiter_x_velocity <- function(t){
    jupiter_x_1 = 0.0;
...
vsop87c_pico_earth_z_velocity <- function(t){
    return(0);
}

vsop87c_pico_earth_y_velocity <- function(t){
    earth_y_0 = 0.0;
...
vsop87c_pico_earth_x_velocity <- function(t){
    earth_x_0 = 0.0;
