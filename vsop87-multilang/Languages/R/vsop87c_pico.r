...
vsop87c_pico_getMercury <- function(t){
...
vsop87c_pico_getVenus <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_getEarth <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_getMars <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_getJupiter <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_getSaturn <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_getUranus <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_getNeptune <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87c_pico_venus_z <- function(t){
    venus_z_0 = 0.0;
...
vsop87c_pico_venus_y <- function(t){
    venus_y_0 = 0.0;
...
vsop87c_pico_venus_x <- function(t){
    venus_x_0 = 0.0;
...
vsop87c_pico_uranus_z <- function(t){
    uranus_z_1 = 0.0;
...
vsop87c_pico_uranus_y <- function(t){
    uranus_y_2 = 0.0;
...
vsop87c_pico_uranus_x <- function(t){
    uranus_x_2 = 0.0;
...
vsop87c_pico_saturn_z <- function(t){
    saturn_z_1 = 0.0;
...
vsop87c_pico_saturn_y <- function(t){
    saturn_y_1 = 0.0;
...
vsop87c_pico_saturn_x <- function(t){
    saturn_x_1 = 0.0;
...
vsop87c_pico_neptune_z <- function(t){
    neptune_z_1 = 0.0;
...
vsop87c_pico_neptune_y <- function(t){
    neptune_y_2 = 0.0;
...
vsop87c_pico_neptune_x <- function(t){
    neptune_x_2 = 0.0;
...
vsop87c_pico_mercury_z <- function(t){
    mercury_z_0 = 0.0;
...
vsop87c_pico_mercury_y <- function(t){
    mercury_y_0 = 0.0;
...
vsop87c_pico_mercury_x <- function(t){
    mercury_x_0 = 0.0;
...
vsop87c_pico_mars_z <- function(t){
    mars_z_0 = 0.0;
...
vsop87c_pico_mars_y <- function(t){
    mars_y_1 = 0.0;
...
vsop87c_pico_mars_x <- function(t){
    mars_x_1 = 0.0;
...
vsop87c_pico_jupiter_z <- function(t){
    jupiter_z_0 = 0.0;
...
vsop87c_pico_jupiter_y <- function(t){
    jupiter_y_1 = 0.0;
...
vsop87c_pico_jupiter_x <- function(t){
    jupiter_x_1 = 0.0;
...
vsop87c_pico_earth_z <- function(t){
    return(0);
}

vsop87c_pico_earth_y <- function(t){
    earth_y_0 = 0.0;
...
vsop87c_pico_earth_x <- function(t){
    earth_x_0 = 0.0;
