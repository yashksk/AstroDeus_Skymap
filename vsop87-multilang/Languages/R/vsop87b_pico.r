...
vsop87b_pico_getMercury <- function(t){
...
vsop87b_pico_getVenus <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_getEarth <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_getMars <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_getJupiter <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_getSaturn <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_getUranus <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_getNeptune <- function(t){
    temp=array(c(0.0, 0.0, 0.0));
...
vsop87b_pico_venus_r <- function(t){
    venus_r_0 = 0.0;
...
vsop87b_pico_venus_b <- function(t){
    venus_b_0 = 0.0;
...
vsop87b_pico_venus_l <- function(t){
    venus_l_1 = 0.0;
...
vsop87b_pico_uranus_r <- function(t){
    uranus_r_1 = 0.0;
...
vsop87b_pico_uranus_b <- function(t){
    uranus_b_0 = 0.0;
...
vsop87b_pico_uranus_l <- function(t){
    uranus_l_1 = 0.0;
...
vsop87b_pico_saturn_r <- function(t){
    saturn_r_1 = 0.0;
...
vsop87b_pico_saturn_b <- function(t){
    saturn_b_0 = 0.0;
...
vsop87b_pico_saturn_l <- function(t){
    saturn_l_1 = 0.0;
...
vsop87b_pico_neptune_r <- function(t){
    neptune_r_0 = 0.0;
...
vsop87b_pico_neptune_b <- function(t){
    neptune_b_0 = 0.0;
...
vsop87b_pico_neptune_l <- function(t){
    neptune_l_1 = 0.0;
...
vsop87b_pico_mercury_r <- function(t){
    mercury_r_0 = 0.0;
...
vsop87b_pico_mercury_b <- function(t){
    mercury_b_0 = 0.0;
...
vsop87b_pico_mercury_l <- function(t){
    mercury_l_1 = 0.0;
...
vsop87b_pico_mars_r <- function(t){
    mars_r_1 = 0.0;
...
vsop87b_pico_mars_b <- function(t){
    mars_b_0 = 0.0;
...
vsop87b_pico_mars_l <- function(t){
    mars_l_1 = 0.0;
...
vsop87b_pico_jupiter_r <- function(t){
    jupiter_r_1 = 0.0;
...
vsop87b_pico_jupiter_b <- function(t){
    jupiter_b_0 = 0.0;
...
vsop87b_pico_jupiter_l <- function(t){
    jupiter_l_1 = 0.0;
...
vsop87b_pico_earth_r <- function(t){
    earth_r_0 = 0.0;
...
vsop87b_pico_earth_b <- function(t){
    return(0);
}

vsop87b_pico_earth_l <- function(t){
    earth_l_1 = 0.0;
