...
classdef vsop87b_milli
   methods(Static)
   function retval=getEarth(t)
      temp=[0 0 0];
      temp(0+1)=vsop87b_milli.earth_l(t);
      temp(1+1)=vsop87b_milli.earth_b(t);
      temp(2+1)=vsop87b_milli.earth_r(t);
      retval= temp;
   end

   function retval=getJupiter(t)
      temp=[0 0 0];
      temp(0+1)=vsop87b_milli.jupiter_l(t);
      temp(1+1)=vsop87b_milli.jupiter_b(t);
      temp(2+1)=vsop87b_milli.jupiter_r(t);
      retval= temp;
   end

   function retval=getMars(t)
      temp=[0 0 0];
      temp(0+1)=vsop87b_milli.mars_l(t);
      temp(1+1)=vsop87b_milli.mars_b(t);
      temp(2+1)=vsop87b_milli.mars_r(t);
      retval= temp;
   end

   function retval=getMercury(t)
      temp=[0 0 0];
      temp(0+1)=vsop87b_milli.mercury_l(t);
      temp(1+1)=vsop87b_milli.mercury_b(t);
      temp(2+1)=vsop87b_milli.mercury_r(t);
      retval= temp;
   end

   function retval=getNeptune(t)
      temp=[0 0 0];
      temp(0+1)=vsop87b_milli.neptune_l(t);
      temp(1+1)=vsop87b_milli.neptune_b(t);
      temp(2+1)=vsop87b_milli.neptune_r(t);
      retval= temp;
   end

   function retval=getSaturn(t)
      temp=[0 0 0];
      temp(0+1)=vsop87b_milli.saturn_l(t);
      temp(1+1)=vsop87b_milli.saturn_b(t);
      temp(2+1)=vsop87b_milli.saturn_r(t);
      retval= temp;
   end

   function retval=getUranus(t)
      temp=[0 0 0];
      temp(0+1)=vsop87b_milli.uranus_l(t);
      temp(1+1)=vsop87b_milli.uranus_b(t);
      temp(2+1)=vsop87b_milli.uranus_r(t);
      retval= temp;
   end

   function retval=getVenus(t)
      temp=[0 0 0];
      temp(0+1)=vsop87b_milli.venus_l(t);
      temp(1+1)=vsop87b_milli.venus_b(t);
      temp(2+1)=vsop87b_milli.venus_r(t);
      retval= temp;
   end
