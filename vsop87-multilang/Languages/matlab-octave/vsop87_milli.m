...
classdef vsop87_milli
   methods(Static)
   function retval=getEmb(t)
      temp=[0 0 0 0 0 0];
      temp(0+1)=vsop87_milli.emb_a(t);
      temp(1+1)=vsop87_milli.emb_l(t);
      temp(2+1)=vsop87_milli.emb_k(t);
      temp(3+1)=vsop87_milli.emb_h(t);
      temp(4+1)=vsop87_milli.emb_q(t);
      temp(5+1)=vsop87_milli.emb_p(t);
      retval= temp;
   end

   function retval=getJupiter(t)
      temp=[0 0 0 0 0 0];
      temp(0+1)=vsop87_milli.jupiter_a(t);
      temp(1+1)=vsop87_milli.jupiter_l(t);
      temp(2+1)=vsop87_milli.jupiter_k(t);
      temp(3+1)=vsop87_milli.jupiter_h(t);
      temp(4+1)=vsop87_milli.jupiter_q(t);
      temp(5+1)=vsop87_milli.jupiter_p(t);
      retval= temp;
   end

   function retval=getMars(t)
      temp=[0 0 0 0 0 0];
      temp(0+1)=vsop87_milli.mars_a(t);
      temp(1+1)=vsop87_milli.mars_l(t);
      temp(2+1)=vsop87_milli.mars_k(t);
      temp(3+1)=vsop87_milli.mars_h(t);
      temp(4+1)=vsop87_milli.mars_q(t);
      temp(5+1)=vsop87_milli.mars_p(t);
      retval= temp;
   end

   function retval=getMercury(t)
      temp=[0 0 0 0 0 0];
      temp(0+1)=vsop87_milli.mercury_a(t);
      temp(1+1)=vsop87_milli.mercury_l(t);
      temp(2+1)=vsop87_milli.mercury_k(t);
      temp(3+1)=vsop87_milli.mercury_h(t);
      temp(4+1)=vsop87_milli.mercury_q(t);
      temp(5+1)=vsop87_milli.mercury_p(t);
      retval= temp;
   end

   function retval=getNeptune(t)
      temp=[0 0 0 0 0 0];
      temp(0+1)=vsop87_milli.neptune_a(t);
      temp(1+1)=vsop87_milli.neptune_l(t);
      temp(2+1)=vsop87_milli.neptune_k(t);
      temp(3+1)=vsop87_milli.neptune_h(t);
      temp(4+1)=vsop87_milli.neptune_q(t);
      temp(5+1)=vsop87_milli.neptune_p(t);
      retval= temp;
   end

   function retval=getSaturn(t)
      temp=[0 0 0 0 0 0];
      temp(0+1)=vsop87_milli.saturn_a(t);
      temp(1+1)=vsop87_milli.saturn_l(t);
      temp(2+1)=vsop87_milli.saturn_k(t);
      temp(3+1)=vsop87_milli.saturn_h(t);
      temp(4+1)=vsop87_milli.saturn_q(t);
      temp(5+1)=vsop87_milli.saturn_p(t);
      retval= temp;
   end

   function retval=getUranus(t)
      temp=[0 0 0 0 0 0];
      temp(0+1)=vsop87_milli.uranus_a(t);
      temp(1+1)=vsop87_milli.uranus_l(t);
      temp(2+1)=vsop87_milli.uranus_k(t);
      temp(3+1)=vsop87_milli.uranus_h(t);
      temp(4+1)=vsop87_milli.uranus_q(t);
      temp(5+1)=vsop87_milli.uranus_p(t);
      retval= temp;
   end

   function retval=getVenus(t)
      temp=[0 0 0 0 0 0];
      temp(0+1)=vsop87_milli.venus_a(t);
      temp(1+1)=vsop87_milli.venus_l(t);
      temp(2+1)=vsop87_milli.venus_k(t);
      temp(3+1)=vsop87_milli.venus_h(t);
      temp(4+1)=vsop87_milli.venus_q(t);
      temp(5+1)=vsop87_milli.venus_p(t);
      retval= temp;
   end
   ...
   function retval=emb_k(t)
      ...
      retval= emb_k_0+emb_k_1+emb_k_2;
   end
   ...
   function retval=jupiter_a(t)
      ...
      retval= jupiter_a_0+jupiter_a_1+jupiter_a_2;
   end
   ...
   function retval=jupiter_h(t)
      ...
      retval= jupiter_h_0+jupiter_h_1+jupiter_h_2;
   end
   ...
   function retval=mars_q(t)
      ...
      retval= mars_q_0+mars_q_1+mars_q_2;
   end
   ...
   function retval=neptune_a(t)
      ...
      retval= neptune_a_0+neptune_a_1+neptune_a_2;
   end
   ...
   function retval=saturn_a(t)
      ...
      retval= saturn_a_0+saturn_a_1+saturn_a_2+saturn_a_3;
   end
   ...
   function retval=saturn_q(t)
      ...
      retval= saturn_q_0+saturn_q_1+saturn_q_2;
   end
   ...
   function retval=saturn_p(t)
      ...
      retval= saturn_p_0+saturn_p_1+saturn_p_2;
   end
   ...
   function retval=uranus_a(t)
      ...
      retval= uranus_a_0+uranus_a_1+uranus_a_2;
   end
   ...
   function retval=venus_q(t)
      ...
      retval= venus_q_0+venus_q_1+venus_q_2;
   end
