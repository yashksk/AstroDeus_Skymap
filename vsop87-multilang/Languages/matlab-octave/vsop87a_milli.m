...
classdef vsop87a_milli
   methods(Static)
   function retval=getEarth(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.earth_x(t);
      temp(1+1)=vsop87a_milli.earth_y(t);
      temp(2+1)=vsop87a_milli.earth_z(t);
      retval= temp;
   end

   function retval=getEmb(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.emb_x(t);
      temp(1+1)=vsop87a_milli.emb_y(t);
      temp(2+1)=vsop87a_milli.emb_z(t);
      retval= temp;
   end

   function retval=getJupiter(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.jupiter_x(t);
      temp(1+1)=vsop87a_milli.jupiter_y(t);
      temp(2+1)=vsop87a_milli.jupiter_z(t);
      retval= temp;
   end

   function retval=getMars(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.mars_x(t);
      temp(1+1)=vsop87a_milli.mars_y(t);
      temp(2+1)=vsop87a_milli.mars_z(t);
      retval= temp;
   end

   function retval=getMercury(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.mercury_x(t);
      temp(1+1)=vsop87a_milli.mercury_y(t);
      temp(2+1)=vsop87a_milli.mercury_z(t);
      retval= temp;
   end

   function retval=getNeptune(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.neptune_x(t);
      temp(1+1)=vsop87a_milli.neptune_y(t);
      temp(2+1)=vsop87a_milli.neptune_z(t);
      retval= temp;
   end

   function retval=getSaturn(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.saturn_x(t);
      temp(1+1)=vsop87a_milli.saturn_y(t);
      temp(2+1)=vsop87a_milli.saturn_z(t);
      retval= temp;
   end

   function retval=getUranus(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.uranus_x(t);
      temp(1+1)=vsop87a_milli.uranus_y(t);
      temp(2+1)=vsop87a_milli.uranus_z(t);
      retval= temp;
   end

   function retval=getVenus(t)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.venus_x(t);
      temp(1+1)=vsop87a_milli.venus_y(t);
      temp(2+1)=vsop87a_milli.venus_z(t);
      retval= temp;
   end

   function retval=getMoon(earth, emb)
      temp=[0 0 0];
      temp(0+1)=vsop87a_milli.(emb(0+1)-earth(0+1))*(1 + 1 / 0.01230073677);
      temp(1+1)=vsop87a_milli.(emb(1+1)-earth(1+1))*(1 + 1 / 0.01230073677);
      temp(2+1)=vsop87a_milli.(emb(2+1)-earth(2+1))*(1 + 1 / 0.01230073677);
      temp(0+1)=vsop87a_milli.temp(0+1)+earth(0+1);
      temp(1+1)=vsop87a_milli.temp(1+1)+earth(1+1);
      temp(2+1)=vsop87a_milli.temp(2+1)+earth(2+1);
      retval= temp;
   end
