...
classdef vsop87d_pico
   methods(Static)
   function retval=getEarth(t)
      temp=[0 0 0];
      temp(0+1)=vsop87d_pico.earth_l(t);
      temp(1+1)=vsop87d_pico.earth_b(t);
      temp(2+1)=vsop87d_pico.earth_r(t);
      retval= temp;
   end

   function retval=getJupiter(t)
      temp=[0 0 0];
      temp(0+1)=vsop87d_pico.jupiter_l(t);
      temp(1+1)=vsop87d_pico.jupiter_b(t);
      temp(2+1)=vsop87d_pico.jupiter_r(t);
      retval= temp;
   end

   function retval=getMars(t)
      temp=[0 0 0];
      temp(0+1)=vsop87d_pico.mars_l(t);
      temp(1+1)=vsop87d_pico.mars_b(t);
      temp(2+1)=vsop87d_pico.mars_r(t);
      retval= temp;
   end

   function retval=getMercury(t)
      temp=[0 0 0];
      temp(0+1)=vsop87d_pico.mercury_l(t);
      temp(1+1)=vsop87d_pico.mercury_b(t);
      temp(2+1)=vsop87d_pico.mercury_r(t);
      retval= temp;
   end

   function retval=getNeptune(t)
      temp=[0 0 0];
      temp(0+1)=vsop87d_pico.neptune_l(t);
      temp(1+1)=vsop87d_pico.neptune_b(t);
      temp(2+1)=vsop87d_pico.neptune_r(t);
      retval= temp;
   end

   function retval=getSaturn(t)
      temp=[0 0 0];
      temp(0+1)=vsop87d_pico.saturn_l(t);
      temp(1+1)=vsop87d_pico.saturn_b(t);
      temp(2+1)=vsop87d_pico.saturn_r(t);
      retval= temp;
   end

   function retval=getUranus(t)
      temp=[0 0 0];
      temp(0+1)=vsop87d_pico.uranus_l(t);
      temp(1+1)=vsop87d_pico.uranus_b(t);
      temp(2+1)=vsop87d_pico.uranus_r(t);
      retval= temp;
   end

   function retval=getVenus(t)
      temp=[0 0 0];
      temp(0+1)=vsop87d_pico.venus_l(t);
      temp(1+1)=vsop87d_pico.venus_b(t);
      temp(2+1)=vsop87d_pico.venus_r(t);
      retval= temp;
   end
