...
classdef vsop87c_micro
   methods(Static)
   function retval=getEarth(t)
      temp=[0 0 0];
      temp(0+1)=vsop87c_micro.earth_x(t);
      temp(1+1)=vsop87c_micro.earth_y(t);
      temp(2+1)=vsop87c_micro.earth_z(t);
      retval= temp;
   end

   function retval=getJupiter(t)
      temp=[0 0 0];
      temp(0+1)=vsop87c_micro.jupiter_x(t);
      temp(1+1)=vsop87c_micro.jupiter_y(t);
      temp(2+1)=vsop87c_micro.jupiter_z(t);
      retval= temp;
   end

   function retval=getMars(t)
      temp=[0 0 0];
      temp(0+1)=vsop87c_micro.mars_x(t);
      temp(1+1)=vsop87c_micro.mars_y(t);
      temp(2+1)=vsop87c_micro.mars_z(t);
      retval= temp;
   end

   function retval=getMercury(t)
      temp=[0 0 0];
      temp(0+1)=vsop87c_micro.mercury_x(t);
      temp(1+1)=vsop87c_micro.mercury_y(t);
      temp(2+1)=vsop87c_micro.mercury_z(t);
      retval= temp;
   end

   function retval=getNeptune(t)
      temp=[0 0 0];
      temp(0+1)=vsop87c_micro.neptune_x(t);
      temp(1+1)=vsop87c_micro.neptune_y(t);
      temp(2+1)=vsop87c_micro.neptune_z(t);
      retval= temp;
   end

   function retval=getSaturn(t)
      temp=[0 0 0];
      temp(0+1)=vsop87c_micro.saturn_x(t);
      temp(1+1)=vsop87c_micro.saturn_y(t);
      temp(2+1)=vsop87c_micro.saturn_z(t);
      retval= temp;
   end

   function retval=getUranus(t)
      temp=[0 0 0];
      temp(0+1)=vsop87c_micro.uranus_x(t);
      temp(1+1)=vsop87c_micro.uranus_y(t);
      temp(2+1)=vsop87c_micro.uranus_z(t);
      retval= temp;
   end

   function retval=getVenus(t)
      temp=[0 0 0];
      temp(0+1)=vsop87c_micro.venus_x(t);
      temp(1+1)=vsop87c_micro.venus_y(t);
      temp(2+1)=vsop87c_micro.venus_z(t);
      retval= temp;
   end
