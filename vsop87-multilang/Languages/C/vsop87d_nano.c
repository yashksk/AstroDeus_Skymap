...
#include <math.h>
double vsop87d_nano_earth_l(double t);
double vsop87d_nano_earth_b(double t);
double vsop87d_nano_earth_r(double t);
double vsop87d_nano_jupiter_l(double t);
double vsop87d_nano_jupiter_b(double t);
double vsop87d_nano_jupiter_r(double t);
double vsop87d_nano_mars_l(double t);
double vsop87d_nano_mars_b(double t);
double vsop87d_nano_mars_r(double t);
double vsop87d_nano_mercury_l(double t);
double vsop87d_nano_mercury_b(double t);
double vsop87d_nano_mercury_r(double t);
double vsop87d_nano_neptune_l(double t);
double vsop87d_nano_neptune_b(double t);
double vsop87d_nano_neptune_r(double t);
double vsop87d_nano_saturn_l(double t);
double vsop87d_nano_saturn_b(double t);
double vsop87d_nano_saturn_r(double t);
double vsop87d_nano_uranus_l(double t);
double vsop87d_nano_uranus_b(double t);
double vsop87d_nano_uranus_r(double t);
double vsop87d_nano_venus_l(double t);
double vsop87d_nano_venus_b(double t);
double vsop87d_nano_venus_r(double t);


void vsop87d_nano_getEarth(double t,double temp[]){
   temp[0]=vsop87d_nano_earth_l(t);
   temp[1]=vsop87d_nano_earth_b(t);
   temp[2]=vsop87d_nano_earth_r(t);
}

void vsop87d_nano_getJupiter(double t,double temp[]){
   temp[0]=vsop87d_nano_jupiter_l(t);
   temp[1]=vsop87d_nano_jupiter_b(t);
   temp[2]=vsop87d_nano_jupiter_r(t);
}

void vsop87d_nano_getMars(double t,double temp[]){
   temp[0]=vsop87d_nano_mars_l(t);
   temp[1]=vsop87d_nano_mars_b(t);
   temp[2]=vsop87d_nano_mars_r(t);
}

void vsop87d_nano_getMercury(double t,double temp[]){
   temp[0]=vsop87d_nano_mercury_l(t);
   temp[1]=vsop87d_nano_mercury_b(t);
   temp[2]=vsop87d_nano_mercury_r(t);
}

void vsop87d_nano_getNeptune(double t,double temp[]){
   temp[0]=vsop87d_nano_neptune_l(t);
   temp[1]=vsop87d_nano_neptune_b(t);
   temp[2]=vsop87d_nano_neptune_r(t);
}

void vsop87d_nano_getSaturn(double t,double temp[]){
   temp[0]=vsop87d_nano_saturn_l(t);
   temp[1]=vsop87d_nano_saturn_b(t);
   temp[2]=vsop87d_nano_saturn_r(t);
}

void vsop87d_nano_getUranus(double t,double temp[]){
   temp[0]=vsop87d_nano_uranus_l(t);
   temp[1]=vsop87d_nano_uranus_b(t);
   temp[2]=vsop87d_nano_uranus_r(t);
}

void vsop87d_nano_getVenus(double t,double temp[]){
