...
#include <math.h>
double vsop87a_nano_earth_x(double t);
double vsop87a_nano_earth_y(double t);
double vsop87a_nano_earth_z(double t);
double vsop87a_nano_emb_x(double t);
double vsop87a_nano_emb_y(double t);
double vsop87a_nano_emb_z(double t);
double vsop87a_nano_jupiter_x(double t);
double vsop87a_nano_jupiter_y(double t);
double vsop87a_nano_jupiter_z(double t);
double vsop87a_nano_mars_x(double t);
double vsop87a_nano_mars_y(double t);
double vsop87a_nano_mars_z(double t);
double vsop87a_nano_mercury_x(double t);
double vsop87a_nano_mercury_y(double t);
double vsop87a_nano_mercury_z(double t);
double vsop87a_nano_neptune_x(double t);
double vsop87a_nano_neptune_y(double t);
double vsop87a_nano_neptune_z(double t);
double vsop87a_nano_saturn_x(double t);
double vsop87a_nano_saturn_y(double t);
double vsop87a_nano_saturn_z(double t);
double vsop87a_nano_uranus_x(double t);
double vsop87a_nano_uranus_y(double t);
double vsop87a_nano_uranus_z(double t);
double vsop87a_nano_venus_x(double t);
double vsop87a_nano_venus_y(double t);
double vsop87a_nano_venus_z(double t);
