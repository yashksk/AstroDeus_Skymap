...
#include <math.h>
double vsop87c_pico_velocities_earth_x(double t);
double vsop87c_pico_velocities_earth_y(double t);
double vsop87c_pico_velocities_earth_z(double t);
double vsop87c_pico_velocities_jupiter_x(double t);
double vsop87c_pico_velocities_jupiter_y(double t);
double vsop87c_pico_velocities_jupiter_z(double t);
double vsop87c_pico_velocities_mars_x(double t);
double vsop87c_pico_velocities_mars_y(double t);
double vsop87c_pico_velocities_mars_z(double t);
double vsop87c_pico_velocities_mercury_x(double t);
double vsop87c_pico_velocities_mercury_y(double t);
double vsop87c_pico_velocities_mercury_z(double t);
double vsop87c_pico_velocities_neptune_x(double t);
double vsop87c_pico_velocities_neptune_y(double t);
double vsop87c_pico_velocities_neptune_z(double t);
double vsop87c_pico_velocities_saturn_x(double t);
double vsop87c_pico_velocities_saturn_y(double t);
double vsop87c_pico_velocities_saturn_z(double t);
double vsop87c_pico_velocities_uranus_x(double t);
double vsop87c_pico_velocities_uranus_y(double t);
double vsop87c_pico_velocities_uranus_z(double t);
double vsop87c_pico_velocities_venus_x(double t);
double vsop87c_pico_velocities_venus_y(double t);
double vsop87c_pico_velocities_venus_z(double t);
