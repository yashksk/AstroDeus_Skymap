...
#include <math.h>
double vsop87a_pico_earth_x(double t);
double vsop87a_pico_earth_y(double t);
double vsop87a_pico_earth_z(double t);
double vsop87a_pico_emb_x(double t);
double vsop87a_pico_emb_y(double t);
double vsop87a_pico_emb_z(double t);
double vsop87a_pico_jupiter_x(double t);
double vsop87a_pico_jupiter_y(double t);
double vsop87a_pico_jupiter_z(double t);
double vsop87a_pico_mars_x(double t);
double vsop87a_pico_mars_y(double t);
double vsop87a_pico_mars_z(double t);
double vsop87a_pico_mercury_x(double t);
double vsop87a_pico_mercury_y(double t);
double vsop87a_pico_mercury_z(double t);
double vsop87a_pico_neptune_x(double t);
double vsop87a_pico_neptune_y(double t);
double vsop87a_pico_neptune_z(double t);
double vsop87a_pico_saturn_x(double t);
double vsop87a_pico_saturn_y(double t);
double vsop87a_pico_saturn_z(double t);
double vsop87a_pico_uranus_x(double t);
double vsop87a_pico_uranus_y(double t);
double vsop87a_pico_uranus_z(double t);
double vsop87a_pico_venus_x(double t);
double vsop87a_pico_venus_y(double t);
double vsop87a_pico_venus_z(double t);
