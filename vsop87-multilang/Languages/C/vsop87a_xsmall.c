...
#include <math.h>
double vsop87a_xsmall_earth_x(double t);
double vsop87a_xsmall_earth_y(double t);
double vsop87a_xsmall_earth_z(double t);
double vsop87a_xsmall_emb_x(double t);
double vsop87a_xsmall_emb_y(double t);
double vsop87a_xsmall_emb_z(double t);
double vsop87a_xsmall_jupiter_x(double t);
double vsop87a_xsmall_jupiter_y(double t);
double vsop87a_xsmall_jupiter_z(double t);
double vsop87a_xsmall_mars_x(double t);
double vsop87a_xsmall_mars_y(double t);
double vsop87a_xsmall_mars_z(double t);
double vsop87a_xsmall_mercury_x(double t);
double vsop87a_xsmall_mercury_y(double t);
double vsop87a_xsmall_mercury_z(double t);
double vsop87a_xsmall_neptune_x(double t);
double vsop87a_xsmall_neptune_y(double t);
double vsop87a_xsmall_neptune_z(double t);
double vsop87a_xsmall_saturn_x(double t);
double vsop87a_xsmall_saturn_y(double t);
double vsop87a_xsmall_saturn_z(double t);
double vsop87a_xsmall_uranus_x(double t);
double vsop87a_xsmall_uranus_y(double t);
double vsop87a_xsmall_uranus_z(double t);
double vsop87a_xsmall_venus_x(double t);
double vsop87a_xsmall_venus_y(double t);
double vsop87a_xsmall_venus_z(double t);
