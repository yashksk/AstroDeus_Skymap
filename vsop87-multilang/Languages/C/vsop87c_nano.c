...
#include <math.h>
double vsop87c_nano_earth_x(double t);
double vsop87c_nano_earth_y(double t);
double vsop87c_nano_earth_z(double t);
double vsop87c_nano_jupiter_x(double t);
double vsop87c_nano_jupiter_y(double t);
double vsop87c_nano_jupiter_z(double t);
double vsop87c_nano_mars_x(double t);
double vsop87c_nano_mars_y(double t);
double vsop87c_nano_mars_z(double t);
double vsop87c_nano_mercury_x(double t);
double vsop87c_nano_mercury_y(double t);
double vsop87c_nano_mercury_z(double t);
double vsop87c_nano_neptune_x(double t);
double vsop87c_nano_neptune_y(double t);
double vsop87c_nano_neptune_z(double t);
double vsop87c_nano_saturn_x(double t);
double vsop87c_nano_saturn_y(double t);
double vsop87c_nano_saturn_z(double t);
double vsop87c_nano_uranus_x(double t);
double vsop87c_nano_uranus_y(double t);
double vsop87c_nano_uranus_z(double t);
double vsop87c_nano_venus_x(double t);
double vsop87c_nano_venus_y(double t);
double vsop87c_nano_venus_z(double t);


void vsop87c_nano_getEarth(double t,double temp[]){
   temp[0]=vsop87c_nano_earth_x(t);
   temp[1]=vsop87c_nano_earth_y(t);
   temp[2]=vsop87c_nano_earth_z(t);
}

void vsop87c_nano_getJupiter(double t,double temp[]){
   temp[0]=vsop87c_nano_jupiter_x(t);
   temp[1]=vsop87c_nano_jupiter_y(t);
   temp[2]=vsop87c_nano_jupiter_z(t);
}

void vsop87c_nano_getMars(double t,double temp[]){
   temp[0]=vsop87c_nano_mars_x(t);
   temp[1]=vsop87c_nano_mars_y(t);
   temp[2]=vsop87c_nano_mars_z(t);
}

void vsop87c_nano_getMercury(double t,double temp[]){
   temp[0]=vsop87c_nano_mercury_x(t);
   temp[1]=vsop87c_nano_mercury_y(t);
   temp[2]=vsop87c_nano_mercury_z(t);
}

void vsop87c_nano_getNeptune(double t,double temp[]){
   temp[0]=vsop87c_nano_neptune_x(t);
   temp[1]=vsop87c_nano_neptune_y(t);
   temp[2]=vsop87c_nano_neptune_z(t);
}

void vsop87c_nano_getSaturn(double t,double temp[]){
   temp[0]=vsop87c_nano_saturn_x(t);
   temp[1]=vsop87c_nano_saturn_y(t);
   temp[2]=vsop87c_nano_saturn_z(t);
}

void vsop87c_nano_getUranus(double t,double temp[]){
   temp[0]=vsop87c_nano_uranus_x(t);
   temp[1]=vsop87c_nano_uranus_y(t);
   temp[2]=vsop87c_nano_uranus_z(t);
}

void vsop87c_nano_getVenus(double t,double temp[]){
