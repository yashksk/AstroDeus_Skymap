...
function vsop87c_pico_getMercury(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87c_pico_mercury_x(t)
   temp(2)=vsop87c_pico_mercury_y(t)
   temp(3)=vsop87c_pico_mercury_z(t)
...
function vsop87c_pico_getVenus(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87c_pico_venus_x(t)
   temp(2)=vsop87c_pico_venus_y(t)
   temp(3)=vsop87c_pico_venus_z(t)
...
function vsop87c_pico_getEarth(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87c_pico_earth_x(t)
   temp(2)=vsop87c_pico_earth_y(t)
   temp(3)=vsop87c_pico_earth_z(t)
...
function vsop87c_pico_getMars(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87c_pico_mars_x(t)
   temp(2)=vsop87c_pico_mars_y(t)
   temp(3)=vsop87c_pico_mars_z(t)
...
function vsop87c_pico_getJupiter(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87c_pico_jupiter_x(t)
   temp(2)=vsop87c_pico_jupiter_y(t)
   temp(3)=vsop87c_pico_jupiter_z(t)
...
function vsop87c_pico_getSaturn(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87c_pico_saturn_x(t)
   temp(2)=vsop87c_pico_saturn_y(t)
   temp(3)=vsop87c_pico_saturn_z(t)
...
function vsop87c_pico_getUranus(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87c_pico_uranus_x(t)
   temp(2)=vsop87c_pico_uranus_y(t)
   temp(3)=vsop87c_pico_uranus_z(t)
...
function vsop87c_pico_getNeptune(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87c_pico_neptune_x(t)
   temp(2)=vsop87c_pico_neptune_y(t)
   temp(3)=vsop87c_pico_neptune_z(t)

   vsop87c_pico_getNeptune = temp
end function

function vsop87c_pico_venus_z(t as Double)
...
function vsop87c_pico_venus_y(t as Double)
...
function vsop87c_pico_venus_x(t as Double)
...
function vsop87c_pico_uranus_z(t as Double)
   ...
   vsop87c_pico_uranus_z = uranus_z_1+uranus_z_0
end function

function vsop87c_pico_uranus_y(t as Double)
   ...
   vsop87c_pico_uranus_y = uranus_y_2+uranus_y_1+uranus_y_0
end function

function vsop87c_pico_uranus_x(t as Double)
   ...
   vsop87c_pico_uranus_x = uranus_x_2+uranus_x_1+uranus_x_0
end function

function vsop87c_pico_saturn_z(t as Double)
   ...
   vsop87c_pico_saturn_z = saturn_z_1+saturn_z_0
end function

function vsop87c_pico_saturn_y(t as Double)
   ...
   vsop87c_pico_saturn_y = saturn_y_1+saturn_y_0
end function

function vsop87c_pico_saturn_x(t as Double)
   ...
   vsop87c_pico_saturn_x = saturn_x_1+saturn_x_0
end function

function vsop87c_pico_neptune_z(t as Double)
   ...
   vsop87c_pico_neptune_z = neptune_z_1+neptune_z_0
end function

function vsop87c_pico_neptune_y(t as Double)
   ...
   vsop87c_pico_neptune_y = neptune_y_2+neptune_y_0
end function

function vsop87c_pico_neptune_x(t as Double)
   ...
   vsop87c_pico_neptune_x = neptune_x_2+neptune_x_0
end function

function vsop87c_pico_mercury_z(t as Double)
...
function vsop87c_pico_mercury_y(t as Double)
...
function vsop87c_pico_mercury_x(t as Double)
...
function vsop87c_pico_mars_z(t as Double)
...
function vsop87c_pico_mars_y(t as Double)
   ...
   vsop87c_pico_mars_y = mars_y_1+mars_y_0
end function

function vsop87c_pico_mars_x(t as Double)
   ...
   vsop87c_pico_mars_x = mars_x_1+mars_x_0
end function

function vsop87c_pico_jupiter_z(t as Double)
...
function vsop87c_pico_jupiter_y(t as Double)
   ...
   vsop87c_pico_jupiter_y = jupiter_y_1+jupiter_y_0
end function

function vsop87c_pico_jupiter_x(t as Double)
   ...
   vsop87c_pico_jupiter_x = jupiter_x_1+jupiter_x_0
end function

function vsop87c_pico_earth_z(t as Double)

   vsop87c_pico_earth_z = 0
end function

function vsop87c_pico_earth_y(t as Double)
...
function vsop87c_pico_earth_x(t as Double)
