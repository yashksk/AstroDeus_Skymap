...
function vsop87b_micro_getMercury(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87b_micro_mercury_l(t)
   temp(2)=vsop87b_micro_mercury_b(t)
   temp(3)=vsop87b_micro_mercury_r(t)

   vsop87b_micro_getMercury = temp
end function

function vsop87b_micro_getVenus(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87b_micro_venus_l(t)
   temp(2)=vsop87b_micro_venus_b(t)
   temp(3)=vsop87b_micro_venus_r(t)

   vsop87b_micro_getVenus = temp
end function

function vsop87b_micro_getEarth(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87b_micro_earth_l(t)
   temp(2)=vsop87b_micro_earth_b(t)
   temp(3)=vsop87b_micro_earth_r(t)

   vsop87b_micro_getEarth = temp
end function

function vsop87b_micro_getMars(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87b_micro_mars_l(t)
   temp(2)=vsop87b_micro_mars_b(t)
   temp(3)=vsop87b_micro_mars_r(t)

   vsop87b_micro_getMars = temp
end function

function vsop87b_micro_getJupiter(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87b_micro_jupiter_l(t)
   temp(2)=vsop87b_micro_jupiter_b(t)
   temp(3)=vsop87b_micro_jupiter_r(t)

   vsop87b_micro_getJupiter = temp
end function

function vsop87b_micro_getSaturn(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87b_micro_saturn_l(t)
   temp(2)=vsop87b_micro_saturn_b(t)
   temp(3)=vsop87b_micro_saturn_r(t)

   vsop87b_micro_getSaturn = temp
end function

function vsop87b_micro_getUranus(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87b_micro_uranus_l(t)
   temp(2)=vsop87b_micro_uranus_b(t)
   temp(3)=vsop87b_micro_uranus_r(t)

   vsop87b_micro_getUranus = temp
end function

function vsop87b_micro_getNeptune(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87b_micro_neptune_l(t)
   temp(2)=vsop87b_micro_neptune_b(t)
   temp(3)=vsop87b_micro_neptune_r(t)

   vsop87b_micro_getNeptune = temp
end function

function vsop87b_micro_venus_r(t as Double)
   ...
   vsop87b_micro_venus_r = venus_r_1+venus_r_0
end function

function vsop87b_micro_venus_b(t as Double)
   ...
   vsop87b_micro_venus_b = venus_b_2+venus_b_1+venus_b_0
end function

function vsop87b_micro_venus_l(t as Double)
   ...
   vsop87b_micro_venus_l = venus_l_1+venus_l_0
end function

function vsop87b_micro_uranus_r(t as Double)
   ...
   vsop87b_micro_uranus_r = uranus_r_2+uranus_r_1+uranus_r_0
end function

function vsop87b_micro_uranus_b(t as Double)
   ...
   vsop87b_micro_uranus_b = uranus_b_1+uranus_b_0
end function

function vsop87b_micro_uranus_l(t as Double)
   ...
   vsop87b_micro_uranus_l = uranus_l_1+uranus_l_0
end function

function vsop87b_micro_saturn_r(t as Double)
   ...
   vsop87b_micro_saturn_r = saturn_r_3+saturn_r_2+saturn_r_1+saturn_r_0
end function

function vsop87b_micro_saturn_b(t as Double)
   ...
   vsop87b_micro_saturn_b = saturn_b_2+saturn_b_1+saturn_b_0
end function

function vsop87b_micro_saturn_l(t as Double)
   ...
   vsop87b_micro_saturn_l = saturn_l_3+saturn_l_2+saturn_l_1+saturn_l_0
end function

function vsop87b_micro_neptune_r(t as Double)
   ...
   vsop87b_micro_neptune_r = neptune_r_1+neptune_r_0
end function

function vsop87b_micro_neptune_b(t as Double)
   ...
   vsop87b_micro_neptune_b = neptune_b_0
end function

function vsop87b_micro_neptune_l(t as Double)
   ...
   vsop87b_micro_neptune_l = neptune_l_1+neptune_l_0
end function

function vsop87b_micro_mercury_r(t as Double)
   ...
   vsop87b_micro_mercury_r = mercury_r_1+mercury_r_0
end function

function vsop87b_micro_mercury_b(t as Double)
   ...
   vsop87b_micro_mercury_b = mercury_b_1+mercury_b_0
end function

function vsop87b_micro_mercury_l(t as Double)
   ...
   vsop87b_micro_mercury_l = mercury_l_2+mercury_l_1+mercury_l_0
end function

function vsop87b_micro_mars_r(t as Double)
   ...
   vsop87b_micro_mars_r = mars_r_2+mars_r_1+mars_r_0
end function

function vsop87b_micro_mars_b(t as Double)
   ...
   vsop87b_micro_mars_b = mars_b_1+mars_b_0
end function

function vsop87b_micro_mars_l(t as Double)
   ...
   vsop87b_micro_mars_l = mars_l_2+mars_l_1+mars_l_0
end function

function vsop87b_micro_jupiter_r(t as Double)
   ...
   vsop87b_micro_jupiter_r = jupiter_r_2+jupiter_r_1+jupiter_r_0
end function

function vsop87b_micro_jupiter_b(t as Double)
   ...
   vsop87b_micro_jupiter_b = jupiter_b_1+jupiter_b_0
end function

function vsop87b_micro_jupiter_l(t as Double)
   ...
   vsop87b_micro_jupiter_l = jupiter_l_2+jupiter_l_1+jupiter_l_0
end function

function vsop87b_micro_earth_r(t as Double)
   ...
   vsop87b_micro_earth_r = earth_r_1+earth_r_0
end function

function vsop87b_micro_earth_b(t as Double)
   ...
   vsop87b_micro_earth_b = earth_b_1
end function

function vsop87b_micro_earth_l(t as Double)
   ...
   vsop87b_micro_earth_l = earth_l_1+earth_l_0
end function
