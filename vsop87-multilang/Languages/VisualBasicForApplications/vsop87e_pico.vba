...
function vsop87e_pico_venus_z(t as Double)
...
function vsop87e_pico_venus_y(t as Double)
...
function vsop87e_pico_venus_x(t as Double)
...
function vsop87e_pico_uranus_z(t as Double)
...
function vsop87e_pico_uranus_y(t as Double)
   ...
   vsop87e_pico_uranus_y = uranus_y_1+uranus_y_0
end function

function vsop87e_pico_uranus_x(t as Double)
...
function vsop87e_pico_sun_z(t as Double)

   vsop87e_pico_sun_z = 0
end function

function vsop87e_pico_sun_y(t as Double)

   vsop87e_pico_sun_y = 0
end function

function vsop87e_pico_sun_x(t as Double)

   vsop87e_pico_sun_x = 0
end function

function vsop87e_pico_saturn_z(t as Double)
   ...
   vsop87e_pico_saturn_z = saturn_z_1+saturn_z_0
end function

function vsop87e_pico_saturn_y(t as Double)
   ...
   vsop87e_pico_saturn_y = saturn_y_1+saturn_y_0
end function

function vsop87e_pico_saturn_x(t as Double)
   ...
   vsop87e_pico_saturn_x = saturn_x_1+saturn_x_0
end function

function vsop87e_pico_neptune_z(t as Double)
...
function vsop87e_pico_neptune_y(t as Double)
...
function vsop87e_pico_neptune_x(t as Double)
...
function vsop87e_pico_mercury_z(t as Double)
...
function vsop87e_pico_mercury_y(t as Double)
...
function vsop87e_pico_mercury_x(t as Double)
...
function vsop87e_pico_mars_z(t as Double)
...
function vsop87e_pico_mars_y(t as Double)
   ...
   vsop87e_pico_mars_y = mars_y_1+mars_y_0
end function

function vsop87e_pico_mars_x(t as Double)
...
function vsop87e_pico_jupiter_z(t as Double)
...
function vsop87e_pico_jupiter_y(t as Double)
   ...
   vsop87e_pico_jupiter_y = jupiter_y_1+jupiter_y_0
end function

function vsop87e_pico_jupiter_x(t as Double)
...
function vsop87e_pico_earth_z(t as Double)

   vsop87e_pico_earth_z = 0
end function

function vsop87e_pico_earth_y(t as Double)
...
function vsop87e_pico_earth_x(t as Double)
