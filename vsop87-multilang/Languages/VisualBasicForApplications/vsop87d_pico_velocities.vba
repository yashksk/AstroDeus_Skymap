...
function vsop87d_pico_venus_r_velocity(t as Double)
   dim venus_r_0 as Double
   venus_r_0 = 0.0

   venus_r_0 = venus_r_0 -1 *      0.72334820905 *        0.00000000000 * sin( 0.00000000000 +        0.00000000000*t)

   vsop87d_pico_venus_r_velocity = venus_r_0
end function

function vsop87d_pico_venus_b_velocity(t as Double)
   dim venus_b_0 as Double
   venus_b_0 = 0.0

   venus_b_0 = venus_b_0 -1 *      0.05923638472 *    10213.28554621100 * sin( 0.26702775813 +    10213.28554621100*t)

   vsop87d_pico_venus_b_velocity = venus_b_0
end function

function vsop87d_pico_venus_l_velocity(t as Double)
   ...
   vsop87d_pico_venus_l_velocity = venus_l_1+venus_l_0
end function

function vsop87d_pico_uranus_r_velocity(t as Double)
   ...
   vsop87d_pico_uranus_r_velocity = uranus_r_1+uranus_r_0
end function

function vsop87d_pico_uranus_b_velocity(t as Double)
   dim uranus_b_0 as Double
   uranus_b_0 = 0.0

   uranus_b_0 = uranus_b_0 -1 *      0.01346277639 *       74.78159856730 * sin( 2.61877810545 +       74.78159856730*t)

   vsop87d_pico_uranus_b_velocity = uranus_b_0
end function

function vsop87d_pico_uranus_l_velocity(t as Double)
   ...
   vsop87d_pico_uranus_l_velocity = uranus_l_1+uranus_l_0
end function

function vsop87d_pico_saturn_r_velocity(t as Double)
   ...
   vsop87d_pico_saturn_r_velocity = saturn_r_1+saturn_r_0
end function

function vsop87d_pico_saturn_b_velocity(t as Double)
   dim saturn_b_0 as Double
   saturn_b_0 = 0.0

   saturn_b_0 = saturn_b_0 -1 *      0.04330678040 *      213.29909543800 * sin( 3.60284428399 +      213.29909543800*t)

   vsop87d_pico_saturn_b_velocity = saturn_b_0
end function

function vsop87d_pico_saturn_l_velocity(t as Double)
   ...
   vsop87d_pico_saturn_l_velocity = saturn_l_1+saturn_l_0
end function

function vsop87d_pico_neptune_r_velocity(t as Double)
   ...
   vsop87d_pico_neptune_r_velocity = neptune_r_0
end function

function vsop87d_pico_neptune_b_velocity(t as Double)
   dim neptune_b_0 as Double
   neptune_b_0 = 0.0

   neptune_b_0 = neptune_b_0 -1 *      0.03088622933 *       38.13303563780 * sin( 1.44104372626 +       38.13303563780*t)

   vsop87d_pico_neptune_b_velocity = neptune_b_0
end function

function vsop87d_pico_neptune_l_velocity(t as Double)
   ...
   vsop87d_pico_neptune_l_velocity = neptune_l_1+neptune_l_0
end function

function vsop87d_pico_mercury_r_velocity(t as Double)
   ...
   vsop87d_pico_mercury_r_velocity = mercury_r_0
end function

function vsop87d_pico_mercury_b_velocity(t as Double)
   ...
   vsop87d_pico_mercury_b_velocity = mercury_b_0
end function

function vsop87d_pico_mercury_l_velocity(t as Double)
   ...
   vsop87d_pico_mercury_l_velocity = mercury_l_1+mercury_l_0
end function

function vsop87d_pico_mars_r_velocity(t as Double)
   ...
   vsop87d_pico_mars_r_velocity = mars_r_1+mars_r_0
end function

function vsop87d_pico_mars_b_velocity(t as Double)
   dim mars_b_0 as Double
   mars_b_0 = 0.0

   mars_b_0 = mars_b_0 -1 *      0.03197134986 *     3340.61242669980 * sin( 3.76832042432 +     3340.61242669980*t)

   vsop87d_pico_mars_b_velocity = mars_b_0
end function

function vsop87d_pico_mars_l_velocity(t as Double)
   ...
   vsop87d_pico_mars_l_velocity = mars_l_1+mars_l_0
end function

function vsop87d_pico_jupiter_r_velocity(t as Double)
   ...
   vsop87d_pico_jupiter_r_velocity = jupiter_r_1+jupiter_r_0
end function

function vsop87d_pico_jupiter_b_velocity(t as Double)
   dim jupiter_b_0 as Double
   jupiter_b_0 = 0.0

   jupiter_b_0 = jupiter_b_0 -1 *      0.02268615703 *      529.69096509460 * sin( 3.55852606718 +      529.69096509460*t)

   vsop87d_pico_jupiter_b_velocity = jupiter_b_0
end function

function vsop87d_pico_jupiter_l_velocity(t as Double)
   ...
   vsop87d_pico_jupiter_l_velocity = jupiter_l_1+jupiter_l_0
end function

function vsop87d_pico_earth_r_velocity(t as Double)
   ...
   vsop87d_pico_earth_r_velocity = earth_r_0
end function

function vsop87d_pico_earth_b_velocity(t as Double)

   vsop87d_pico_earth_b_velocity = 0
end function

function vsop87d_pico_earth_l_velocity(t as Double)
   ...
   vsop87d_pico_earth_l_velocity = earth_l_1+earth_l_0
end function
