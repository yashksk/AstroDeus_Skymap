...
function vsop87_micro_getMercury(t as Double) as Variant
   dim temp(6)
   temp(1)=vsop87_micro_mercury_a(t)
   temp(2)=vsop87_micro_mercury_l(t)
   temp(3)=vsop87_micro_mercury_k(t)
   temp(4)=vsop87_micro_mercury_h(t)
   temp(5)=vsop87_micro_mercury_q(t)
   temp(6)=vsop87_micro_mercury_p(t)
...
function vsop87_micro_getVenus(t as Double) as Variant
   dim temp(6)
   temp(1)=vsop87_micro_venus_a(t)
   temp(2)=vsop87_micro_venus_l(t)
   temp(3)=vsop87_micro_venus_k(t)
   temp(4)=vsop87_micro_venus_h(t)
   temp(5)=vsop87_micro_venus_q(t)
   temp(6)=vsop87_micro_venus_p(t)
...
function vsop87_micro_getEmb(t as Double) as Variant
   dim temp(6)
   temp(1)=vsop87_micro_emb_a(t)
   temp(2)=vsop87_micro_emb_l(t)
   temp(3)=vsop87_micro_emb_k(t)
   temp(4)=vsop87_micro_emb_h(t)
   temp(5)=vsop87_micro_emb_q(t)
   temp(6)=vsop87_micro_emb_p(t)
...
function vsop87_micro_getMars(t as Double) as Variant
   dim temp(6)
   temp(1)=vsop87_micro_mars_a(t)
   temp(2)=vsop87_micro_mars_l(t)
   temp(3)=vsop87_micro_mars_k(t)
   temp(4)=vsop87_micro_mars_h(t)
   temp(5)=vsop87_micro_mars_q(t)
   temp(6)=vsop87_micro_mars_p(t)
...
function vsop87_micro_getJupiter(t as Double) as Variant
   dim temp(6)
   temp(1)=vsop87_micro_jupiter_a(t)
   temp(2)=vsop87_micro_jupiter_l(t)
   temp(3)=vsop87_micro_jupiter_k(t)
   temp(4)=vsop87_micro_jupiter_h(t)
   temp(5)=vsop87_micro_jupiter_q(t)
   temp(6)=vsop87_micro_jupiter_p(t)
...
function vsop87_micro_getSaturn(t as Double) as Variant
   dim temp(6)
   temp(1)=vsop87_micro_saturn_a(t)
   temp(2)=vsop87_micro_saturn_l(t)
   temp(3)=vsop87_micro_saturn_k(t)
   temp(4)=vsop87_micro_saturn_h(t)
   temp(5)=vsop87_micro_saturn_q(t)
   temp(6)=vsop87_micro_saturn_p(t)
...
function vsop87_micro_getUranus(t as Double) as Variant
   dim temp(6)
   temp(1)=vsop87_micro_uranus_a(t)
   temp(2)=vsop87_micro_uranus_l(t)
   temp(3)=vsop87_micro_uranus_k(t)
   temp(4)=vsop87_micro_uranus_h(t)
   temp(5)=vsop87_micro_uranus_q(t)
   temp(6)=vsop87_micro_uranus_p(t)
...
function vsop87_micro_getNeptune(t as Double) as Variant
   dim temp(6)
   temp(1)=vsop87_micro_neptune_a(t)
   temp(2)=vsop87_micro_neptune_l(t)
   temp(3)=vsop87_micro_neptune_k(t)
   temp(4)=vsop87_micro_neptune_h(t)
   temp(5)=vsop87_micro_neptune_q(t)
   temp(6)=vsop87_micro_neptune_p(t)

   vsop87_micro_getNeptune = temp
end function

function vsop87_micro_venus_p(t as Double)
   ...
   vsop87_micro_venus_p = venus_p_1+venus_p_0
end function

function vsop87_micro_venus_q(t as Double)
   ...
   vsop87_micro_venus_q = venus_q_1+venus_q_0
end function

function vsop87_micro_venus_h(t as Double)
   ...
   vsop87_micro_venus_h = venus_h_1+venus_h_0
end function

function vsop87_micro_venus_k(t as Double)
   ...
   vsop87_micro_venus_k = venus_k_1+venus_k_0
end function

function vsop87_micro_venus_l(t as Double)
   ...
   vsop87_micro_venus_l = venus_l_1+venus_l_0
end function

function vsop87_micro_venus_a(t as Double)
...
function vsop87_micro_uranus_p(t as Double)
   ...
   vsop87_micro_uranus_p = uranus_p_1+uranus_p_0
end function

function vsop87_micro_uranus_q(t as Double)
   ...
   vsop87_micro_uranus_q = uranus_q_1+uranus_q_0
end function

function vsop87_micro_uranus_h(t as Double)
   ...
   vsop87_micro_uranus_h = uranus_h_1+uranus_h_0
end function

function vsop87_micro_uranus_k(t as Double)
   ...
   vsop87_micro_uranus_k = uranus_k_1+uranus_k_0
end function

function vsop87_micro_uranus_l(t as Double)
   ...
   vsop87_micro_uranus_l = uranus_l_1+uranus_l_0
end function

function vsop87_micro_uranus_a(t as Double)
   ...
   vsop87_micro_uranus_a = uranus_a_1+uranus_a_0
end function

function vsop87_micro_saturn_p(t as Double)
   ...
   vsop87_micro_saturn_p = saturn_p_1+saturn_p_0
end function

function vsop87_micro_saturn_q(t as Double)
   ...
   vsop87_micro_saturn_q = saturn_q_1+saturn_q_0
end function

function vsop87_micro_saturn_h(t as Double)
   ...
   vsop87_micro_saturn_h = saturn_h_2+saturn_h_1+saturn_h_0
end function

function vsop87_micro_saturn_k(t as Double)
   ...
   vsop87_micro_saturn_k = saturn_k_2+saturn_k_1+saturn_k_0
end function

function vsop87_micro_saturn_l(t as Double)
   ...
   vsop87_micro_saturn_l = saturn_l_3+saturn_l_2+saturn_l_1+saturn_l_0
end function

function vsop87_micro_saturn_a(t as Double)
   ...
   vsop87_micro_saturn_a = saturn_a_2+saturn_a_1+saturn_a_0
end function

function vsop87_micro_neptune_p(t as Double)
...
function vsop87_micro_neptune_q(t as Double)
...
function vsop87_micro_neptune_h(t as Double)
...
function vsop87_micro_neptune_k(t as Double)
...
function vsop87_micro_neptune_l(t as Double)
   ...
   vsop87_micro_neptune_l = neptune_l_1+neptune_l_0
end function

function vsop87_micro_neptune_a(t as Double)
   ...
   vsop87_micro_neptune_a = neptune_a_1+neptune_a_0
end function

function vsop87_micro_mercury_p(t as Double)
   ...
   vsop87_micro_mercury_p = mercury_p_1+mercury_p_0
end function

function vsop87_micro_mercury_q(t as Double)
   ...
   vsop87_micro_mercury_q = mercury_q_1+mercury_q_0
end function

function vsop87_micro_mercury_h(t as Double)
   ...
   vsop87_micro_mercury_h = mercury_h_1+mercury_h_0
end function

function vsop87_micro_mercury_k(t as Double)
   ...
   vsop87_micro_mercury_k = mercury_k_1+mercury_k_0
end function

function vsop87_micro_mercury_l(t as Double)
   ...
   vsop87_micro_mercury_l = mercury_l_1+mercury_l_0
end function

function vsop87_micro_mercury_a(t as Double)
...
function vsop87_micro_mars_p(t as Double)
   ...
   vsop87_micro_mars_p = mars_p_1+mars_p_0
end function

function vsop87_micro_mars_q(t as Double)
   ...
   vsop87_micro_mars_q = mars_q_1+mars_q_0
end function

function vsop87_micro_mars_h(t as Double)
   ...
   vsop87_micro_mars_h = mars_h_2+mars_h_1+mars_h_0
end function

function vsop87_micro_mars_k(t as Double)
   ...
   vsop87_micro_mars_k = mars_k_2+mars_k_1+mars_k_0
end function

function vsop87_micro_mars_l(t as Double)
   ...
   vsop87_micro_mars_l = mars_l_1+mars_l_0
end function

function vsop87_micro_mars_a(t as Double)
...
function vsop87_micro_jupiter_p(t as Double)
   ...
   vsop87_micro_jupiter_p = jupiter_p_1+jupiter_p_0
end function

function vsop87_micro_jupiter_q(t as Double)
   ...
   vsop87_micro_jupiter_q = jupiter_q_1+jupiter_q_0
end function

function vsop87_micro_jupiter_h(t as Double)
   ...
   vsop87_micro_jupiter_h = jupiter_h_1+jupiter_h_0
end function

function vsop87_micro_jupiter_k(t as Double)
   ...
   vsop87_micro_jupiter_k = jupiter_k_2+jupiter_k_1+jupiter_k_0
end function

function vsop87_micro_jupiter_l(t as Double)
   ...
   vsop87_micro_jupiter_l = jupiter_l_2+jupiter_l_1+jupiter_l_0
end function

function vsop87_micro_jupiter_a(t as Double)
   ...
   vsop87_micro_jupiter_a = jupiter_a_1+jupiter_a_0
end function

function vsop87_micro_emb_p(t as Double)
...
function vsop87_micro_emb_q(t as Double)
...
function vsop87_micro_emb_h(t as Double)
   ...
   vsop87_micro_emb_h = emb_h_1+emb_h_0
end function

function vsop87_micro_emb_k(t as Double)
   ...
   vsop87_micro_emb_k = emb_k_1+emb_k_0
end function

function vsop87_micro_emb_l(t as Double)
   ...
   vsop87_micro_emb_l = emb_l_1+emb_l_0
end function

function vsop87_micro_emb_a(t as Double)
