...
function vsop87e_micro_getMercury(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_mercury_x(t)
   temp(2)=vsop87e_micro_mercury_y(t)
   temp(3)=vsop87e_micro_mercury_z(t)

   vsop87e_micro_getMercury = temp
end function

function vsop87e_micro_getVenus(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_venus_x(t)
   temp(2)=vsop87e_micro_venus_y(t)
   temp(3)=vsop87e_micro_venus_z(t)

   vsop87e_micro_getVenus = temp
end function

function vsop87e_micro_getEarth(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_earth_x(t)
   temp(2)=vsop87e_micro_earth_y(t)
   temp(3)=vsop87e_micro_earth_z(t)

   vsop87e_micro_getEarth = temp
end function

function vsop87e_micro_getMars(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_mars_x(t)
   temp(2)=vsop87e_micro_mars_y(t)
   temp(3)=vsop87e_micro_mars_z(t)

   vsop87e_micro_getMars = temp
end function

function vsop87e_micro_getJupiter(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_jupiter_x(t)
   temp(2)=vsop87e_micro_jupiter_y(t)
   temp(3)=vsop87e_micro_jupiter_z(t)

   vsop87e_micro_getJupiter = temp
end function

function vsop87e_micro_getSaturn(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_saturn_x(t)
   temp(2)=vsop87e_micro_saturn_y(t)
   temp(3)=vsop87e_micro_saturn_z(t)

   vsop87e_micro_getSaturn = temp
end function

function vsop87e_micro_getUranus(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_uranus_x(t)
   temp(2)=vsop87e_micro_uranus_y(t)
   temp(3)=vsop87e_micro_uranus_z(t)

   vsop87e_micro_getUranus = temp
end function

function vsop87e_micro_getNeptune(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_neptune_x(t)
   temp(2)=vsop87e_micro_neptune_y(t)
   temp(3)=vsop87e_micro_neptune_z(t)

   vsop87e_micro_getNeptune = temp
end function

function vsop87e_micro_getSun(t as Double) as Variant
   dim temp(3)
   temp(1)=vsop87e_micro_sun_x(t)
   temp(2)=vsop87e_micro_sun_y(t)
   temp(3)=vsop87e_micro_sun_z(t)

   vsop87e_micro_getSun = temp
end function

function vsop87e_micro_venus_z(t as Double)
   ...
   vsop87e_micro_venus_z = venus_z_1+venus_z_0
end function

function vsop87e_micro_venus_y(t as Double)
   ...
   vsop87e_micro_venus_y = venus_y_1+venus_y_0
end function

function vsop87e_micro_venus_x(t as Double)
   ...
   vsop87e_micro_venus_x = venus_x_1+venus_x_0
end function

function vsop87e_micro_uranus_z(t as Double)
   ...
   vsop87e_micro_uranus_z = uranus_z_2+uranus_z_1+uranus_z_0
end function

function vsop87e_micro_uranus_y(t as Double)
   ...
   vsop87e_micro_uranus_y = uranus_y_2+uranus_y_1+uranus_y_0
end function

function vsop87e_micro_uranus_x(t as Double)
   ...
   vsop87e_micro_uranus_x = uranus_x_2+uranus_x_1+uranus_x_0
end function

function vsop87e_micro_sun_z(t as Double)
...
function vsop87e_micro_sun_y(t as Double)
...
function vsop87e_micro_sun_x(t as Double)
...
function vsop87e_micro_saturn_z(t as Double)
   ...
   vsop87e_micro_saturn_z = saturn_z_2+saturn_z_1+saturn_z_0
end function

function vsop87e_micro_saturn_y(t as Double)
   ...
   vsop87e_micro_saturn_y = saturn_y_3+saturn_y_2+saturn_y_1+saturn_y_0
end function

function vsop87e_micro_saturn_x(t as Double)
   ...
   vsop87e_micro_saturn_x = saturn_x_3+saturn_x_2+saturn_x_1+saturn_x_0
end function

function vsop87e_micro_neptune_z(t as Double)
   ...
   vsop87e_micro_neptune_z = neptune_z_1+neptune_z_0
end function

function vsop87e_micro_neptune_y(t as Double)
   ...
   vsop87e_micro_neptune_y = neptune_y_1+neptune_y_0
end function

function vsop87e_micro_neptune_x(t as Double)
   ...
   vsop87e_micro_neptune_x = neptune_x_1+neptune_x_0
end function

function vsop87e_micro_mercury_z(t as Double)
   ...
   vsop87e_micro_mercury_z = mercury_z_1+mercury_z_0
end function

function vsop87e_micro_mercury_y(t as Double)
   ...
   vsop87e_micro_mercury_y = mercury_y_1+mercury_y_0
end function

function vsop87e_micro_mercury_x(t as Double)
   ...
   vsop87e_micro_mercury_x = mercury_x_1+mercury_x_0
end function

function vsop87e_micro_mars_z(t as Double)
   ...
   vsop87e_micro_mars_z = mars_z_2+mars_z_1+mars_z_0
end function

function vsop87e_micro_mars_y(t as Double)
   ...
   vsop87e_micro_mars_y = mars_y_2+mars_y_1+mars_y_0
end function

function vsop87e_micro_mars_x(t as Double)
   ...
   vsop87e_micro_mars_x = mars_x_2+mars_x_1+mars_x_0
end function

function vsop87e_micro_jupiter_z(t as Double)
   ...
   vsop87e_micro_jupiter_z = jupiter_z_2+jupiter_z_1+jupiter_z_0
end function

function vsop87e_micro_jupiter_y(t as Double)
   ...
   vsop87e_micro_jupiter_y = jupiter_y_3+jupiter_y_2+jupiter_y_1+jupiter_y_0
end function

function vsop87e_micro_jupiter_x(t as Double)
   ...
   vsop87e_micro_jupiter_x = jupiter_x_3+jupiter_x_2+jupiter_x_1+jupiter_x_0
end function

function vsop87e_micro_earth_z(t as Double)
   ...
   vsop87e_micro_earth_z = earth_z_1+earth_z_0
end function

function vsop87e_micro_earth_y(t as Double)
   ...
   vsop87e_micro_earth_y = earth_y_1+earth_y_0
end function

function vsop87e_micro_earth_x(t as Double)
   ...
   vsop87e_micro_earth_x = earth_x_1+earth_x_0
end function
